---
name: Feature Scaffolding Minimal Repros
trigger: feature scaffolding minimal repros, help with feature scaffolding minimal repros, plan feature scaffolding minimal repros, improve feature scaffolding minimal repros, expert feature scaffolding minimal repros
description: Expert-level guidance for feature scaffolding minimal repros with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Minimal Repros is an expert coding workflow skill for Feature Scaffolding. The focal concern is Minimal Repros, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Minimal Repros is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Minimal Repros is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Minimal Repros would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Minimal Repros create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Minimal Repros to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Minimal Repros.
...
- [ ] The evidence supporting Feature Scaffolding Minimal Repros is stronger than the assumptions.
