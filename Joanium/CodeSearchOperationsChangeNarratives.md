---
name: Code Search Operations Change Narratives
trigger: code search operations change narratives, help with code search operations change narratives, plan code search operations change narratives, improve code search operations change narratives, expert code search operations change narratives
description: Expert-level guidance for code search operations change narratives with action-oriented workflow, review criteria, and failure patterns.
---

Code Search Operations Change Narratives is an expert repository and delivery skill for Code Search Operations. The focal concern is Change Narratives, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Code Search Operations Change Narratives determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Code Search Operations Change Narratives riskier than the diff itself suggests?
- Which reviewer would challenge Code Search Operations Change Narratives first, and what evidence would they need?
- How could Code Search Operations Change Narratives fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Code Search Operations Change Narratives would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Code Search Operations Change Narratives concretely?
...
- A blast-radius note for Code Search Operations Change Narratives.
...
- [ ] The repository-level blast radius of Code Search Operations Change Narratives is explicit.
