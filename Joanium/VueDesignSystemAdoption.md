---
name: Vue Design System Adoption
trigger: vue design system adoption, help with vue design system adoption, plan vue design system adoption, improve vue design system adoption, expert vue design system adoption
description: Expert-level guidance for vue design system adoption with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Vue Design System Adoption is an expert frontend skill for Vue. The focal concern is Design System Adoption, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Vue Design System Adoption affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Vue Design System Adoption make user state harder to reason about than it needs to be?
- Which interaction in Vue Design System Adoption degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Vue Design System Adoption would break if the DOM or state changed unexpectedly?
- How does Vue Design System Adoption fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Vue Design System Adoption looks correct in a mock but collapses under production behavior?
...
- A state transition map for Vue Design System Adoption.
...
- [ ] The state model for Vue Design System Adoption is clear enough to debug.
...
- [ ] Another engineer can extend Vue Design System Adoption without guessing hidden UI contracts.
