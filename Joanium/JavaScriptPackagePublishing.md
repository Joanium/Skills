---
name: JavaScript Package Publishing
trigger: javascript package publishing, help with javascript package publishing, plan javascript package publishing, improve javascript package publishing, expert javascript package publishing
description: Expert-level guidance for javascript package publishing with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

JavaScript Package Publishing is an expert programming-language skill for JavaScript. The focal concern is Package Publishing, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when JavaScript Package Publishing affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside JavaScript Package Publishing?
- Which abstraction in JavaScript Package Publishing becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in JavaScript Package Publishing first?
- How will JavaScript Package Publishing behave when multiple contributors evolve it independently?
- Which part of JavaScript Package Publishing is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for JavaScript Package Publishing.
- A failure-mode note that explains the sharp edges inside JavaScript Package Publishing.
...
- [ ] The main language-level risk in JavaScript Package Publishing is named explicitly.
...
- [ ] Future contributors can extend JavaScript Package Publishing without reverse-engineering hidden contracts.
