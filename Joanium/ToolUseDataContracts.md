---
name: Tool Use Data Contracts
trigger: tool use data contracts, help with tool use data contracts, plan tool use data contracts, improve tool use data contracts, expert tool use data contracts
description: Expert-level guidance for tool use data contracts with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Tool Use Data Contracts is an expert applied-AI skill for Tool Use. The focal concern is Data Contracts, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Tool Use Data Contracts affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Tool Use Data Contracts would look acceptable in a demo but fail under production ambiguity?
- Which part of Tool Use Data Contracts lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Tool Use Data Contracts fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Tool Use Data Contracts is getting better rather than merely changing?
- Where should humans intervene in Tool Use Data Contracts to add leverage instead of toil?
...
- A behavior contract for Tool Use Data Contracts.
...
- [ ] The behavior contract for Tool Use Data Contracts is explicit.
