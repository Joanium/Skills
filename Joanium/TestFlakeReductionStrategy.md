---
name: Test Flake Reduction Strategy
trigger: test flake reduction strategy, help with test flake reduction strategy, plan test flake reduction strategy, improve test flake reduction strategy
description: Practical guidance for planning and executing test flake reduction strategy with clear scope, tradeoffs, and validation steps.
---

Test Flake Reduction Strategy improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
