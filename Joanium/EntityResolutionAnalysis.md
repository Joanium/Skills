---
name: Entity Resolution Analysis
trigger: entity resolution analysis, help with entity resolution analysis, plan entity resolution analysis, improve entity resolution analysis
description: Practical guidance for planning and executing entity resolution analysis with clear scope, tradeoffs, and validation steps.
---

Entity Resolution Analysis helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
