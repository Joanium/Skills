---
name: Legacy Refactor Verification Loops
trigger: legacy refactor verification loops, help with legacy refactor verification loops, plan legacy refactor verification loops, improve legacy refactor verification loops, expert legacy refactor verification loops
description: Expert-level guidance for legacy refactor verification loops with action-oriented workflow, review criteria, and failure patterns.
---

Legacy Refactor Verification Loops is an expert coding workflow skill for Legacy Refactor. The focal concern is Verification Loops, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Legacy Refactor Verification Loops is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Legacy Refactor Verification Loops is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Legacy Refactor Verification Loops would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Legacy Refactor Verification Loops create a silent regression that tests may miss?
- How would the AI explain the safety of Legacy Refactor Verification Loops to a skeptical reviewer?
...
- A concise evidence note for Legacy Refactor Verification Loops.
...
- [ ] The evidence supporting Legacy Refactor Verification Loops is stronger than the assumptions.
