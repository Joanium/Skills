---
name: Graphics Systems Programming State Machines
trigger: graphics systems programming state machines, help with graphics systems programming state machines, plan graphics systems programming state machines, improve graphics systems programming state machines, expert graphics systems programming state machines
description: Expert-level guidance for graphics systems programming state machines with action-oriented workflow, review criteria, and failure patterns.
---

Graphics Systems Programming State Machines is an expert systems and deep-engineering skill for Graphics Systems Programming. The focal concern is State Machines, but the real objective is helping an AI reason about correctness, performance, and failure in technical domains where shallow intuition breaks down.

## When To Use

- Use this when Graphics Systems Programming State Machines involves constraints where correctness, timing, memory, or physical behavior dominate the design.
...
- Which resource or state boundary inside Graphics Systems Programming State Machines is least observable today?
- What hidden assumption in Graphics Systems Programming State Machines would break first under load, timing pressure, or hardware limits?
- How would the AI distinguish a correctness issue from a performance symptom in Graphics Systems Programming State Machines?
- What tooling gap makes Graphics Systems Programming State Machines harder to debug or verify than it should be?
- Which optimization target in Graphics Systems Programming State Machines is attractive but strategically secondary?
...
- A system model for Graphics Systems Programming State Machines naming resources, states, and key constraints.
...
- [ ] The operating envelope for Graphics Systems Programming State Machines is explicit.
