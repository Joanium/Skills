---
name: TypeScript Test Harness Design
trigger: typescript test harness design, help with typescript test harness design, plan typescript test harness design, improve typescript test harness design, expert typescript test harness design
description: Expert-level guidance for typescript test harness design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

TypeScript Test Harness Design is an expert programming-language skill for TypeScript. The focal concern is Test Harness Design, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when TypeScript Test Harness Design affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside TypeScript Test Harness Design?
- Which abstraction in TypeScript Test Harness Design becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in TypeScript Test Harness Design first?
- How will TypeScript Test Harness Design behave when multiple contributors evolve it independently?
- Which part of TypeScript Test Harness Design is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for TypeScript Test Harness Design.
- A failure-mode note that explains the sharp edges inside TypeScript Test Harness Design.
...
- [ ] The main language-level risk in TypeScript Test Harness Design is named explicitly.
...
- [ ] Future contributors can extend TypeScript Test Harness Design without reverse-engineering hidden contracts.
