---
name: Unit Testing Systems Mock Discipline
trigger: unit testing systems mock discipline, help with unit testing systems mock discipline, plan unit testing systems mock discipline, improve unit testing systems mock discipline, expert unit testing systems mock discipline
description: Expert-level guidance for unit testing systems mock discipline with action-oriented workflow, review criteria, and failure patterns.
---

Unit Testing Systems Mock Discipline is an expert testing and quality skill for Unit Testing Systems. The focal concern is Mock Discipline, but the real objective is helping an AI create evidence that code is correct under change, not merely green under ideal conditions.

## When To Use

- Use this when Unit Testing Systems Mock Discipline needs to prove behavior under realistic change and failure conditions rather than just increase test count.
...
- What uncertainty inside Unit Testing Systems Mock Discipline is still untested even if coverage looks healthy?
- Which assertion in Unit Testing Systems Mock Discipline would stay green while the user-visible behavior regressed?
- How much of Unit Testing Systems Mock Discipline depends on mocks, fixtures, or timing assumptions that may be lying?
- What test failure pattern would be most actionable for a future AI debugging pass?
- Where does Unit Testing Systems Mock Discipline need stronger negative cases rather than more positive cases?
...
- A behavior protection map for Unit Testing Systems Mock Discipline.
- A test design note covering fixtures, timing, and oracle choice.
- A failure matrix for the important negative scenarios.
- A triage guide for what failing signals in Unit Testing Systems Mock Discipline should mean.
...
- [ ] The key behavior protected by Unit Testing Systems Mock Discipline is explicit.
