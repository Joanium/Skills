---
name: Metric Lineage Automation
trigger: metric lineage automation, help with metric lineage automation, plan metric lineage automation, improve metric lineage automation
description: Practical guidance for planning and executing metric lineage automation with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Automation helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
