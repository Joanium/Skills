---
name: Rollback Readiness Design
trigger: rollback readiness design, help with rollback readiness design, plan rollback readiness design, improve rollback readiness design
description: Practical guidance for planning and executing rollback readiness design with clear scope, tradeoffs, and validation steps.
---

Rollback Readiness Design focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
