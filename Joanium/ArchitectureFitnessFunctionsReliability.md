---
name: Architecture Fitness Functions Reliability
trigger: architecture fitness functions reliability, help with architecture fitness functions reliability, plan architecture fitness functions reliability, improve architecture fitness functions reliability, expert architecture fitness functions reliability
description: Expert-level guidance for architecture fitness functions reliability, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Architecture Fitness Functions Reliability is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is designing graceful degradation, recovery paths, and explicit reliability targets before the system is stressed.

## When To Use

- Use this when Architecture Fitness Functions Reliability affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the most likely and most damaging failure modes in Architecture Fitness Functions Reliability?
...
- A failure mode catalog for Architecture Fitness Functions Reliability.
