---
name: Runtime Capacity Headroom Optimization
trigger: runtime capacity headroom optimization, help with runtime capacity headroom optimization, plan runtime capacity headroom optimization, improve runtime capacity headroom optimization, expert runtime capacity headroom optimization
description: Expert-level guidance for runtime capacity headroom optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Runtime Capacity Headroom Optimization is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Runtime Capacity Headroom Optimization changes service availability, deployment safety, or recovery behavior.
...
- What is the actual bottleneck in Runtime Capacity Headroom Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Runtime Capacity Headroom Optimization with representative workloads.
