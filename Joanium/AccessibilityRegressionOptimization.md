---
name: Accessibility Regression Optimization
trigger: accessibility regression optimization, help with accessibility regression optimization, plan accessibility regression optimization, improve accessibility regression optimization
description: Practical guidance for planning and executing accessibility regression optimization with clear scope, tradeoffs, and validation steps.
---

Accessibility Regression Optimization improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
