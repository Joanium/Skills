---
name: Device Capability Matrices Optimization
trigger: device capability matrices optimization, help with device capability matrices optimization, plan device capability matrices optimization, improve device capability matrices optimization, expert device capability matrices optimization
description: Expert-level guidance for device capability matrices optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Device Capability Matrices Optimization is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Device Capability Matrices Optimization affects release risk, device behavior, or user trust during degraded conditions.
...
- What is the actual bottleneck in Device Capability Matrices Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Device Capability Matrices Optimization with representative workloads.
