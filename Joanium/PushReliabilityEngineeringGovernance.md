---
name: Push Reliability Engineering Governance
trigger: push reliability engineering governance, help with push reliability engineering governance, plan push reliability engineering governance, improve push reliability engineering governance, expert push reliability engineering governance
description: Expert-level guidance for push reliability engineering governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Push Reliability Engineering Governance is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Push Reliability Engineering Governance affects release risk, device behavior, or user trust during degraded conditions.
...
- Who sets the policy for Push Reliability Engineering Governance, and who is allowed to grant exceptions?
...
- A policy document for Push Reliability Engineering Governance with explicit scope.
