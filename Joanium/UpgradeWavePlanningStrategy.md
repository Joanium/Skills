---
name: Upgrade Wave Planning Strategy
trigger: upgrade wave planning strategy, help with upgrade wave planning strategy, plan upgrade wave planning strategy, improve upgrade wave planning strategy, expert upgrade wave planning strategy
description: Expert-level guidance for upgrade wave planning strategy, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Upgrade Wave Planning Strategy is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on choosing the operating model, decision boundaries, and success criteria before local optimizations become policy by accident.

## When To Use

- Use this when Upgrade Wave Planning Strategy affects codebase shape, team interfaces, or long-term delivery speed.
...
- What decision is Upgrade Wave Planning Strategy supposed to improve over the next planning horizon?
- Which constraints are fixed, and which are merely habits that can be challenged?
- Where does failure in Upgrade Wave Planning Strategy create the largest technical, business, or trust cost?
...
- A written decision statement for Upgrade Wave Planning Strategy.
