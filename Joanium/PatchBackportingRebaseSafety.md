---
name: Patch Backporting Rebase Safety
trigger: patch backporting rebase safety, help with patch backporting rebase safety, plan patch backporting rebase safety, improve patch backporting rebase safety, expert patch backporting rebase safety
description: Expert-level guidance for patch backporting rebase safety with action-oriented workflow, review criteria, and failure patterns.
---

Patch Backporting Rebase Safety is an expert repository and delivery skill for Patch Backporting. The focal concern is Rebase Safety, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Patch Backporting Rebase Safety determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Patch Backporting Rebase Safety riskier than the diff itself suggests?
- Which reviewer would challenge Patch Backporting Rebase Safety first, and what evidence would they need?
- How could Patch Backporting Rebase Safety fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Patch Backporting Rebase Safety would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Patch Backporting Rebase Safety concretely?
...
- A blast-radius note for Patch Backporting Rebase Safety.
...
- [ ] The repository-level blast radius of Patch Backporting Rebase Safety is explicit.
