---
name: JavaScript Refactor Mechanics
trigger: javascript refactor mechanics, help with javascript refactor mechanics, plan javascript refactor mechanics, improve javascript refactor mechanics, expert javascript refactor mechanics
description: Expert-level guidance for javascript refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

JavaScript Refactor Mechanics is an expert programming-language skill for JavaScript. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when JavaScript Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside JavaScript Refactor Mechanics?
- Which abstraction in JavaScript Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in JavaScript Refactor Mechanics first?
- How will JavaScript Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of JavaScript Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for JavaScript Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside JavaScript Refactor Mechanics.
...
- [ ] The main language-level risk in JavaScript Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend JavaScript Refactor Mechanics without reverse-engineering hidden contracts.
