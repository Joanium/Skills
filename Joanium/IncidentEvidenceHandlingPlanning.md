---
name: Incident Evidence Handling Planning
trigger: incident evidence handling planning, help with incident evidence handling planning, plan incident evidence handling planning, improve incident evidence handling planning, expert incident evidence handling planning
description: Expert-level guidance for incident evidence handling planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Incident Evidence Handling Planning is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Incident Evidence Handling Planning affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- What must be true before Incident Evidence Handling Planning can start safely?
...
- A milestone plan for Incident Evidence Handling Planning with explicit gating criteria.
