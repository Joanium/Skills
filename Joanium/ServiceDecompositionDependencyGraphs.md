---
name: Service Decomposition Dependency Graphs
trigger: service decomposition dependency graphs, help with service decomposition dependency graphs, plan service decomposition dependency graphs, improve service decomposition dependency graphs, expert service decomposition dependency graphs
description: Expert-level guidance for service decomposition dependency graphs with action-oriented workflow, review criteria, and failure patterns.
---

Service Decomposition Dependency Graphs is an expert architecture and systems skill for Service Decomposition. The focal concern is Dependency Graphs, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Service Decomposition Dependency Graphs needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Service Decomposition Dependency Graphs becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Service Decomposition Dependency Graphs is currently cheap only because the bill has not arrived yet?
- How would Service Decomposition Dependency Graphs be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Service Decomposition Dependency Graphs too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Service Decomposition Dependency Graphs.
...
- [ ] The key boundaries inside Service Decomposition Dependency Graphs are explicit and justified.
