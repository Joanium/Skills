---
name: Model Routing Planning
trigger: model routing planning, help with model routing planning, plan model routing planning, improve model routing planning
description: Practical guidance for planning and executing model routing planning with clear scope, tradeoffs, and validation steps.
---

Model Routing Planning helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
