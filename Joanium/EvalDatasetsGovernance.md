---
name: Evaluation Datasets Governance
trigger: evaluation datasets governance, help with evaluation datasets governance, plan evaluation datasets governance, improve evaluation datasets governance
description: Practical guidance for planning and executing evaluation datasets governance with clear scope, tradeoffs, and validation steps.
---

Evaluation Datasets Governance helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
