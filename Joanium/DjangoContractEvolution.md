---
name: Django Contract Evolution
trigger: django contract evolution, help with django contract evolution, plan django contract evolution, improve django contract evolution, expert django contract evolution
description: Expert-level guidance for django contract evolution with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Django Contract Evolution is an expert backend skill for Django. The focal concern is Contract Evolution, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when Django Contract Evolution shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside Django Contract Evolution breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in Django Contract Evolution?
- Where does Django Contract Evolution need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether Django Contract Evolution is unhealthy before customers do?
- What compatibility promise is implied by Django Contract Evolution even if it was never written down?
...
- A contract note for Django Contract Evolution that includes failure semantics.
...
- [ ] The contract for Django Contract Evolution is explicit about success and failure behavior.
