---
name: Environment Promotion Evidence Capture
trigger: environment promotion evidence capture, help with environment promotion evidence capture, plan environment promotion evidence capture, improve environment promotion evidence capture, expert environment promotion evidence capture
description: Expert-level guidance for environment promotion evidence capture with action-oriented workflow, review criteria, and failure patterns.
---

Environment Promotion Evidence Capture is an expert platform and automation skill for Environment Promotion. The focal concern is Evidence Capture, but the real objective is helping an AI make infrastructure and operational change without creating invisible blast radius.

## When To Use

- Use this when Environment Promotion Evidence Capture can affect deployment safety, service recovery, or operator trust in automation.
...
- What part of Environment Promotion Evidence Capture could fail silently while the automation still reports success?
- Which rollback or recovery step inside Environment Promotion Evidence Capture depends too much on tribal memory?
- How will operators know when Environment Promotion Evidence Capture should stop, wait, or reverse course?
- Where does Environment Promotion Evidence Capture blur access, policy, and execution boundaries dangerously?
...
- A change-and-recovery map for Environment Promotion Evidence Capture.
...
- [ ] The rollback model for Environment Promotion Evidence Capture is as real as the forward path.
