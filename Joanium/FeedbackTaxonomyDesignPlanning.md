---
name: Feedback Taxonomy Design Planning
trigger: feedback taxonomy design planning, help with feedback taxonomy design planning, plan feedback taxonomy design planning, improve feedback taxonomy design planning, expert feedback taxonomy design planning
description: Expert-level guidance for feedback taxonomy design planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Feedback Taxonomy Design Planning is an expert-level product skill for making high-leverage decisions with sharper tradeoffs, stronger evidence, and cleaner follow-through. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Feedback Taxonomy Design Planning affects roadmap choices, customer outcomes, or cross-functional alignment.
...
- What must be true before Feedback Taxonomy Design Planning can start safely?
...
- A milestone plan for Feedback Taxonomy Design Planning with explicit gating criteria.
