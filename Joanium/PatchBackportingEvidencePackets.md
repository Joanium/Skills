---
name: Patch Backporting Evidence Packets
trigger: patch backporting evidence packets, help with patch backporting evidence packets, plan patch backporting evidence packets, improve patch backporting evidence packets, expert patch backporting evidence packets
description: Expert-level guidance for patch backporting evidence packets with action-oriented workflow, review criteria, and failure patterns.
---

Patch Backporting Evidence Packets is an expert repository and delivery skill for Patch Backporting. The focal concern is Evidence Packets, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Patch Backporting Evidence Packets determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Patch Backporting Evidence Packets riskier than the diff itself suggests?
- Which reviewer would challenge Patch Backporting Evidence Packets first, and what evidence would they need?
- How could Patch Backporting Evidence Packets fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Patch Backporting Evidence Packets would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Patch Backporting Evidence Packets concretely?
...
- A blast-radius note for Patch Backporting Evidence Packets.
...
- [ ] The repository-level blast radius of Patch Backporting Evidence Packets is explicit.
