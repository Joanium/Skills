---
name: Kotlin Refactor Mechanics
trigger: kotlin refactor mechanics, help with kotlin refactor mechanics, plan kotlin refactor mechanics, improve kotlin refactor mechanics, expert kotlin refactor mechanics
description: Expert-level guidance for kotlin refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Kotlin Refactor Mechanics is an expert programming-language skill for Kotlin. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Kotlin Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Kotlin Refactor Mechanics?
- Which abstraction in Kotlin Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Kotlin Refactor Mechanics first?
- How will Kotlin Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of Kotlin Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Kotlin Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside Kotlin Refactor Mechanics.
...
- [ ] The main language-level risk in Kotlin Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend Kotlin Refactor Mechanics without reverse-engineering hidden contracts.
