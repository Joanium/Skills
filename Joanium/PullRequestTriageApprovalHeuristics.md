---
name: Pull Request Triage Approval Heuristics
trigger: pull request triage approval heuristics, help with pull request triage approval heuristics, plan pull request triage approval heuristics, improve pull request triage approval heuristics, expert pull request triage approval heuristics
description: Expert-level guidance for pull request triage approval heuristics with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Approval Heuristics is an expert repository and delivery skill for Pull Request Triage. The focal concern is Approval Heuristics, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Approval Heuristics determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Approval Heuristics riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Approval Heuristics first, and what evidence would they need?
- How could Pull Request Triage Approval Heuristics fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Approval Heuristics would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Approval Heuristics concretely?
...
- A blast-radius note for Pull Request Triage Approval Heuristics.
...
- [ ] The repository-level blast radius of Pull Request Triage Approval Heuristics is explicit.
