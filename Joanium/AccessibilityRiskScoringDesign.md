---
name: Accessibility Risk Scoring Design
trigger: accessibility risk scoring design, help with accessibility risk scoring design, plan accessibility risk scoring design, improve accessibility risk scoring design, expert accessibility risk scoring design
description: Expert-level guidance for accessibility risk scoring design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Accessibility Risk Scoring Design is an expert-level frontend skill for making client behavior understandable, resilient, and consistent across design and engineering. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Accessibility Risk Scoring Design shapes user trust through responsiveness, clarity, or failure handling.
...
- What are the core boundaries, contracts, and invariants in Accessibility Risk Scoring Design?
...
- An architecture or boundary diagram for Accessibility Risk Scoring Design.
