---
name: Upgrade Wave Planning Reliability
trigger: upgrade wave planning reliability, help with upgrade wave planning reliability, plan upgrade wave planning reliability, improve upgrade wave planning reliability, expert upgrade wave planning reliability
description: Expert-level guidance for upgrade wave planning reliability, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Upgrade Wave Planning Reliability is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is designing graceful degradation, recovery paths, and explicit reliability targets before the system is stressed.

## When To Use

- Use this when Upgrade Wave Planning Reliability affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the most likely and most damaging failure modes in Upgrade Wave Planning Reliability?
...
- A failure mode catalog for Upgrade Wave Planning Reliability.
