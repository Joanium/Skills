---
name: Safety Escalation Paths Review
trigger: safety escalation paths review, help with safety escalation paths review, plan safety escalation paths review, improve safety escalation paths review, expert safety escalation paths review
description: Expert-level guidance for safety escalation paths review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Safety Escalation Paths Review is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Safety Escalation Paths Review influences user-visible output, automation, or safety-sensitive decisions.
...
- What claims about Safety Escalation Paths Review are supported by evidence, and which are still assertions?
...
- A review summary for Safety Escalation Paths Review with clear approval status.
