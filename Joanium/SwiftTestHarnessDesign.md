---
name: Swift Test Harness Design
trigger: swift test harness design, help with swift test harness design, plan swift test harness design, improve swift test harness design, expert swift test harness design
description: Expert-level guidance for swift test harness design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Swift Test Harness Design is an expert programming-language skill for Swift. The focal concern is Test Harness Design, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Swift Test Harness Design affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Swift Test Harness Design?
- Which abstraction in Swift Test Harness Design becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Swift Test Harness Design first?
- How will Swift Test Harness Design behave when multiple contributors evolve it independently?
- Which part of Swift Test Harness Design is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Swift Test Harness Design.
- A failure-mode note that explains the sharp edges inside Swift Test Harness Design.
...
- [ ] The main language-level risk in Swift Test Harness Design is named explicitly.
...
- [ ] Future contributors can extend Swift Test Harness Design without reverse-engineering hidden contracts.
