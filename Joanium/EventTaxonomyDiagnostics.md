---
name: Event Taxonomy Diagnostics
trigger: event taxonomy diagnostics, help with event taxonomy diagnostics, plan event taxonomy diagnostics, improve event taxonomy diagnostics
description: Practical guidance for planning and executing event taxonomy diagnostics with clear scope, tradeoffs, and validation steps.
---

Event Taxonomy Diagnostics helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
