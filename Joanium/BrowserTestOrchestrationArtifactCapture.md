---
name: Browser Test Orchestration Artifact Capture
trigger: browser test orchestration artifact capture, help with browser test orchestration artifact capture, plan browser test orchestration artifact capture, improve browser test orchestration artifact capture, expert browser test orchestration artifact capture
description: Expert-level guidance for browser test orchestration artifact capture with action-oriented workflow, review criteria, and failure patterns.
---

Browser Test Orchestration Artifact Capture is an expert browser automation skill for Browser Test Orchestration. The focal concern is Artifact Capture, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Browser Test Orchestration Artifact Capture needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Browser Test Orchestration Artifact Capture unreliable across runs?
- Which timing or selector assumption in Browser Test Orchestration Artifact Capture is least stable under real conditions?
- How would Browser Test Orchestration Artifact Capture behave differently across browsers, profiles, or CI environments?
- What artifacts should Browser Test Orchestration Artifact Capture capture so the next failure is diagnosable instead of mysterious?
- Which part of Browser Test Orchestration Artifact Capture is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Browser Test Orchestration Artifact Capture.
...
- [ ] The state model behind Browser Test Orchestration Artifact Capture is explicit.
