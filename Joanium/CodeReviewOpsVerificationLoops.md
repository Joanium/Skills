---
name: Code Review Operations Verification Loops
trigger: code review operations verification loops, help with code review operations verification loops, plan code review operations verification loops, improve code review operations verification loops, expert code review operations verification loops
description: Expert-level guidance for code review operations verification loops with action-oriented workflow, review criteria, and failure patterns.
---

Code Review Operations Verification Loops is an expert coding workflow skill for Code Review Operations. The focal concern is Verification Loops, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Code Review Operations Verification Loops is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Code Review Operations Verification Loops is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Code Review Operations Verification Loops would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Code Review Operations Verification Loops create a silent regression that tests may miss?
- How would the AI explain the safety of Code Review Operations Verification Loops to a skeptical reviewer?
...
- A concise evidence note for Code Review Operations Verification Loops.
...
- [ ] The evidence supporting Code Review Operations Verification Loops is stronger than the assumptions.
