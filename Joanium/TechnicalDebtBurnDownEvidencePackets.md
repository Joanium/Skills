---
name: Technical Debt Burn Down Evidence Packets
trigger: technical debt burn down evidence packets, help with technical debt burn down evidence packets, plan technical debt burn down evidence packets, improve technical debt burn down evidence packets, expert technical debt burn down evidence packets
description: Expert-level guidance for technical debt burn down evidence packets with action-oriented workflow, review criteria, and failure patterns.
---

Technical Debt Burn Down Evidence Packets is an expert repository and delivery skill for Technical Debt Burn Down. The focal concern is Evidence Packets, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Technical Debt Burn Down Evidence Packets determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Technical Debt Burn Down Evidence Packets riskier than the diff itself suggests?
- Which reviewer would challenge Technical Debt Burn Down Evidence Packets first, and what evidence would they need?
- How could Technical Debt Burn Down Evidence Packets fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Technical Debt Burn Down Evidence Packets would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Technical Debt Burn Down Evidence Packets concretely?
...
- A blast-radius note for Technical Debt Burn Down Evidence Packets.
...
- [ ] The repository-level blast radius of Technical Debt Burn Down Evidence Packets is explicit.
