---
name: Production AI Operations Experiment Tracking
trigger: production ai operations experiment tracking, help with production ai operations experiment tracking, plan production ai operations experiment tracking, improve production ai operations experiment tracking, expert production ai operations experiment tracking
description: Expert-level guidance for production ai operations experiment tracking with action-oriented workflow, review criteria, and failure patterns.
---

Production AI Operations Experiment Tracking is an expert applied AI skill for Production AI Operations. The focal concern is Experiment Tracking, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Production AI Operations Experiment Tracking affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Production AI Operations Experiment Tracking is currently measured by vibes rather than a real contract?
- Which failure in Production AI Operations Experiment Tracking would be hardest to notice before it harms users or operators?
- How will Production AI Operations Experiment Tracking behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Production AI Operations Experiment Tracking?
...
- A behavior contract for Production AI Operations Experiment Tracking.
...
- [ ] The contract behind Production AI Operations Experiment Tracking is explicit enough to evaluate.
