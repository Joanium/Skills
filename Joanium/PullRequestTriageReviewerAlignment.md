---
name: Pull Request Triage Reviewer Alignment
trigger: pull request triage reviewer alignment, help with pull request triage reviewer alignment, plan pull request triage reviewer alignment, improve pull request triage reviewer alignment, expert pull request triage reviewer alignment
description: Expert-level guidance for pull request triage reviewer alignment with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Reviewer Alignment is an expert repository and delivery skill for Pull Request Triage. The focal concern is Reviewer Alignment, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Reviewer Alignment determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Reviewer Alignment riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Reviewer Alignment first, and what evidence would they need?
- How could Pull Request Triage Reviewer Alignment fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Reviewer Alignment would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Reviewer Alignment concretely?
...
- A blast-radius note for Pull Request Triage Reviewer Alignment.
...
- [ ] The repository-level blast radius of Pull Request Triage Reviewer Alignment is explicit.
