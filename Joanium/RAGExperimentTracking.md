---
name: RAG Experiment Tracking
trigger: rag experiment tracking, help with rag experiment tracking, plan rag experiment tracking, improve rag experiment tracking, expert rag experiment tracking
description: Expert-level guidance for rag experiment tracking with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

RAG Experiment Tracking is an expert applied-AI skill for RAG. The focal concern is Experiment Tracking, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when RAG Experiment Tracking affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in RAG Experiment Tracking would look acceptable in a demo but fail under production ambiguity?
- Which part of RAG Experiment Tracking lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will RAG Experiment Tracking fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that RAG Experiment Tracking is getting better rather than merely changing?
- Where should humans intervene in RAG Experiment Tracking to add leverage instead of toil?
...
- A behavior contract for RAG Experiment Tracking.
...
- [ ] The behavior contract for RAG Experiment Tracking is explicit.
