---
name: Push Messaging Review
trigger: push messaging review, help with push messaging review, plan push messaging review, improve push messaging review
description: Practical guidance for planning and executing push messaging review with clear scope, tradeoffs, and validation steps.
---

Push Messaging Review focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
