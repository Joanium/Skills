---
name: GitHub Actions Observability Design
trigger: github actions observability design, help with github actions observability design, plan github actions observability design, improve github actions observability design, expert github actions observability design
description: Expert-level guidance for github actions observability design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GitHub Actions Observability Design is an expert cloud and platform skill for GitHub Actions. The focal concern is Observability Design, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when GitHub Actions Observability Design changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside GitHub Actions Observability Design would fail first during a rushed rollout or incident?
- Which control in GitHub Actions Observability Design is automated but not truly reversible?
- How will operators know whether GitHub Actions Observability Design is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in GitHub Actions Observability Design is invisible until it becomes expensive?
- Which dependency makes GitHub Actions Observability Design less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for GitHub Actions Observability Design.
...
- [ ] The rollback path for GitHub Actions Observability Design is explicit and tested.
