---
name: Push Messaging Strategy
trigger: push messaging strategy, help with push messaging strategy, plan push messaging strategy, improve push messaging strategy
description: Practical guidance for planning and executing push messaging strategy with clear scope, tradeoffs, and validation steps.
---

Push Messaging Strategy focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
