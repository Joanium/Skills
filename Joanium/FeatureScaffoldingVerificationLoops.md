---
name: Feature Scaffolding Verification Loops
trigger: feature scaffolding verification loops, help with feature scaffolding verification loops, plan feature scaffolding verification loops, improve feature scaffolding verification loops, expert feature scaffolding verification loops
description: Expert-level guidance for feature scaffolding verification loops with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Verification Loops is an expert coding workflow skill for Feature Scaffolding. The focal concern is Verification Loops, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Verification Loops is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Verification Loops is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Verification Loops would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Verification Loops create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Verification Loops to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Verification Loops.
...
- [ ] The evidence supporting Feature Scaffolding Verification Loops is stronger than the assumptions.
