---
name: Disaster Recovery Exercises Governance
trigger: disaster recovery exercises governance, help with disaster recovery exercises governance, plan disaster recovery exercises governance, improve disaster recovery exercises governance, expert disaster recovery exercises governance
description: Expert-level guidance for disaster recovery exercises governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Disaster Recovery Exercises Governance is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Disaster Recovery Exercises Governance changes service availability, deployment safety, or recovery behavior.
...
- Who sets the policy for Disaster Recovery Exercises Governance, and who is allowed to grant exceptions?
...
- A policy document for Disaster Recovery Exercises Governance with explicit scope.
