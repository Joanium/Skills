---
name: Model Routing Automation
trigger: model routing automation, help with model routing automation, plan model routing automation, improve model routing automation
description: Practical guidance for planning and executing model routing automation with clear scope, tradeoffs, and validation steps.
---

Model Routing Automation helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
