---
name: Device Capability Matrices Planning
trigger: device capability matrices planning, help with device capability matrices planning, plan device capability matrices planning, improve device capability matrices planning, expert device capability matrices planning
description: Expert-level guidance for device capability matrices planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Device Capability Matrices Planning is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Device Capability Matrices Planning affects release risk, device behavior, or user trust during degraded conditions.
...
- What must be true before Device Capability Matrices Planning can start safely?
...
- A milestone plan for Device Capability Matrices Planning with explicit gating criteria.
