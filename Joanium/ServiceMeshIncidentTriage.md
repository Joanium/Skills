...
trigger: service mesh incident triage, help with service mesh incident triage, plan service mesh incident triage, improve service mesh incident triage, expert service mesh incident triage
description: Expert-level guidance for service mesh incident triage with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Service Mesh Incident Triage is an expert cloud and platform skill for Service Mesh. The focal concern is Incident Triage, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when Service Mesh Incident Triage changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside Service Mesh Incident Triage would fail first during a rushed rollout or incident?
- Which control in Service Mesh Incident Triage is automated but not truly reversible?
- How will operators know whether Service Mesh Incident Triage is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in Service Mesh Incident Triage is invisible until it becomes expensive?
- Which dependency makes Service Mesh Incident Triage less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for Service Mesh Incident Triage.
...
- [ ] The rollback path for Service Mesh Incident Triage is explicit and tested.
