---
name: Traffic Shaping Diagnostics
trigger: traffic shaping diagnostics, help with traffic shaping diagnostics, plan traffic shaping diagnostics, improve traffic shaping diagnostics
description: Practical guidance for planning and executing traffic shaping diagnostics with clear scope, tradeoffs, and validation steps.
---

Traffic Shaping Diagnostics focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
