---
name: Tool Selection Design Quality Gates
trigger: tool selection design quality gates, help with tool selection design quality gates, plan tool selection design quality gates, improve tool selection design quality gates, expert tool selection design quality gates
description: Expert-level guidance for tool selection design quality gates with action-oriented workflow, review criteria, and failure patterns.
---

Tool Selection Design Quality Gates is an expert agent and tooling skill for Tool Selection Design. The focal concern is Quality Gates, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Tool Selection Design Quality Gates affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Tool Selection Design Quality Gates is still governed by intuition instead of a contract or label set?
- Which failure in Tool Selection Design Quality Gates would be hardest to detect before it compounds?
- How would Tool Selection Design Quality Gates behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Tool Selection Design Quality Gates?
...
- A contract and failure-label set for Tool Selection Design Quality Gates.
...
- [ ] The system behind Tool Selection Design Quality Gates is described more clearly than the prompt surface.
