---
name: Cost Latency Governance Quality Gates
trigger: cost latency governance quality gates, help with cost latency governance quality gates, plan cost latency governance quality gates, improve cost latency governance quality gates, expert cost latency governance quality gates
description: Expert-level guidance for cost latency governance quality gates with action-oriented workflow, review criteria, and failure patterns.
---

Cost Latency Governance Quality Gates is an expert agent and tooling skill for Cost Latency Governance. The focal concern is Quality Gates, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Cost Latency Governance Quality Gates affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Cost Latency Governance Quality Gates is still governed by intuition instead of a contract or label set?
- Which failure in Cost Latency Governance Quality Gates would be hardest to detect before it compounds?
- How would Cost Latency Governance Quality Gates behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Cost Latency Governance Quality Gates?
...
- A contract and failure-label set for Cost Latency Governance Quality Gates.
...
- [ ] The system behind Cost Latency Governance Quality Gates is described more clearly than the prompt surface.
