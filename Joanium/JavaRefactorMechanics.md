---
name: Java Refactor Mechanics
trigger: java refactor mechanics, help with java refactor mechanics, plan java refactor mechanics, improve java refactor mechanics, expert java refactor mechanics
description: Expert-level guidance for java refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Java Refactor Mechanics is an expert programming-language skill for Java. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Java Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Java Refactor Mechanics?
- Which abstraction in Java Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Java Refactor Mechanics first?
- How will Java Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of Java Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Java Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside Java Refactor Mechanics.
...
- [ ] The main language-level risk in Java Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend Java Refactor Mechanics without reverse-engineering hidden contracts.
