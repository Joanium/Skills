---
name: Install Funnels Optimization
trigger: install funnels optimization, help with install funnels optimization, plan install funnels optimization, improve install funnels optimization
description: Practical guidance for planning and executing install funnels optimization with clear scope, tradeoffs, and validation steps.
---

Install Funnels Optimization focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
