---
name: SolidJS Design System Adoption
trigger: solidjs design system adoption, help with solidjs design system adoption, plan solidjs design system adoption, improve solidjs design system adoption, expert solidjs design system adoption
description: Expert-level guidance for solidjs design system adoption with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

SolidJS Design System Adoption is an expert frontend skill for SolidJS. The focal concern is Design System Adoption, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when SolidJS Design System Adoption affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does SolidJS Design System Adoption make user state harder to reason about than it needs to be?
- Which interaction in SolidJS Design System Adoption degrades first under latency, stale data, or partial failure?
- What accessibility behavior in SolidJS Design System Adoption would break if the DOM or state changed unexpectedly?
- How does SolidJS Design System Adoption fail when routing, hydration, or rendering order becomes non-ideal?
- What part of SolidJS Design System Adoption looks correct in a mock but collapses under production behavior?
...
- A state transition map for SolidJS Design System Adoption.
...
- [ ] The state model for SolidJS Design System Adoption is clear enough to debug.
...
- [ ] Another engineer can extend SolidJS Design System Adoption without guessing hidden UI contracts.
