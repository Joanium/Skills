---
name: Refactor Campaigns Rebase Safety
trigger: refactor campaigns rebase safety, help with refactor campaigns rebase safety, plan refactor campaigns rebase safety, improve refactor campaigns rebase safety, expert refactor campaigns rebase safety
description: Expert-level guidance for refactor campaigns rebase safety with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Rebase Safety is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Rebase Safety, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Rebase Safety determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Rebase Safety riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Rebase Safety first, and what evidence would they need?
- How could Refactor Campaigns Rebase Safety fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Rebase Safety would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Rebase Safety concretely?
...
- A blast-radius note for Refactor Campaigns Rebase Safety.
...
- [ ] The repository-level blast radius of Refactor Campaigns Rebase Safety is explicit.
