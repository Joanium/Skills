---
name: Service Decomposition Tradeoff Reviews
trigger: service decomposition tradeoff reviews, help with service decomposition tradeoff reviews, plan service decomposition tradeoff reviews, improve service decomposition tradeoff reviews, expert service decomposition tradeoff reviews
description: Expert-level guidance for service decomposition tradeoff reviews with action-oriented workflow, review criteria, and failure patterns.
---

Service Decomposition Tradeoff Reviews is an expert architecture and systems skill for Service Decomposition. The focal concern is Tradeoff Reviews, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Service Decomposition Tradeoff Reviews needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Service Decomposition Tradeoff Reviews becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Service Decomposition Tradeoff Reviews is currently cheap only because the bill has not arrived yet?
- How would Service Decomposition Tradeoff Reviews be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Service Decomposition Tradeoff Reviews too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Service Decomposition Tradeoff Reviews.
...
- [ ] The key boundaries inside Service Decomposition Tradeoff Reviews are explicit and justified.
