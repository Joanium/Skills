---
name: Browser Test Orchestration User Simulation
trigger: browser test orchestration user simulation, help with browser test orchestration user simulation, plan browser test orchestration user simulation, improve browser test orchestration user simulation, expert browser test orchestration user simulation
description: Expert-level guidance for browser test orchestration user simulation with action-oriented workflow, review criteria, and failure patterns.
---

Browser Test Orchestration User Simulation is an expert browser automation skill for Browser Test Orchestration. The focal concern is User Simulation, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Browser Test Orchestration User Simulation needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Browser Test Orchestration User Simulation unreliable across runs?
- Which timing or selector assumption in Browser Test Orchestration User Simulation is least stable under real conditions?
- How would Browser Test Orchestration User Simulation behave differently across browsers, profiles, or CI environments?
- What artifacts should Browser Test Orchestration User Simulation capture so the next failure is diagnosable instead of mysterious?
- Which part of Browser Test Orchestration User Simulation is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Browser Test Orchestration User Simulation.
...
- [ ] The state model behind Browser Test Orchestration User Simulation is explicit.
