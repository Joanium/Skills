---
name: Embedded Systems Lab API Design
trigger: embedded systems lab api design, help with embedded systems lab api design, plan embedded systems lab api design, improve embedded systems lab api design, expert embedded systems lab api design
description: Expert-level guidance for embedded systems lab api design with action-oriented workflow, review criteria, and failure patterns.
---

Embedded Systems Lab API Design is an expert systems and deep-engineering skill for Embedded Systems Lab. The focal concern is API Design, but the real objective is helping an AI reason about correctness, performance, and failure in technical domains where shallow intuition breaks down.

## When To Use

- Use this when Embedded Systems Lab API Design involves constraints where correctness, timing, memory, or physical behavior dominate the design.
...
- Which resource or state boundary inside Embedded Systems Lab API Design is least observable today?
- What hidden assumption in Embedded Systems Lab API Design would break first under load, timing pressure, or hardware limits?
- How would the AI distinguish a correctness issue from a performance symptom in Embedded Systems Lab API Design?
- What tooling gap makes Embedded Systems Lab API Design harder to debug or verify than it should be?
- Which optimization target in Embedded Systems Lab API Design is attractive but strategically secondary?
...
- A system model for Embedded Systems Lab API Design naming resources, states, and key constraints.
...
- [ ] The operating envelope for Embedded Systems Lab API Design is explicit.
