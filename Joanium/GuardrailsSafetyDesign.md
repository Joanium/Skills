---
name: Guardrails Safety Design
trigger: guardrails safety design, help with guardrails safety design, plan guardrails safety design, improve guardrails safety design, expert guardrails safety design
description: Expert-level guidance for guardrails safety design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Guardrails Safety Design is an expert applied-AI skill for Guardrails. The focal concern is Safety Design, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Guardrails Safety Design affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Guardrails Safety Design would look acceptable in a demo but fail under production ambiguity?
- Which part of Guardrails Safety Design lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Guardrails Safety Design fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Guardrails Safety Design is getting better rather than merely changing?
- Where should humans intervene in Guardrails Safety Design to add leverage instead of toil?
...
- A behavior contract for Guardrails Safety Design.
...
- [ ] The behavior contract for Guardrails Safety Design is explicit.
