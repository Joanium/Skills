---
name: Rust Refactor Mechanics
trigger: rust refactor mechanics, help with rust refactor mechanics, plan rust refactor mechanics, improve rust refactor mechanics, expert rust refactor mechanics
description: Expert-level guidance for rust refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Rust Refactor Mechanics is an expert programming-language skill for Rust. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Rust Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Rust Refactor Mechanics?
- Which abstraction in Rust Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Rust Refactor Mechanics first?
- How will Rust Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of Rust Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Rust Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside Rust Refactor Mechanics.
...
- [ ] The main language-level risk in Rust Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend Rust Refactor Mechanics without reverse-engineering hidden contracts.
