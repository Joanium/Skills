---
name: Legacy Boundary Extraction Playbook
trigger: legacy boundary extraction playbook, help with legacy boundary extraction playbook, plan legacy boundary extraction playbook, improve legacy boundary extraction playbook, expert legacy boundary extraction playbook
description: Expert-level guidance for legacy boundary extraction playbook, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Legacy Boundary Extraction Playbook is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is response execution: who does what, in what order, with what evidence, when conditions are degraded.

## When To Use

- Use this when Legacy Boundary Extraction Playbook affects codebase shape, team interfaces, or long-term delivery speed.
...
- What threshold or trigger causes Legacy Boundary Extraction Playbook to move from monitoring to active response?
...
- A trigger table for Legacy Boundary Extraction Playbook.
