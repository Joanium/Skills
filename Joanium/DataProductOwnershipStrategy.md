---
name: Data Product Ownership Strategy
trigger: data product ownership strategy, help with data product ownership strategy, plan data product ownership strategy, improve data product ownership strategy, expert data product ownership strategy
description: Expert-level guidance for data product ownership strategy, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---
...
- Use this when Data Product Ownership Strategy affects downstream metrics, decisions, or customer-facing data products.
...
- What decision is Data Product Ownership Strategy supposed to improve over the next planning horizon?
- Which constraints are fixed, and which are merely habits that can be challenged?
- Where does failure in Data Product Ownership Strategy create the largest technical, business, or trust cost?
...
- A written decision statement for Data Product Ownership Strategy.
