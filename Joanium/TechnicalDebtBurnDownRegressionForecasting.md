---
name: Technical Debt Burn Down Regression Forecasting
trigger: technical debt burn down regression forecasting, help with technical debt burn down regression forecasting, plan technical debt burn down regression forecasting, improve technical debt burn down regression forecasting, expert technical debt burn down regression forecasting
description: Expert-level guidance for technical debt burn down regression forecasting with action-oriented workflow, review criteria, and failure patterns.
---

Technical Debt Burn Down Regression Forecasting is an expert repository and delivery skill for Technical Debt Burn Down. The focal concern is Regression Forecasting, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Technical Debt Burn Down Regression Forecasting determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Technical Debt Burn Down Regression Forecasting riskier than the diff itself suggests?
- Which reviewer would challenge Technical Debt Burn Down Regression Forecasting first, and what evidence would they need?
- How could Technical Debt Burn Down Regression Forecasting fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Technical Debt Burn Down Regression Forecasting would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Technical Debt Burn Down Regression Forecasting concretely?
...
- A blast-radius note for Technical Debt Burn Down Regression Forecasting.
...
- [ ] The repository-level blast radius of Technical Debt Burn Down Regression Forecasting is explicit.
