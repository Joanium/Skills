---
name: Metric Governance Semantic Contracts
trigger: metric governance semantic contracts, help with metric governance semantic contracts, plan metric governance semantic contracts, improve metric governance semantic contracts, expert metric governance semantic contracts
description: Expert-level guidance for metric governance semantic contracts with action-oriented workflow, review criteria, and failure patterns.
---

Metric Governance Semantic Contracts is an expert data and analytics skill for Metric Governance. The focal concern is Semantic Contracts, but the real objective is helping an AI produce data systems and analysis that remain trustworthy when definitions, sources, and consumers all evolve.

## When To Use

- Use this when Metric Governance Semantic Contracts needs stronger semantics, validation, and consumer awareness than a working query or pipeline alone can provide.
...
- What part of Metric Governance Semantic Contracts would two consumers interpret differently if nothing were documented?
- Which anomaly in Metric Governance Semantic Contracts is most likely to be ignored until it becomes a business argument?
- How would Metric Governance Semantic Contracts be repaired if the source data arrived late, duplicated, or wrong?
- What cost pattern in Metric Governance Semantic Contracts is growing because nobody owns the semantic boundary?
- Which downstream decision is too fragile for Metric Governance Semantic Contracts to remain loosely defined?
...
- A semantic contract for Metric Governance Semantic Contracts.
...
- [ ] The meaning of Metric Governance Semantic Contracts is explicit and consumer-facing.
