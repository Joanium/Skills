---
name: Metric Lineage Strategy
trigger: metric lineage strategy, help with metric lineage strategy, plan metric lineage strategy, improve metric lineage strategy
description: Practical guidance for planning and executing metric lineage strategy with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Strategy helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
