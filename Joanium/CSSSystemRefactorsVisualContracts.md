---
name: CSS System Refactors Visual Contracts
trigger: css system refactors visual contracts, help with css system refactors visual contracts, plan css system refactors visual contracts, improve css system refactors visual contracts, expert css system refactors visual contracts
description: Expert-level guidance for css system refactors visual contracts with action-oriented workflow, review criteria, and failure patterns.
---

CSS System Refactors Visual Contracts is an expert frontend implementation skill for CSS System Refactors. The focal concern is Visual Contracts, but the real objective is helping an AI create UI behavior that stays understandable when state, rendering, latency, and devices stop cooperating.

## When To Use

- Use this when CSS System Refactors Visual Contracts affects whether a frontend change will remain coherent outside the happy path.
...
- What part of CSS System Refactors Visual Contracts becomes hardest to reason about when the UI is slow or inconsistent?
- Which state transition inside CSS System Refactors Visual Contracts would fail silently without stronger instrumentation?
- How does CSS System Refactors Visual Contracts behave when the browser, network, or input method stops being ideal?
- What implementation choice in CSS System Refactors Visual Contracts most threatens the original design intent?
- Which regression in CSS System Refactors Visual Contracts would users notice long before the team does?
...
- A state and edge-case map for CSS System Refactors Visual Contracts.
...
- [ ] The behavioral contract behind CSS System Refactors Visual Contracts is clearer than the implementation shortcuts.
