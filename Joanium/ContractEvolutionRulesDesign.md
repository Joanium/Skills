---
name: Contract Evolution Rules Design
trigger: contract evolution rules design, help with contract evolution rules design, plan contract evolution rules design, improve contract evolution rules design, expert contract evolution rules design
description: Expert-level guidance for contract evolution rules design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Contract Evolution Rules Design is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Contract Evolution Rules Design affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the core boundaries, contracts, and invariants in Contract Evolution Rules Design?
...
- An architecture or boundary diagram for Contract Evolution Rules Design.
