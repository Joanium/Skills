---
name: Auth Recovery Optimization
trigger: auth recovery optimization, help with auth recovery optimization, plan auth recovery optimization, improve auth recovery optimization
description: Practical guidance for planning and executing auth recovery optimization with clear scope, tradeoffs, and validation steps.
---

Auth Recovery Optimization is about reducing exploitable gaps by pairing preventive controls with review, evidence, and response readiness.
