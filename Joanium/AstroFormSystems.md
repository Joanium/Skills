---
name: Astro Form Systems
trigger: astro form systems, help with astro form systems, plan astro form systems, improve astro form systems, expert astro form systems
description: Expert-level guidance for astro form systems with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Astro Form Systems is an expert frontend skill for Astro. The focal concern is Form Systems, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Astro Form Systems affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Astro Form Systems make user state harder to reason about than it needs to be?
- Which interaction in Astro Form Systems degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Astro Form Systems would break if the DOM or state changed unexpectedly?
- How does Astro Form Systems fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Astro Form Systems looks correct in a mock but collapses under production behavior?
...
- A state transition map for Astro Form Systems.
...
- [ ] The state model for Astro Form Systems is clear enough to debug.
...
- [ ] Another engineer can extend Astro Form Systems without guessing hidden UI contracts.
