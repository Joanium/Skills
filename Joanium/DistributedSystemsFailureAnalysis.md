---
name: Distributed Systems Failure Analysis
trigger: distributed systems failure analysis, help with distributed systems failure analysis, plan distributed systems failure analysis, improve distributed systems failure analysis, expert distributed systems failure analysis
description: Expert-level guidance for distributed systems failure analysis with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Distributed Systems Failure Analysis is an expert systems skill for Distributed Systems. The focal concern is Failure Analysis, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Distributed Systems Failure Analysis is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Distributed Systems Failure Analysis would break first under scale, timing, or hardware stress?
- Which state or resource in Distributed Systems Failure Analysis is hardest to observe when behavior goes wrong?
- How does Distributed Systems Failure Analysis trade correctness, throughput, and recoverability today?
- What tooling gap makes Distributed Systems Failure Analysis harder to reason about than it should be?
- Which optimization target inside Distributed Systems Failure Analysis is attractive but strategically secondary?
...
- A system model for Distributed Systems Failure Analysis that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Distributed Systems Failure Analysis is explicit.
