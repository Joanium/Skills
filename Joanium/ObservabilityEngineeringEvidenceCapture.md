---
name: Observability Engineering Evidence Capture
trigger: observability engineering evidence capture, help with observability engineering evidence capture, plan observability engineering evidence capture, improve observability engineering evidence capture, expert observability engineering evidence capture
description: Expert-level guidance for observability engineering evidence capture with action-oriented workflow, review criteria, and failure patterns.
---

Observability Engineering Evidence Capture is an expert platform and automation skill for Observability Engineering. The focal concern is Evidence Capture, but the real objective is helping an AI make infrastructure and operational change without creating invisible blast radius.

## When To Use

- Use this when Observability Engineering Evidence Capture can affect deployment safety, service recovery, or operator trust in automation.
...
- What part of Observability Engineering Evidence Capture could fail silently while the automation still reports success?
- Which rollback or recovery step inside Observability Engineering Evidence Capture depends too much on tribal memory?
- How will operators know when Observability Engineering Evidence Capture should stop, wait, or reverse course?
- Where does Observability Engineering Evidence Capture blur access, policy, and execution boundaries dangerously?
...
- A change-and-recovery map for Observability Engineering Evidence Capture.
...
- [ ] The rollback model for Observability Engineering Evidence Capture is as real as the forward path.
