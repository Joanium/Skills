---
name: Distributed Systems Architecture Patterns
trigger: distributed systems architecture patterns, help with distributed systems architecture patterns, plan distributed systems architecture patterns, improve distributed systems architecture patterns, expert distributed systems architecture patterns
description: Expert-level guidance for distributed systems architecture patterns with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Distributed Systems Architecture Patterns is an expert systems skill for Distributed Systems. The focal concern is Architecture Patterns, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Distributed Systems Architecture Patterns is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Distributed Systems Architecture Patterns would break first under scale, timing, or hardware stress?
- Which state or resource in Distributed Systems Architecture Patterns is hardest to observe when behavior goes wrong?
- How does Distributed Systems Architecture Patterns trade correctness, throughput, and recoverability today?
- What tooling gap makes Distributed Systems Architecture Patterns harder to reason about than it should be?
- Which optimization target inside Distributed Systems Architecture Patterns is attractive but strategically secondary?
...
- A system model for Distributed Systems Architecture Patterns that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Distributed Systems Architecture Patterns is explicit.
