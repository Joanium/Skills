---
name: Robotics Fault Recovery Planning
trigger: robotics fault recovery planning, help with robotics fault recovery planning, plan robotics fault recovery planning, improve robotics fault recovery planning, expert robotics fault recovery planning
description: Expert-level guidance for robotics fault recovery planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Robotics Fault Recovery Planning is an expert-level specialized systems skill for operating in technical domains where physical, protocol, or computational limits dominate design choices. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Robotics Fault Recovery Planning has tight performance, correctness, or hardware constraints.
...
- What must be true before Robotics Fault Recovery Planning can start safely?
...
- A milestone plan for Robotics Fault Recovery Planning with explicit gating criteria.
