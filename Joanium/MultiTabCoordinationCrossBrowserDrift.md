---
name: Multi-Tab Coordination Cross-Browser Drift
trigger: multi-tab coordination cross-browser drift, help with multi-tab coordination cross-browser drift, plan multi-tab coordination cross-browser drift, improve multi-tab coordination cross-browser drift, expert multi-tab coordination cross-browser drift
description: Expert-level guidance for multi-tab coordination cross-browser drift with action-oriented workflow, review criteria, and failure patterns.
---

Multi-Tab Coordination Cross-Browser Drift is an expert browser automation skill for Multi-Tab Coordination. The focal concern is Cross-Browser Drift, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Multi-Tab Coordination Cross-Browser Drift needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Multi-Tab Coordination Cross-Browser Drift unreliable across runs?
- Which timing or selector assumption in Multi-Tab Coordination Cross-Browser Drift is least stable under real conditions?
- How would Multi-Tab Coordination Cross-Browser Drift behave differently across browsers, profiles, or CI environments?
- What artifacts should Multi-Tab Coordination Cross-Browser Drift capture so the next failure is diagnosable instead of mysterious?
- Which part of Multi-Tab Coordination Cross-Browser Drift is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Multi-Tab Coordination Cross-Browser Drift.
...
- [ ] The state model behind Multi-Tab Coordination Cross-Browser Drift is explicit.
