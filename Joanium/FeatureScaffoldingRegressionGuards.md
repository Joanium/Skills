---
name: Feature Scaffolding Regression Guards
trigger: feature scaffolding regression guards, help with feature scaffolding regression guards, plan feature scaffolding regression guards, improve feature scaffolding regression guards, expert feature scaffolding regression guards
description: Expert-level guidance for feature scaffolding regression guards with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Regression Guards is an expert coding workflow skill for Feature Scaffolding. The focal concern is Regression Guards, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Regression Guards is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Regression Guards is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Regression Guards would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Regression Guards create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Regression Guards to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Regression Guards.
...
- [ ] The evidence supporting Feature Scaffolding Regression Guards is stronger than the assumptions.
