---
name: Fine Tuning Experiment Tracking
trigger: fine tuning experiment tracking, help with fine tuning experiment tracking, plan fine tuning experiment tracking, improve fine tuning experiment tracking, expert fine tuning experiment tracking
description: Expert-level guidance for fine tuning experiment tracking with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Fine Tuning Experiment Tracking is an expert applied-AI skill for Fine Tuning. The focal concern is Experiment Tracking, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Fine Tuning Experiment Tracking affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Fine Tuning Experiment Tracking would look acceptable in a demo but fail under production ambiguity?
- Which part of Fine Tuning Experiment Tracking lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Fine Tuning Experiment Tracking fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Fine Tuning Experiment Tracking is getting better rather than merely changing?
- Where should humans intervene in Fine Tuning Experiment Tracking to add leverage instead of toil?
...
- A behavior contract for Fine Tuning Experiment Tracking.
...
- [ ] The behavior contract for Fine Tuning Experiment Tracking is explicit.
