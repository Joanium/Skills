---
name: Build Failure Response Follow-through Checklists
trigger: build failure response follow-through checklists, help with build failure response follow-through checklists, plan build failure response follow-through checklists, improve build failure response follow-through checklists, expert build failure response follow-through checklists
description: Expert-level guidance for build failure response follow-through checklists with action-oriented workflow, review criteria, and failure patterns.
---

Build Failure Response Follow-through Checklists is an expert repository and delivery skill for Build Failure Response. The focal concern is Follow-through Checklists, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Build Failure Response Follow-through Checklists determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Build Failure Response Follow-through Checklists riskier than the diff itself suggests?
- Which reviewer would challenge Build Failure Response Follow-through Checklists first, and what evidence would they need?
- How could Build Failure Response Follow-through Checklists fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Build Failure Response Follow-through Checklists would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Build Failure Response Follow-through Checklists concretely?
...
- A blast-radius note for Build Failure Response Follow-through Checklists.
...
- [ ] The repository-level blast radius of Build Failure Response Follow-through Checklists is explicit.
