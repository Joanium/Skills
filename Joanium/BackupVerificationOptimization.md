---
name: Backup Verification Optimization
trigger: backup verification optimization, help with backup verification optimization, plan backup verification optimization, improve backup verification optimization
description: Practical guidance for planning and executing backup verification optimization with clear scope, tradeoffs, and validation steps.
---

Backup Verification Optimization focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
