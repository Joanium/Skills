---
name: Synthetic Data Failure Analysis
trigger: synthetic data failure analysis, help with synthetic data failure analysis, plan synthetic data failure analysis, improve synthetic data failure analysis, expert synthetic data failure analysis
description: Expert-level guidance for synthetic data failure analysis with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Synthetic Data Failure Analysis is an expert applied-AI skill for Synthetic Data. The focal concern is Failure Analysis, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Synthetic Data Failure Analysis affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Synthetic Data Failure Analysis would look acceptable in a demo but fail under production ambiguity?
- Which part of Synthetic Data Failure Analysis lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Synthetic Data Failure Analysis fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Synthetic Data Failure Analysis is getting better rather than merely changing?
- Where should humans intervene in Synthetic Data Failure Analysis to add leverage instead of toil?
...
- A behavior contract for Synthetic Data Failure Analysis.
...
- [ ] The behavior contract for Synthetic Data Failure Analysis is explicit.
