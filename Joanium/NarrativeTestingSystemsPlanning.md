---
name: Narrative Testing Systems Planning
trigger: narrative testing systems planning, help with narrative testing systems planning, plan narrative testing systems planning, improve narrative testing systems planning, expert narrative testing systems planning
description: Expert-level guidance for narrative testing systems planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Narrative Testing Systems Planning is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Narrative Testing Systems Planning affects acquisition, narrative clarity, or cross-channel execution.
...
- What must be true before Narrative Testing Systems Planning can start safely?
...
- A milestone plan for Narrative Testing Systems Planning with explicit gating criteria.
