---
name: Remix Component Testing
trigger: remix component testing, help with remix component testing, plan remix component testing, improve remix component testing, expert remix component testing
description: Expert-level guidance for remix component testing with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Remix Component Testing is an expert frontend skill for Remix. The focal concern is Component Testing, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Remix Component Testing affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Remix Component Testing make user state harder to reason about than it needs to be?
- Which interaction in Remix Component Testing degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Remix Component Testing would break if the DOM or state changed unexpectedly?
- How does Remix Component Testing fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Remix Component Testing looks correct in a mock but collapses under production behavior?
...
- A state transition map for Remix Component Testing.
...
- [ ] The state model for Remix Component Testing is clear enough to debug.
...
- [ ] Another engineer can extend Remix Component Testing without guessing hidden UI contracts.
