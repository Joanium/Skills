---
name: Agent Coordination Failure Taxonomy
trigger: agent coordination failure taxonomy, help with agent coordination failure taxonomy, plan agent coordination failure taxonomy, improve agent coordination failure taxonomy, expert agent coordination failure taxonomy
description: Expert-level guidance for agent coordination failure taxonomy with action-oriented workflow, review criteria, and failure patterns.
---

Agent Coordination Failure Taxonomy is an expert applied AI skill for Agent Coordination. The focal concern is Failure Taxonomy, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Agent Coordination Failure Taxonomy affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Agent Coordination Failure Taxonomy is currently measured by vibes rather than a real contract?
- Which failure in Agent Coordination Failure Taxonomy would be hardest to notice before it harms users or operators?
- How will Agent Coordination Failure Taxonomy behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Agent Coordination Failure Taxonomy?
...
- A behavior contract for Agent Coordination Failure Taxonomy.
...
- [ ] The contract behind Agent Coordination Failure Taxonomy is explicit enough to evaluate.
