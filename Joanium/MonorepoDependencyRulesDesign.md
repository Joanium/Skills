---
name: Monorepo Dependency Rules Design
trigger: monorepo dependency rules design, help with monorepo dependency rules design, plan monorepo dependency rules design, improve monorepo dependency rules design, expert monorepo dependency rules design
description: Expert-level guidance for monorepo dependency rules design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Monorepo Dependency Rules Design is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Monorepo Dependency Rules Design affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the core boundaries, contracts, and invariants in Monorepo Dependency Rules Design?
...
- An architecture or boundary diagram for Monorepo Dependency Rules Design.
