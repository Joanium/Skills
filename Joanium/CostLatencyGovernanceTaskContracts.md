---
name: Cost Latency Governance Task Contracts
trigger: cost latency governance task contracts, help with cost latency governance task contracts, plan cost latency governance task contracts, improve cost latency governance task contracts, expert cost latency governance task contracts
description: Expert-level guidance for cost latency governance task contracts with action-oriented workflow, review criteria, and failure patterns.
---

Cost Latency Governance Task Contracts is an expert agent and tooling skill for Cost Latency Governance. The focal concern is Task Contracts, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Cost Latency Governance Task Contracts affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Cost Latency Governance Task Contracts is still governed by intuition instead of a contract or label set?
- Which failure in Cost Latency Governance Task Contracts would be hardest to detect before it compounds?
- How would Cost Latency Governance Task Contracts behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Cost Latency Governance Task Contracts?
...
- A contract and failure-label set for Cost Latency Governance Task Contracts.
...
- [ ] The system behind Cost Latency Governance Task Contracts is described more clearly than the prompt surface.
