---
name: Cluster Tenancy Strategy
trigger: cluster tenancy strategy, help with cluster tenancy strategy, plan cluster tenancy strategy, improve cluster tenancy strategy
description: Practical guidance for planning and executing cluster tenancy strategy with clear scope, tradeoffs, and validation steps.
---

Cluster Tenancy Strategy focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
