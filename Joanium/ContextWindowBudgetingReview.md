---
name: Context Window Budgeting Review
trigger: context window budgeting review, help with context window budgeting review, plan context window budgeting review, improve context window budgeting review, expert context window budgeting review
description: Expert-level guidance for context window budgeting review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Context Window Budgeting Review is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Context Window Budgeting Review influences user-visible output, automation, or safety-sensitive decisions.
...
- What claims about Context Window Budgeting Review are supported by evidence, and which are still assertions?
...
- A review summary for Context Window Budgeting Review with clear approval status.
