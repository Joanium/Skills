---
name: Modular Monoliths Failure Budgets
trigger: modular monoliths failure budgets, help with modular monoliths failure budgets, plan modular monoliths failure budgets, improve modular monoliths failure budgets, expert modular monoliths failure budgets
description: Expert-level guidance for modular monoliths failure budgets with action-oriented workflow, review criteria, and failure patterns.
---

Modular Monoliths Failure Budgets is an expert architecture and systems skill for Modular Monoliths. The focal concern is Failure Budgets, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Modular Monoliths Failure Budgets needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Modular Monoliths Failure Budgets becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Modular Monoliths Failure Budgets is currently cheap only because the bill has not arrived yet?
- How would Modular Monoliths Failure Budgets be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Modular Monoliths Failure Budgets too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Modular Monoliths Failure Budgets.
...
- [ ] The key boundaries inside Modular Monoliths Failure Budgets are explicit and justified.
