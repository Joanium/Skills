---
name: Pull Request Triage Follow-through Checklists
trigger: pull request triage follow-through checklists, help with pull request triage follow-through checklists, plan pull request triage follow-through checklists, improve pull request triage follow-through checklists, expert pull request triage follow-through checklists
description: Expert-level guidance for pull request triage follow-through checklists with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Follow-through Checklists is an expert repository and delivery skill for Pull Request Triage. The focal concern is Follow-through Checklists, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Follow-through Checklists determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Follow-through Checklists riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Follow-through Checklists first, and what evidence would they need?
- How could Pull Request Triage Follow-through Checklists fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Follow-through Checklists would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Follow-through Checklists concretely?
...
- A blast-radius note for Pull Request Triage Follow-through Checklists.
...
- [ ] The repository-level blast radius of Pull Request Triage Follow-through Checklists is explicit.
