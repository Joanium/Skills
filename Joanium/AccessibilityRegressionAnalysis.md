---
name: Accessibility Regression Analysis
trigger: accessibility regression analysis, help with accessibility regression analysis, plan accessibility regression analysis, improve accessibility regression analysis
description: Practical guidance for planning and executing accessibility regression analysis with clear scope, tradeoffs, and validation steps.
---

Accessibility Regression Analysis improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
