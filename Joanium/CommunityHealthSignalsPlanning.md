---
name: Community Health Signals Planning
trigger: community health signals planning, help with community health signals planning, plan community health signals planning, improve community health signals planning, expert community health signals planning
description: Expert-level guidance for community health signals planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Community Health Signals Planning is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Community Health Signals Planning affects acquisition, narrative clarity, or cross-channel execution.
...
- What must be true before Community Health Signals Planning can start safely?
...
- A milestone plan for Community Health Signals Planning with explicit gating criteria.
