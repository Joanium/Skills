---
name: Legacy Boundary Extraction Optimization
trigger: legacy boundary extraction optimization, help with legacy boundary extraction optimization, plan legacy boundary extraction optimization, improve legacy boundary extraction optimization, expert legacy boundary extraction optimization
description: Expert-level guidance for legacy boundary extraction optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Legacy Boundary Extraction Optimization is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Legacy Boundary Extraction Optimization affects codebase shape, team interfaces, or long-term delivery speed.
...
- What is the actual bottleneck in Legacy Boundary Extraction Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Legacy Boundary Extraction Optimization with representative workloads.
