---
name: Prompting Failure Analysis
trigger: prompting failure analysis, help with prompting failure analysis, plan prompting failure analysis, improve prompting failure analysis, expert prompting failure analysis
description: Expert-level guidance for prompting failure analysis with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Prompting Failure Analysis is an expert applied-AI skill for Prompting. The focal concern is Failure Analysis, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Prompting Failure Analysis affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Prompting Failure Analysis would look acceptable in a demo but fail under production ambiguity?
- Which part of Prompting Failure Analysis lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Prompting Failure Analysis fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Prompting Failure Analysis is getting better rather than merely changing?
- Where should humans intervene in Prompting Failure Analysis to add leverage instead of toil?
...
- A behavior contract for Prompting Failure Analysis.
...
- [ ] The behavior contract for Prompting Failure Analysis is explicit.
