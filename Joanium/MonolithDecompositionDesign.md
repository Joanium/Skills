---
name: Monolith Decomposition Design
trigger: monolith decomposition design, help with monolith decomposition design, plan monolith decomposition design, improve monolith decomposition design
description: Practical guidance for planning and executing monolith decomposition design with clear scope, tradeoffs, and validation steps.
---

Monolith Decomposition Design improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
