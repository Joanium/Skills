---
name: Prompting Latency Budgets
trigger: prompting latency budgets, help with prompting latency budgets, plan prompting latency budgets, improve prompting latency budgets, expert prompting latency budgets
description: Expert-level guidance for prompting latency budgets with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Prompting Latency Budgets is an expert applied-AI skill for Prompting. The focal concern is Latency Budgets, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Prompting Latency Budgets affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Prompting Latency Budgets would look acceptable in a demo but fail under production ambiguity?
- Which part of Prompting Latency Budgets lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Prompting Latency Budgets fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Prompting Latency Budgets is getting better rather than merely changing?
- Where should humans intervene in Prompting Latency Budgets to add leverage instead of toil?
...
- A behavior contract for Prompting Latency Budgets.
...
- [ ] The behavior contract for Prompting Latency Budgets is explicit.
