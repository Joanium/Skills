---
name: React Design System Adoption
trigger: react design system adoption, help with react design system adoption, plan react design system adoption, improve react design system adoption, expert react design system adoption
description: Expert-level guidance for react design system adoption with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

React Design System Adoption is an expert frontend skill for React. The focal concern is Design System Adoption, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when React Design System Adoption affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does React Design System Adoption make user state harder to reason about than it needs to be?
- Which interaction in React Design System Adoption degrades first under latency, stale data, or partial failure?
- What accessibility behavior in React Design System Adoption would break if the DOM or state changed unexpectedly?
- How does React Design System Adoption fail when routing, hydration, or rendering order becomes non-ideal?
- What part of React Design System Adoption looks correct in a mock but collapses under production behavior?
...
- A state transition map for React Design System Adoption.
...
- [ ] The state model for React Design System Adoption is clear enough to debug.
...
- [ ] Another engineer can extend React Design System Adoption without guessing hidden UI contracts.
