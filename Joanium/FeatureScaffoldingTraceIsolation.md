---
name: Feature Scaffolding Trace Isolation
trigger: feature scaffolding trace isolation, help with feature scaffolding trace isolation, plan feature scaffolding trace isolation, improve feature scaffolding trace isolation, expert feature scaffolding trace isolation
description: Expert-level guidance for feature scaffolding trace isolation with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Trace Isolation is an expert coding workflow skill for Feature Scaffolding. The focal concern is Trace Isolation, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Trace Isolation is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Trace Isolation is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Trace Isolation would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Trace Isolation create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Trace Isolation to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Trace Isolation.
...
- [ ] The evidence supporting Feature Scaffolding Trace Isolation is stronger than the assumptions.
