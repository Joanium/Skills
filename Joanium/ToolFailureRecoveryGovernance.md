---
name: Tool Failure Recovery Governance
trigger: tool failure recovery governance, help with tool failure recovery governance, plan tool failure recovery governance, improve tool failure recovery governance, expert tool failure recovery governance
description: Expert-level guidance for tool failure recovery governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Tool Failure Recovery Governance is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Tool Failure Recovery Governance influences user-visible output, automation, or safety-sensitive decisions.
...
- Who sets the policy for Tool Failure Recovery Governance, and who is allowed to grant exceptions?
...
- A policy document for Tool Failure Recovery Governance with explicit scope.
