---
name: Auth Flow Repair Retry Discipline
trigger: auth flow repair retry discipline, help with auth flow repair retry discipline, plan auth flow repair retry discipline, improve auth flow repair retry discipline, expert auth flow repair retry discipline
description: Expert-level guidance for auth flow repair retry discipline with action-oriented workflow, review criteria, and failure patterns.
---

Auth Flow Repair Retry Discipline is an expert backend execution skill for Auth Flow Repair. The focal concern is Retry Discipline, but the real objective is helping an AI design service behavior that stays coherent under retries, queues, partial failure, and operational pressure.

## When To Use

- Use this when Auth Flow Repair Retry Discipline affects whether backend changes remain safe once real production behavior kicks in.
...
- Which failure ordering inside Auth Flow Repair Retry Discipline would create the most misleading symptom?
- Where does Auth Flow Repair Retry Discipline need stronger idempotency or retry discipline?
- What dependency in Auth Flow Repair Retry Discipline is currently hiding behind timeout or queue noise?
- How would an operator explain the health of Auth Flow Repair Retry Discipline in the first five minutes of an incident?
- What contract assumption in Auth Flow Repair Retry Discipline is least defensible under partial failure?
...
- A failure-sequence note for Auth Flow Repair Retry Discipline.
...
- [ ] The real behavior of Auth Flow Repair Retry Discipline under retries and failures is explicit.
