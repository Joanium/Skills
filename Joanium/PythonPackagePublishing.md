...
trigger: python package publishing, help with python package publishing, plan python package publishing, improve python package publishing, expert python package publishing
description: Expert-level guidance for python package publishing with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Python Package Publishing is an expert programming-language skill for Python. The focal concern is Package Publishing, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Python Package Publishing affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Python Package Publishing?
- Which abstraction in Python Package Publishing becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Python Package Publishing first?
- How will Python Package Publishing behave when multiple contributors evolve it independently?
- Which part of Python Package Publishing is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Python Package Publishing.
- A failure-mode note that explains the sharp edges inside Python Package Publishing.
...
- [ ] The main language-level risk in Python Package Publishing is named explicitly.
...
- [ ] Future contributors can extend Python Package Publishing without reverse-engineering hidden contracts.
