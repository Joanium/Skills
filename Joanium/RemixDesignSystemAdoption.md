---
name: Remix Design System Adoption
trigger: remix design system adoption, help with remix design system adoption, plan remix design system adoption, improve remix design system adoption, expert remix design system adoption
description: Expert-level guidance for remix design system adoption with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Remix Design System Adoption is an expert frontend skill for Remix. The focal concern is Design System Adoption, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Remix Design System Adoption affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Remix Design System Adoption make user state harder to reason about than it needs to be?
- Which interaction in Remix Design System Adoption degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Remix Design System Adoption would break if the DOM or state changed unexpectedly?
- How does Remix Design System Adoption fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Remix Design System Adoption looks correct in a mock but collapses under production behavior?
...
- A state transition map for Remix Design System Adoption.
...
- [ ] The state model for Remix Design System Adoption is clear enough to debug.
...
- [ ] Another engineer can extend Remix Design System Adoption without guessing hidden UI contracts.
