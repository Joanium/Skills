---
name: Agent Coordination Trace Analysis
trigger: agent coordination trace analysis, help with agent coordination trace analysis, plan agent coordination trace analysis, improve agent coordination trace analysis, expert agent coordination trace analysis
description: Expert-level guidance for agent coordination trace analysis with action-oriented workflow, review criteria, and failure patterns.
---

Agent Coordination Trace Analysis is an expert applied AI skill for Agent Coordination. The focal concern is Trace Analysis, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Agent Coordination Trace Analysis affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Agent Coordination Trace Analysis is currently measured by vibes rather than a real contract?
- Which failure in Agent Coordination Trace Analysis would be hardest to notice before it harms users or operators?
- How will Agent Coordination Trace Analysis behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Agent Coordination Trace Analysis?
...
- A behavior contract for Agent Coordination Trace Analysis.
...
- [ ] The contract behind Agent Coordination Trace Analysis is explicit enough to evaluate.
