---
name: C# Refactor Mechanics
trigger: c# refactor mechanics, help with c# refactor mechanics, plan c# refactor mechanics, improve c# refactor mechanics, expert c# refactor mechanics
description: Expert-level guidance for c# refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

C# Refactor Mechanics is an expert programming-language skill for C#. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when C# Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside C# Refactor Mechanics?
- Which abstraction in C# Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in C# Refactor Mechanics first?
- How will C# Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of C# Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for C# Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside C# Refactor Mechanics.
...
- [ ] The main language-level risk in C# Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend C# Refactor Mechanics without reverse-engineering hidden contracts.
