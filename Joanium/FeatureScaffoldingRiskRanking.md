---
name: Feature Scaffolding Risk Ranking
trigger: feature scaffolding risk ranking, help with feature scaffolding risk ranking, plan feature scaffolding risk ranking, improve feature scaffolding risk ranking, expert feature scaffolding risk ranking
description: Expert-level guidance for feature scaffolding risk ranking with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Risk Ranking is an expert coding workflow skill for Feature Scaffolding. The focal concern is Risk Ranking, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Risk Ranking is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Risk Ranking is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Risk Ranking would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Risk Ranking create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Risk Ranking to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Risk Ranking.
...
- [ ] The evidence supporting Feature Scaffolding Risk Ranking is stronger than the assumptions.
