---
name: Agents Evaluation Rubrics
trigger: agents evaluation rubrics, help with agents evaluation rubrics, plan agents evaluation rubrics, improve agents evaluation rubrics, expert agents evaluation rubrics
description: Expert-level guidance for agents evaluation rubrics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Agents Evaluation Rubrics is an expert applied-AI skill for Agents. The focal concern is Evaluation Rubrics, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Agents Evaluation Rubrics affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Agents Evaluation Rubrics would look acceptable in a demo but fail under production ambiguity?
- Which part of Agents Evaluation Rubrics lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Agents Evaluation Rubrics fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Agents Evaluation Rubrics is getting better rather than merely changing?
- Where should humans intervene in Agents Evaluation Rubrics to add leverage instead of toil?
...
- A behavior contract for Agents Evaluation Rubrics.
...
- [ ] The behavior contract for Agents Evaluation Rubrics is explicit.
