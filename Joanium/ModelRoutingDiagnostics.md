---
name: Model Routing Diagnostics
trigger: model routing diagnostics, help with model routing diagnostics, plan model routing diagnostics, improve model routing diagnostics
description: Practical guidance for planning and executing model routing diagnostics with clear scope, tradeoffs, and validation steps.
---

Model Routing Diagnostics helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
