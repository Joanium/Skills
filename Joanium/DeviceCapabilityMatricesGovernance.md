---
name: Device Capability Matrices Governance
trigger: device capability matrices governance, help with device capability matrices governance, plan device capability matrices governance, improve device capability matrices governance, expert device capability matrices governance
description: Expert-level guidance for device capability matrices governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Device Capability Matrices Governance is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Device Capability Matrices Governance affects release risk, device behavior, or user trust during degraded conditions.
...
- Who sets the policy for Device Capability Matrices Governance, and who is allowed to grant exceptions?
...
- A policy document for Device Capability Matrices Governance with explicit scope.
