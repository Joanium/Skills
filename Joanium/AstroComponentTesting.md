...
trigger: astro component testing, help with astro component testing, plan astro component testing, improve astro component testing, expert astro component testing
description: Expert-level guidance for astro component testing with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Astro Component Testing is an expert frontend skill for Astro. The focal concern is Component Testing, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Astro Component Testing affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Astro Component Testing make user state harder to reason about than it needs to be?
- Which interaction in Astro Component Testing degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Astro Component Testing would break if the DOM or state changed unexpectedly?
- How does Astro Component Testing fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Astro Component Testing looks correct in a mock but collapses under production behavior?
...
- A state transition map for Astro Component Testing.
...
- [ ] The state model for Astro Component Testing is clear enough to debug.
...
- [ ] Another engineer can extend Astro Component Testing without guessing hidden UI contracts.
