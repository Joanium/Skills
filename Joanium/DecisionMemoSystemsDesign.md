---
name: Decision Memo Systems Design
trigger: decision memo systems design, help with decision memo systems design, plan decision memo systems design, improve decision memo systems design, expert decision memo systems design
description: Expert-level guidance for decision memo systems design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Decision Memo Systems Design is an expert-level product skill for making high-leverage decisions with sharper tradeoffs, stronger evidence, and cleaner follow-through. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Decision Memo Systems Design affects roadmap choices, customer outcomes, or cross-functional alignment.
...
- What are the core boundaries, contracts, and invariants in Decision Memo Systems Design?
...
- An architecture or boundary diagram for Decision Memo Systems Design.
