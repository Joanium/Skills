---
name: Safety Escalation Paths Operations
trigger: safety escalation paths operations, help with safety escalation paths operations, plan safety escalation paths operations, improve safety escalation paths operations, expert safety escalation paths operations
description: Expert-level guidance for safety escalation paths operations, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Safety Escalation Paths Operations is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is repeatable day-two execution under real load, incomplete information, and ordinary human error.

## When To Use

- Use this when Safety Escalation Paths Operations influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the recurring operational decisions inside Safety Escalation Paths Operations?
...
- A runbook for Safety Escalation Paths Operations covering routine and degraded modes.
