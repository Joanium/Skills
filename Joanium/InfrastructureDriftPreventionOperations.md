---
name: Infrastructure Drift Prevention Operations
trigger: infrastructure drift prevention operations, help with infrastructure drift prevention operations, plan infrastructure drift prevention operations, improve infrastructure drift prevention operations, expert infrastructure drift prevention operations
description: Expert-level guidance for infrastructure drift prevention operations, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Infrastructure Drift Prevention Operations is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is repeatable day-two execution under real load, incomplete information, and ordinary human error.

## When To Use

- Use this when Infrastructure Drift Prevention Operations changes service availability, deployment safety, or recovery behavior.
...
- What are the recurring operational decisions inside Infrastructure Drift Prevention Operations?
...
- A runbook for Infrastructure Drift Prevention Operations covering routine and degraded modes.
