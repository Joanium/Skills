---
name: Event Taxonomy Optimization
trigger: event taxonomy optimization, help with event taxonomy optimization, plan event taxonomy optimization, improve event taxonomy optimization
description: Practical guidance for planning and executing event taxonomy optimization with clear scope, tradeoffs, and validation steps.
---

Event Taxonomy Optimization helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
