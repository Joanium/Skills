---
name: Agents Human Review Loops
trigger: agents human review loops, help with agents human review loops, plan agents human review loops, improve agents human review loops, expert agents human review loops
description: Expert-level guidance for agents human review loops with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Agents Human Review Loops is an expert applied-AI skill for Agents. The focal concern is Human Review Loops, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Agents Human Review Loops affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Agents Human Review Loops would look acceptable in a demo but fail under production ambiguity?
- Which part of Agents Human Review Loops lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Agents Human Review Loops fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Agents Human Review Loops is getting better rather than merely changing?
- Where should humans intervene in Agents Human Review Loops to add leverage instead of toil?
...
- A behavior contract for Agents Human Review Loops.
...
- [ ] The behavior contract for Agents Human Review Loops is explicit.
