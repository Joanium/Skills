---
name: Tool Failure Recovery Operations
trigger: tool failure recovery operations, help with tool failure recovery operations, plan tool failure recovery operations, improve tool failure recovery operations, expert tool failure recovery operations
description: Expert-level guidance for tool failure recovery operations, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Tool Failure Recovery Operations is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is repeatable day-two execution under real load, incomplete information, and ordinary human error.

## When To Use

- Use this when Tool Failure Recovery Operations influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the recurring operational decisions inside Tool Failure Recovery Operations?
...
- A runbook for Tool Failure Recovery Operations covering routine and degraded modes.
