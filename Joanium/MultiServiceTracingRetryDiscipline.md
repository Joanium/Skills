---
name: Multi-Service Tracing Retry Discipline
trigger: multi-service tracing retry discipline, help with multi-service tracing retry discipline, plan multi-service tracing retry discipline, improve multi-service tracing retry discipline, expert multi-service tracing retry discipline
description: Expert-level guidance for multi-service tracing retry discipline with action-oriented workflow, review criteria, and failure patterns.
---

Multi-Service Tracing Retry Discipline is an expert backend execution skill for Multi-Service Tracing. The focal concern is Retry Discipline, but the real objective is helping an AI design service behavior that stays coherent under retries, queues, partial failure, and operational pressure.

## When To Use

- Use this when Multi-Service Tracing Retry Discipline affects whether backend changes remain safe once real production behavior kicks in.
...
- Which failure ordering inside Multi-Service Tracing Retry Discipline would create the most misleading symptom?
- Where does Multi-Service Tracing Retry Discipline need stronger idempotency or retry discipline?
- What dependency in Multi-Service Tracing Retry Discipline is currently hiding behind timeout or queue noise?
- How would an operator explain the health of Multi-Service Tracing Retry Discipline in the first five minutes of an incident?
- What contract assumption in Multi-Service Tracing Retry Discipline is least defensible under partial failure?
...
- A failure-sequence note for Multi-Service Tracing Retry Discipline.
...
- [ ] The real behavior of Multi-Service Tracing Retry Discipline under retries and failures is explicit.
