---
name: Runtime Capacity Headroom Review
trigger: runtime capacity headroom review, help with runtime capacity headroom review, plan runtime capacity headroom review, improve runtime capacity headroom review, expert runtime capacity headroom review
description: Expert-level guidance for runtime capacity headroom review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Runtime Capacity Headroom Review is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Runtime Capacity Headroom Review changes service availability, deployment safety, or recovery behavior.
...
- What claims about Runtime Capacity Headroom Review are supported by evidence, and which are still assertions?
...
- A review summary for Runtime Capacity Headroom Review with clear approval status.
