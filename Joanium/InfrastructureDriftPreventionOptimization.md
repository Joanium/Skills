---
name: Infrastructure Drift Prevention Optimization
trigger: infrastructure drift prevention optimization, help with infrastructure drift prevention optimization, plan infrastructure drift prevention optimization, improve infrastructure drift prevention optimization, expert infrastructure drift prevention optimization
description: Expert-level guidance for infrastructure drift prevention optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Infrastructure Drift Prevention Optimization is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Infrastructure Drift Prevention Optimization changes service availability, deployment safety, or recovery behavior.
...
- What is the actual bottleneck in Infrastructure Drift Prevention Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Infrastructure Drift Prevention Optimization with representative workloads.
