---
name: Crash Signal Triage Planning
trigger: crash signal triage planning, help with crash signal triage planning, plan crash signal triage planning, improve crash signal triage planning, expert crash signal triage planning
description: Expert-level guidance for crash signal triage planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Crash Signal Triage Planning is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Crash Signal Triage Planning affects release risk, device behavior, or user trust during degraded conditions.
...
- What must be true before Crash Signal Triage Planning can start safely?
...
- A milestone plan for Crash Signal Triage Planning with explicit gating criteria.
