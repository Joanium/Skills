---
name: Prompting Safety Design
trigger: prompting safety design, help with prompting safety design, plan prompting safety design, improve prompting safety design, expert prompting safety design
description: Expert-level guidance for prompting safety design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Prompting Safety Design is an expert applied-AI skill for Prompting. The focal concern is Safety Design, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Prompting Safety Design affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Prompting Safety Design would look acceptable in a demo but fail under production ambiguity?
- Which part of Prompting Safety Design lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Prompting Safety Design fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Prompting Safety Design is getting better rather than merely changing?
- Where should humans intervene in Prompting Safety Design to add leverage instead of toil?
...
- A behavior contract for Prompting Safety Design.
...
- [ ] The behavior contract for Prompting Safety Design is explicit.
