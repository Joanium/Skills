---
name: Visual Diff Triage Artifact Capture
trigger: visual diff triage artifact capture, help with visual diff triage artifact capture, plan visual diff triage artifact capture, improve visual diff triage artifact capture, expert visual diff triage artifact capture
description: Expert-level guidance for visual diff triage artifact capture with action-oriented workflow, review criteria, and failure patterns.
---

Visual Diff Triage Artifact Capture is an expert browser automation skill for Visual Diff Triage. The focal concern is Artifact Capture, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Visual Diff Triage Artifact Capture needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Visual Diff Triage Artifact Capture unreliable across runs?
- Which timing or selector assumption in Visual Diff Triage Artifact Capture is least stable under real conditions?
- How would Visual Diff Triage Artifact Capture behave differently across browsers, profiles, or CI environments?
- What artifacts should Visual Diff Triage Artifact Capture capture so the next failure is diagnosable instead of mysterious?
- Which part of Visual Diff Triage Artifact Capture is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Visual Diff Triage Artifact Capture.
...
- [ ] The state model behind Visual Diff Triage Artifact Capture is explicit.
