---
name: Interaction Latency Budgets Review
trigger: interaction latency budgets review, help with interaction latency budgets review, plan interaction latency budgets review, improve interaction latency budgets review, expert interaction latency budgets review
description: Expert-level guidance for interaction latency budgets review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Interaction Latency Budgets Review is an expert-level frontend skill for making client behavior understandable, resilient, and consistent across design and engineering. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Interaction Latency Budgets Review shapes user trust through responsiveness, clarity, or failure handling.
...
- What claims about Interaction Latency Budgets Review are supported by evidence, and which are still assertions?
...
- A review summary for Interaction Latency Budgets Review with clear approval status.
