---
name: GitHub Actions Automation Safety
trigger: github actions automation safety, help with github actions automation safety, plan github actions automation safety, improve github actions automation safety, expert github actions automation safety
description: Expert-level guidance for github actions automation safety with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GitHub Actions Automation Safety is an expert cloud and platform skill for GitHub Actions. The focal concern is Automation Safety, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when GitHub Actions Automation Safety changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside GitHub Actions Automation Safety would fail first during a rushed rollout or incident?
- Which control in GitHub Actions Automation Safety is automated but not truly reversible?
- How will operators know whether GitHub Actions Automation Safety is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in GitHub Actions Automation Safety is invisible until it becomes expensive?
- Which dependency makes GitHub Actions Automation Safety less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for GitHub Actions Automation Safety.
...
- [ ] The rollback path for GitHub Actions Automation Safety is explicit and tested.
