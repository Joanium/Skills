---
name: TypeScript Concurrency Patterns
trigger: typescript concurrency patterns, help with typescript concurrency patterns, plan typescript concurrency patterns, improve typescript concurrency patterns, expert typescript concurrency patterns
description: Expert-level guidance for typescript concurrency patterns with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

TypeScript Concurrency Patterns is an expert programming-language skill for TypeScript. The focal concern is Concurrency Patterns, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when TypeScript Concurrency Patterns affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside TypeScript Concurrency Patterns?
- Which abstraction in TypeScript Concurrency Patterns becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in TypeScript Concurrency Patterns first?
- How will TypeScript Concurrency Patterns behave when multiple contributors evolve it independently?
- Which part of TypeScript Concurrency Patterns is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for TypeScript Concurrency Patterns.
- A failure-mode note that explains the sharp edges inside TypeScript Concurrency Patterns.
...
- [ ] The main language-level risk in TypeScript Concurrency Patterns is named explicitly.
...
- [ ] Future contributors can extend TypeScript Concurrency Patterns without reverse-engineering hidden contracts.
