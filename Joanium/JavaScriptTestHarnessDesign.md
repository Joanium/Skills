---
name: JavaScript Test Harness Design
trigger: javascript test harness design, help with javascript test harness design, plan javascript test harness design, improve javascript test harness design, expert javascript test harness design
description: Expert-level guidance for javascript test harness design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

JavaScript Test Harness Design is an expert programming-language skill for JavaScript. The focal concern is Test Harness Design, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when JavaScript Test Harness Design affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside JavaScript Test Harness Design?
- Which abstraction in JavaScript Test Harness Design becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in JavaScript Test Harness Design first?
- How will JavaScript Test Harness Design behave when multiple contributors evolve it independently?
- Which part of JavaScript Test Harness Design is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for JavaScript Test Harness Design.
- A failure-mode note that explains the sharp edges inside JavaScript Test Harness Design.
...
- [ ] The main language-level risk in JavaScript Test Harness Design is named explicitly.
...
- [ ] Future contributors can extend JavaScript Test Harness Design without reverse-engineering hidden contracts.
