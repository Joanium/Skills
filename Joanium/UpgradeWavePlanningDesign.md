---
name: Upgrade Wave Planning Design
trigger: upgrade wave planning design, help with upgrade wave planning design, plan upgrade wave planning design, improve upgrade wave planning design, expert upgrade wave planning design
description: Expert-level guidance for upgrade wave planning design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Upgrade Wave Planning Design is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Upgrade Wave Planning Design affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the core boundaries, contracts, and invariants in Upgrade Wave Planning Design?
...
- An architecture or boundary diagram for Upgrade Wave Planning Design.
