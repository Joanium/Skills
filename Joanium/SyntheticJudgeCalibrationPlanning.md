---
name: Synthetic Judge Calibration Planning
trigger: synthetic judge calibration planning, help with synthetic judge calibration planning, plan synthetic judge calibration planning, improve synthetic judge calibration planning, expert synthetic judge calibration planning
description: Expert-level guidance for synthetic judge calibration planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Synthetic Judge Calibration Planning is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Synthetic Judge Calibration Planning influences user-visible output, automation, or safety-sensitive decisions.
...
- What must be true before Synthetic Judge Calibration Planning can start safely?
...
- A milestone plan for Synthetic Judge Calibration Planning with explicit gating criteria.
