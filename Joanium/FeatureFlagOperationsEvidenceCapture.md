---
name: Feature Flag Operations Evidence Capture
trigger: feature flag operations evidence capture, help with feature flag operations evidence capture, plan feature flag operations evidence capture, improve feature flag operations evidence capture, expert feature flag operations evidence capture
description: Expert-level guidance for feature flag operations evidence capture with action-oriented workflow, review criteria, and failure patterns.
---

Feature Flag Operations Evidence Capture is an expert platform and automation skill for Feature Flag Operations. The focal concern is Evidence Capture, but the real objective is helping an AI make infrastructure and operational change without creating invisible blast radius.

## When To Use

- Use this when Feature Flag Operations Evidence Capture can affect deployment safety, service recovery, or operator trust in automation.
...
- What part of Feature Flag Operations Evidence Capture could fail silently while the automation still reports success?
- Which rollback or recovery step inside Feature Flag Operations Evidence Capture depends too much on tribal memory?
- How will operators know when Feature Flag Operations Evidence Capture should stop, wait, or reverse course?
- Where does Feature Flag Operations Evidence Capture blur access, policy, and execution boundaries dangerously?
...
- A change-and-recovery map for Feature Flag Operations Evidence Capture.
...
- [ ] The rollback model for Feature Flag Operations Evidence Capture is as real as the forward path.
