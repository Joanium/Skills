---
name: Platform Paved Roads Governance
trigger: platform paved roads governance, help with platform paved roads governance, plan platform paved roads governance, improve platform paved roads governance, expert platform paved roads governance
description: Expert-level guidance for platform paved roads governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Platform Paved Roads Governance is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Platform Paved Roads Governance affects codebase shape, team interfaces, or long-term delivery speed.
...
- Who sets the policy for Platform Paved Roads Governance, and who is allowed to grant exceptions?
...
- A policy document for Platform Paved Roads Governance with explicit scope.
