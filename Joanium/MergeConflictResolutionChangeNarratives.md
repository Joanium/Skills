---
name: Merge Conflict Resolution Change Narratives
trigger: merge conflict resolution change narratives, help with merge conflict resolution change narratives, plan merge conflict resolution change narratives, improve merge conflict resolution change narratives, expert merge conflict resolution change narratives
description: Expert-level guidance for merge conflict resolution change narratives with action-oriented workflow, review criteria, and failure patterns.
---

Merge Conflict Resolution Change Narratives is an expert repository and delivery skill for Merge Conflict Resolution. The focal concern is Change Narratives, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Merge Conflict Resolution Change Narratives determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Merge Conflict Resolution Change Narratives riskier than the diff itself suggests?
- Which reviewer would challenge Merge Conflict Resolution Change Narratives first, and what evidence would they need?
- How could Merge Conflict Resolution Change Narratives fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Merge Conflict Resolution Change Narratives would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Merge Conflict Resolution Change Narratives concretely?
...
- A blast-radius note for Merge Conflict Resolution Change Narratives.
...
- [ ] The repository-level blast radius of Merge Conflict Resolution Change Narratives is explicit.
