---
name: Change Risk Scoring Review
trigger: change risk scoring review, help with change risk scoring review, plan change risk scoring review, improve change risk scoring review, expert change risk scoring review
description: Expert-level guidance for change risk scoring review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Change Risk Scoring Review is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Change Risk Scoring Review affects codebase shape, team interfaces, or long-term delivery speed.
...
- What claims about Change Risk Scoring Review are supported by evidence, and which are still assertions?
...
- A review summary for Change Risk Scoring Review with clear approval status.
