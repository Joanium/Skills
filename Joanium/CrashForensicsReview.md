---
name: Crash Forensics Review
trigger: crash forensics review, help with crash forensics review, plan crash forensics review, improve crash forensics review
description: Practical guidance for planning and executing crash forensics review with clear scope, tradeoffs, and validation steps.
---

Crash Forensics Review focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
