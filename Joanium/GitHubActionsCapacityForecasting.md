---
name: GitHub Actions Capacity Forecasting
trigger: github actions capacity forecasting, help with github actions capacity forecasting, plan github actions capacity forecasting, improve github actions capacity forecasting, expert github actions capacity forecasting
description: Expert-level guidance for github actions capacity forecasting with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GitHub Actions Capacity Forecasting is an expert cloud and platform skill for GitHub Actions. The focal concern is Capacity Forecasting, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when GitHub Actions Capacity Forecasting changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside GitHub Actions Capacity Forecasting would fail first during a rushed rollout or incident?
- Which control in GitHub Actions Capacity Forecasting is automated but not truly reversible?
- How will operators know whether GitHub Actions Capacity Forecasting is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in GitHub Actions Capacity Forecasting is invisible until it becomes expensive?
- Which dependency makes GitHub Actions Capacity Forecasting less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for GitHub Actions Capacity Forecasting.
...
- [ ] The rollback path for GitHub Actions Capacity Forecasting is explicit and tested.
