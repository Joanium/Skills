---
name: Remix Hydration Recovery
trigger: remix hydration recovery, help with remix hydration recovery, plan remix hydration recovery, improve remix hydration recovery, expert remix hydration recovery
description: Expert-level guidance for remix hydration recovery with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Remix Hydration Recovery is an expert frontend skill for Remix. The focal concern is Hydration Recovery, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Remix Hydration Recovery affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Remix Hydration Recovery make user state harder to reason about than it needs to be?
- Which interaction in Remix Hydration Recovery degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Remix Hydration Recovery would break if the DOM or state changed unexpectedly?
- How does Remix Hydration Recovery fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Remix Hydration Recovery looks correct in a mock but collapses under production behavior?
...
- A state transition map for Remix Hydration Recovery.
...
- [ ] The state model for Remix Hydration Recovery is clear enough to debug.
...
- [ ] Another engineer can extend Remix Hydration Recovery without guessing hidden UI contracts.
