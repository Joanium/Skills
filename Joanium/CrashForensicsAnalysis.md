---
name: Crash Forensics Analysis
trigger: crash forensics analysis, help with crash forensics analysis, plan crash forensics analysis, improve crash forensics analysis
description: Practical guidance for planning and executing crash forensics analysis with clear scope, tradeoffs, and validation steps.
---

Crash Forensics Analysis focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
