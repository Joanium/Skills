---
name: Infrastructure Drift Prevention Design
trigger: infrastructure drift prevention design, help with infrastructure drift prevention design, plan infrastructure drift prevention design, improve infrastructure drift prevention design, expert infrastructure drift prevention design
description: Expert-level guidance for infrastructure drift prevention design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Infrastructure Drift Prevention Design is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Infrastructure Drift Prevention Design changes service availability, deployment safety, or recovery behavior.
...
- What are the core boundaries, contracts, and invariants in Infrastructure Drift Prevention Design?
...
- An architecture or boundary diagram for Infrastructure Drift Prevention Design.
