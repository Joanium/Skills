---
name: Client Observability Review
trigger: client observability review, help with client observability review, plan client observability review, improve client observability review
description: Practical guidance for planning and executing client observability review with clear scope, tradeoffs, and validation steps.
---

Client Observability Review improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
