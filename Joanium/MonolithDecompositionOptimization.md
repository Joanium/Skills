---
name: Monolith Decomposition Optimization
trigger: monolith decomposition optimization, help with monolith decomposition optimization, plan monolith decomposition optimization, improve monolith decomposition optimization
description: Practical guidance for planning and executing monolith decomposition optimization with clear scope, tradeoffs, and validation steps.
---

Monolith Decomposition Optimization improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
