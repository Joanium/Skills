---
name: Graphics Programming Failure Analysis
trigger: graphics programming failure analysis, help with graphics programming failure analysis, plan graphics programming failure analysis, improve graphics programming failure analysis, expert graphics programming failure analysis
description: Expert-level guidance for graphics programming failure analysis with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Graphics Programming Failure Analysis is an expert systems skill for Graphics Programming. The focal concern is Failure Analysis, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Graphics Programming Failure Analysis is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Graphics Programming Failure Analysis would break first under scale, timing, or hardware stress?
- Which state or resource in Graphics Programming Failure Analysis is hardest to observe when behavior goes wrong?
- How does Graphics Programming Failure Analysis trade correctness, throughput, and recoverability today?
- What tooling gap makes Graphics Programming Failure Analysis harder to reason about than it should be?
- Which optimization target inside Graphics Programming Failure Analysis is attractive but strategically secondary?
...
- A system model for Graphics Programming Failure Analysis that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Graphics Programming Failure Analysis is explicit.
