---
name: Express Contract Evolution
trigger: express contract evolution, help with express contract evolution, plan express contract evolution, improve express contract evolution, expert express contract evolution
description: Expert-level guidance for express contract evolution with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Express Contract Evolution is an expert backend skill for Express. The focal concern is Contract Evolution, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when Express Contract Evolution shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside Express Contract Evolution breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in Express Contract Evolution?
- Where does Express Contract Evolution need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether Express Contract Evolution is unhealthy before customers do?
- What compatibility promise is implied by Express Contract Evolution even if it was never written down?
...
- A contract note for Express Contract Evolution that includes failure semantics.
...
- [ ] The contract for Express Contract Evolution is explicit about success and failure behavior.
