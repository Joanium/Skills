---
name: Refactor Campaigns Follow-through Checklists
trigger: refactor campaigns follow-through checklists, help with refactor campaigns follow-through checklists, plan refactor campaigns follow-through checklists, improve refactor campaigns follow-through checklists, expert refactor campaigns follow-through checklists
description: Expert-level guidance for refactor campaigns follow-through checklists with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Follow-through Checklists is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Follow-through Checklists, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Follow-through Checklists determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Follow-through Checklists riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Follow-through Checklists first, and what evidence would they need?
- How could Refactor Campaigns Follow-through Checklists fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Follow-through Checklists would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Follow-through Checklists concretely?
...
- A blast-radius note for Refactor Campaigns Follow-through Checklists.
...
- [ ] The repository-level blast radius of Refactor Campaigns Follow-through Checklists is explicit.
