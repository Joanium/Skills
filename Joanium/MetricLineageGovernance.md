---
name: Metric Lineage Governance
trigger: metric lineage governance, help with metric lineage governance, plan metric lineage governance, improve metric lineage governance
description: Practical guidance for planning and executing metric lineage governance with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Governance helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
