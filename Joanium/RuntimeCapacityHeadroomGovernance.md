---
name: Runtime Capacity Headroom Governance
trigger: runtime capacity headroom governance, help with runtime capacity headroom governance, plan runtime capacity headroom governance, improve runtime capacity headroom governance, expert runtime capacity headroom governance
description: Expert-level guidance for runtime capacity headroom governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Runtime Capacity Headroom Governance is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Runtime Capacity Headroom Governance changes service availability, deployment safety, or recovery behavior.
...
- Who sets the policy for Runtime Capacity Headroom Governance, and who is allowed to grant exceptions?
...
- A policy document for Runtime Capacity Headroom Governance with explicit scope.
