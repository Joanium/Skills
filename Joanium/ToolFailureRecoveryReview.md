---
name: Tool Failure Recovery Review
trigger: tool failure recovery review, help with tool failure recovery review, plan tool failure recovery review, improve tool failure recovery review, expert tool failure recovery review
description: Expert-level guidance for tool failure recovery review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Tool Failure Recovery Review is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Tool Failure Recovery Review influences user-visible output, automation, or safety-sensitive decisions.
...
- What claims about Tool Failure Recovery Review are supported by evidence, and which are still assertions?
...
- A review summary for Tool Failure Recovery Review with clear approval status.
