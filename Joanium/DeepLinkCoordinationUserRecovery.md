---
name: Deep Link Coordination User Recovery
trigger: deep link coordination user recovery, help with deep link coordination user recovery, plan deep link coordination user recovery, improve deep link coordination user recovery, expert deep link coordination user recovery
description: Expert-level guidance for deep link coordination user recovery with client delivery workflow, review criteria, and failure patterns.
---

Deep Link Coordination User Recovery is an expert mobile and desktop delivery skill for Deep Link Coordination. The focal concern is User Recovery, but the real objective is helping an AI ship client software that survives device constraints, stores, upgrades, and real user recovery paths.

## When To Use

- Use this when Deep Link Coordination User Recovery affects whether client software remains trustworthy across devices, upgrades, and degraded conditions.
...
- Which user or device condition would expose the weakest assumption in Deep Link Coordination User Recovery first?
- How will Deep Link Coordination User Recovery behave during upgrade, rollback, or stale local state?
- What store, signing, or permission dependency could block or confuse Deep Link Coordination User Recovery unexpectedly?
- How would support or operations diagnose Deep Link Coordination User Recovery from telemetry instead of guesswork?
- What path inside Deep Link Coordination User Recovery should help the user recover rather than merely fail loudly?
...
- A device and release risk note for Deep Link Coordination User Recovery.
...
- [ ] The device, store, and upgrade assumptions behind Deep Link Coordination User Recovery are explicit.
