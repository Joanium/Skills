---
name: ASP.NET Core Contract Evolution
trigger: asp.net core contract evolution, help with asp.net core contract evolution, plan asp.net core contract evolution, improve asp.net core contract evolution, expert asp.net core contract evolution
description: Expert-level guidance for asp.net core contract evolution with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

ASP.NET Core Contract Evolution is an expert backend skill for ASP.NET Core. The focal concern is Contract Evolution, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when ASP.NET Core Contract Evolution shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside ASP.NET Core Contract Evolution breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in ASP.NET Core Contract Evolution?
- Where does ASP.NET Core Contract Evolution need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether ASP.NET Core Contract Evolution is unhealthy before customers do?
- What compatibility promise is implied by ASP.NET Core Contract Evolution even if it was never written down?
...
- A contract note for ASP.NET Core Contract Evolution that includes failure semantics.
...
- [ ] The contract for ASP.NET Core Contract Evolution is explicit about success and failure behavior.
