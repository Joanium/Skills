---
name: Legacy Refactor Minimal Repros
trigger: legacy refactor minimal repros, help with legacy refactor minimal repros, plan legacy refactor minimal repros, improve legacy refactor minimal repros, expert legacy refactor minimal repros
description: Expert-level guidance for legacy refactor minimal repros with action-oriented workflow, review criteria, and failure patterns.
---

Legacy Refactor Minimal Repros is an expert coding workflow skill for Legacy Refactor. The focal concern is Minimal Repros, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Legacy Refactor Minimal Repros is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Legacy Refactor Minimal Repros is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Legacy Refactor Minimal Repros would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Legacy Refactor Minimal Repros create a silent regression that tests may miss?
- How would the AI explain the safety of Legacy Refactor Minimal Repros to a skeptical reviewer?
...
- A concise evidence note for Legacy Refactor Minimal Repros.
...
- [ ] The evidence supporting Legacy Refactor Minimal Repros is stronger than the assumptions.
