---
name: Computer Vision Architecture Patterns
trigger: computer vision architecture patterns, help with computer vision architecture patterns, plan computer vision architecture patterns, improve computer vision architecture patterns, expert computer vision architecture patterns
description: Expert-level guidance for computer vision architecture patterns with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Computer Vision Architecture Patterns is an expert systems skill for Computer Vision. The focal concern is Architecture Patterns, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Computer Vision Architecture Patterns is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Computer Vision Architecture Patterns would break first under scale, timing, or hardware stress?
- Which state or resource in Computer Vision Architecture Patterns is hardest to observe when behavior goes wrong?
- How does Computer Vision Architecture Patterns trade correctness, throughput, and recoverability today?
- What tooling gap makes Computer Vision Architecture Patterns harder to reason about than it should be?
- Which optimization target inside Computer Vision Architecture Patterns is attractive but strategically secondary?
...
- A system model for Computer Vision Architecture Patterns that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Computer Vision Architecture Patterns is explicit.
