---
name: Dependency Upgrade Verification Loops
trigger: dependency upgrade verification loops, help with dependency upgrade verification loops, plan dependency upgrade verification loops, improve dependency upgrade verification loops, expert dependency upgrade verification loops
description: Expert-level guidance for dependency upgrade verification loops with action-oriented workflow, review criteria, and failure patterns.
---

Dependency Upgrade Verification Loops is an expert coding workflow skill for Dependency Upgrade. The focal concern is Verification Loops, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Dependency Upgrade Verification Loops is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Dependency Upgrade Verification Loops is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Dependency Upgrade Verification Loops would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Dependency Upgrade Verification Loops create a silent regression that tests may miss?
- How would the AI explain the safety of Dependency Upgrade Verification Loops to a skeptical reviewer?
...
- A concise evidence note for Dependency Upgrade Verification Loops.
...
- [ ] The evidence supporting Dependency Upgrade Verification Loops is stronger than the assumptions.
