---
name: Backup Verification Strategy
trigger: backup verification strategy, help with backup verification strategy, plan backup verification strategy, improve backup verification strategy
description: Practical guidance for planning and executing backup verification strategy with clear scope, tradeoffs, and validation steps.
---

Backup Verification Strategy focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
