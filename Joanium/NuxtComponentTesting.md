---
name: Nuxt Component Testing
trigger: nuxt component testing, help with nuxt component testing, plan nuxt component testing, improve nuxt component testing, expert nuxt component testing
description: Expert-level guidance for nuxt component testing with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Nuxt Component Testing is an expert frontend skill for Nuxt. The focal concern is Component Testing, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Nuxt Component Testing affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Nuxt Component Testing make user state harder to reason about than it needs to be?
- Which interaction in Nuxt Component Testing degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Nuxt Component Testing would break if the DOM or state changed unexpectedly?
- How does Nuxt Component Testing fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Nuxt Component Testing looks correct in a mock but collapses under production behavior?
...
- A state transition map for Nuxt Component Testing.
...
- [ ] The state model for Nuxt Component Testing is clear enough to debug.
...
- [ ] Another engineer can extend Nuxt Component Testing without guessing hidden UI contracts.
