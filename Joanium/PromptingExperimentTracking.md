---
name: Prompting Experiment Tracking
trigger: prompting experiment tracking, help with prompting experiment tracking, plan prompting experiment tracking, improve prompting experiment tracking, expert prompting experiment tracking
description: Expert-level guidance for prompting experiment tracking with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Prompting Experiment Tracking is an expert applied-AI skill for Prompting. The focal concern is Experiment Tracking, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Prompting Experiment Tracking affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Prompting Experiment Tracking would look acceptable in a demo but fail under production ambiguity?
- Which part of Prompting Experiment Tracking lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Prompting Experiment Tracking fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Prompting Experiment Tracking is getting better rather than merely changing?
- Where should humans intervene in Prompting Experiment Tracking to add leverage instead of toil?
...
- A behavior contract for Prompting Experiment Tracking.
...
- [ ] The behavior contract for Prompting Experiment Tracking is explicit.
