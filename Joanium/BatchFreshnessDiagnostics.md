---
name: Batch Freshness Diagnostics
trigger: batch freshness diagnostics, help with batch freshness diagnostics, plan batch freshness diagnostics, improve batch freshness diagnostics
description: Practical guidance for planning and executing batch freshness diagnostics with clear scope, tradeoffs, and validation steps.
---

Batch Freshness Diagnostics helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
