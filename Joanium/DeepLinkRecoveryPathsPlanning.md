---
name: Deep Link Recovery Paths Planning
trigger: deep link recovery paths planning, help with deep link recovery paths planning, plan deep link recovery paths planning, improve deep link recovery paths planning, expert deep link recovery paths planning
description: Expert-level guidance for deep link recovery paths planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Deep Link Recovery Paths Planning is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Deep Link Recovery Paths Planning affects release risk, device behavior, or user trust during degraded conditions.
...
- What must be true before Deep Link Recovery Paths Planning can start safely?
...
- A milestone plan for Deep Link Recovery Paths Planning with explicit gating criteria.
