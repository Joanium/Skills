---
name: Prompt Safety Optimization
trigger: prompt safety optimization, help with prompt safety optimization, plan prompt safety optimization, improve prompt safety optimization
description: Practical guidance for planning and executing prompt safety optimization with clear scope, tradeoffs, and validation steps.
---

Prompt Safety Optimization helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
