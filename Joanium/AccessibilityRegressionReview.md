---
name: Accessibility Regression Review
trigger: accessibility regression review, help with accessibility regression review, plan accessibility regression review, improve accessibility regression review
description: Practical guidance for planning and executing accessibility regression review with clear scope, tradeoffs, and validation steps.
---

Accessibility Regression Review improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
