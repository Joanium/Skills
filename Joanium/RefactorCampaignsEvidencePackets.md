---
name: Refactor Campaigns Evidence Packets
trigger: refactor campaigns evidence packets, help with refactor campaigns evidence packets, plan refactor campaigns evidence packets, improve refactor campaigns evidence packets, expert refactor campaigns evidence packets
description: Expert-level guidance for refactor campaigns evidence packets with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Evidence Packets is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Evidence Packets, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Evidence Packets determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Evidence Packets riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Evidence Packets first, and what evidence would they need?
- How could Refactor Campaigns Evidence Packets fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Evidence Packets would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Evidence Packets concretely?
...
- A blast-radius note for Refactor Campaigns Evidence Packets.
...
- [ ] The repository-level blast radius of Refactor Campaigns Evidence Packets is explicit.
