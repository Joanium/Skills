---
name: Tool Use Latency Budgets
trigger: tool use latency budgets, help with tool use latency budgets, plan tool use latency budgets, improve tool use latency budgets, expert tool use latency budgets
description: Expert-level guidance for tool use latency budgets with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Tool Use Latency Budgets is an expert applied-AI skill for Tool Use. The focal concern is Latency Budgets, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Tool Use Latency Budgets affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Tool Use Latency Budgets would look acceptable in a demo but fail under production ambiguity?
- Which part of Tool Use Latency Budgets lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Tool Use Latency Budgets fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Tool Use Latency Budgets is getting better rather than merely changing?
- Where should humans intervene in Tool Use Latency Budgets to add leverage instead of toil?
...
- A behavior contract for Tool Use Latency Budgets.
...
- [ ] The behavior contract for Tool Use Latency Budgets is explicit.
