---
name: Device Trust Review
trigger: device trust review, help with device trust review, plan device trust review, improve device trust review
description: Practical guidance for planning and executing device trust review with clear scope, tradeoffs, and validation steps.
---

Device Trust Review is about reducing exploitable gaps by pairing preventive controls with review, evidence, and response readiness.
