---
name: Evaluation Datasets Design
trigger: evaluation datasets design, help with evaluation datasets design, plan evaluation datasets design, improve evaluation datasets design
description: Practical guidance for planning and executing evaluation datasets design with clear scope, tradeoffs, and validation steps.
---

Evaluation Datasets Design helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
