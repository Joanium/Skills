---
name: Distributed Systems Lab State Machines
trigger: distributed systems lab state machines, help with distributed systems lab state machines, plan distributed systems lab state machines, improve distributed systems lab state machines, expert distributed systems lab state machines
description: Expert-level guidance for distributed systems lab state machines with action-oriented workflow, review criteria, and failure patterns.
---

Distributed Systems Lab State Machines is an expert systems and deep-engineering skill for Distributed Systems Lab. The focal concern is State Machines, but the real objective is helping an AI reason about correctness, performance, and failure in technical domains where shallow intuition breaks down.

## When To Use

- Use this when Distributed Systems Lab State Machines involves constraints where correctness, timing, memory, or physical behavior dominate the design.
...
- Which resource or state boundary inside Distributed Systems Lab State Machines is least observable today?
- What hidden assumption in Distributed Systems Lab State Machines would break first under load, timing pressure, or hardware limits?
- How would the AI distinguish a correctness issue from a performance symptom in Distributed Systems Lab State Machines?
- What tooling gap makes Distributed Systems Lab State Machines harder to debug or verify than it should be?
- Which optimization target in Distributed Systems Lab State Machines is attractive but strategically secondary?
...
- A system model for Distributed Systems Lab State Machines naming resources, states, and key constraints.
...
- [ ] The operating envelope for Distributed Systems Lab State Machines is explicit.
