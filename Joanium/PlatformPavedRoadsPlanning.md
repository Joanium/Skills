---
name: Platform Paved Roads Planning
trigger: platform paved roads planning, help with platform paved roads planning, plan platform paved roads planning, improve platform paved roads planning, expert platform paved roads planning
description: Expert-level guidance for platform paved roads planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Platform Paved Roads Planning is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Platform Paved Roads Planning affects codebase shape, team interfaces, or long-term delivery speed.
...
- What must be true before Platform Paved Roads Planning can start safely?
...
- A milestone plan for Platform Paved Roads Planning with explicit gating criteria.
