---
name: Code Search Operations Evidence Packets
trigger: code search operations evidence packets, help with code search operations evidence packets, plan code search operations evidence packets, improve code search operations evidence packets, expert code search operations evidence packets
description: Expert-level guidance for code search operations evidence packets with action-oriented workflow, review criteria, and failure patterns.
---

Code Search Operations Evidence Packets is an expert repository and delivery skill for Code Search Operations. The focal concern is Evidence Packets, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Code Search Operations Evidence Packets determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Code Search Operations Evidence Packets riskier than the diff itself suggests?
- Which reviewer would challenge Code Search Operations Evidence Packets first, and what evidence would they need?
- How could Code Search Operations Evidence Packets fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Code Search Operations Evidence Packets would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Code Search Operations Evidence Packets concretely?
...
- A blast-radius note for Code Search Operations Evidence Packets.
...
- [ ] The repository-level blast radius of Code Search Operations Evidence Packets is explicit.
