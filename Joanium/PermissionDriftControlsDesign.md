---
name: Permission Drift Controls Design
trigger: permission drift controls design, help with permission drift controls design, plan permission drift controls design, improve permission drift controls design, expert permission drift controls design
description: Expert-level guidance for permission drift controls design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Permission Drift Controls Design is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Permission Drift Controls Design affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- What are the core boundaries, contracts, and invariants in Permission Drift Controls Design?
...
- An architecture or boundary diagram for Permission Drift Controls Design.
