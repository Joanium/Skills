---
name: Rendering Failure Containment Design
trigger: rendering failure containment design, help with rendering failure containment design, plan rendering failure containment design, improve rendering failure containment design, expert rendering failure containment design
description: Expert-level guidance for rendering failure containment design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Rendering Failure Containment Design is an expert-level frontend skill for making client behavior understandable, resilient, and consistent across design and engineering. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Rendering Failure Containment Design shapes user trust through responsiveness, clarity, or failure handling.
...
- What are the core boundaries, contracts, and invariants in Rendering Failure Containment Design?
...
- An architecture or boundary diagram for Rendering Failure Containment Design.
