---
name: TypeScript Refactor Mechanics
trigger: typescript refactor mechanics, help with typescript refactor mechanics, plan typescript refactor mechanics, improve typescript refactor mechanics, expert typescript refactor mechanics
description: Expert-level guidance for typescript refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

TypeScript Refactor Mechanics is an expert programming-language skill for TypeScript. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when TypeScript Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside TypeScript Refactor Mechanics?
- Which abstraction in TypeScript Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in TypeScript Refactor Mechanics first?
- How will TypeScript Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of TypeScript Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for TypeScript Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside TypeScript Refactor Mechanics.
...
- [ ] The main language-level risk in TypeScript Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend TypeScript Refactor Mechanics without reverse-engineering hidden contracts.
