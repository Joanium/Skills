---
name: Service Dependency Mapping Optimization
trigger: service dependency mapping optimization, help with service dependency mapping optimization, plan service dependency mapping optimization, improve service dependency mapping optimization, expert service dependency mapping optimization
description: Expert-level guidance for service dependency mapping optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Service Dependency Mapping Optimization is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Service Dependency Mapping Optimization changes service availability, deployment safety, or recovery behavior.
...
- What is the actual bottleneck in Service Dependency Mapping Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Service Dependency Mapping Optimization with representative workloads.
