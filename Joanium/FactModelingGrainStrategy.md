---
name: Fact Modeling Grain Strategy
trigger: fact modeling grain strategy, help with fact modeling grain strategy, plan fact modeling grain strategy, improve fact modeling grain strategy, expert fact modeling grain strategy
description: Expert-level guidance for fact modeling grain strategy, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---
...
- Use this when Fact Modeling Grain Strategy affects downstream metrics, decisions, or customer-facing data products.
...
- What decision is Fact Modeling Grain Strategy supposed to improve over the next planning horizon?
- Which constraints are fixed, and which are merely habits that can be challenged?
- Where does failure in Fact Modeling Grain Strategy create the largest technical, business, or trust cost?
...
- A written decision statement for Fact Modeling Grain Strategy.
