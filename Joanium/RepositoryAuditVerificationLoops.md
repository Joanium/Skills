---
name: Repository Audit Verification Loops
trigger: repository audit verification loops, help with repository audit verification loops, plan repository audit verification loops, improve repository audit verification loops, expert repository audit verification loops
description: Expert-level guidance for repository audit verification loops with action-oriented workflow, review criteria, and failure patterns.
---

Repository Audit Verification Loops is an expert coding workflow skill for Repository Audit. The focal concern is Verification Loops, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Repository Audit Verification Loops is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Repository Audit Verification Loops is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Repository Audit Verification Loops would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Repository Audit Verification Loops create a silent regression that tests may miss?
- How would the AI explain the safety of Repository Audit Verification Loops to a skeptical reviewer?
...
- A concise evidence note for Repository Audit Verification Loops.
...
- [ ] The evidence supporting Repository Audit Verification Loops is stronger than the assumptions.
