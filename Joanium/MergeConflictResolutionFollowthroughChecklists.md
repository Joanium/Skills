---
name: Merge Conflict Resolution Follow-through Checklists
trigger: merge conflict resolution follow-through checklists, help with merge conflict resolution follow-through checklists, plan merge conflict resolution follow-through checklists, improve merge conflict resolution follow-through checklists, expert merge conflict resolution follow-through checklists
description: Expert-level guidance for merge conflict resolution follow-through checklists with action-oriented workflow, review criteria, and failure patterns.
---

Merge Conflict Resolution Follow-through Checklists is an expert repository and delivery skill for Merge Conflict Resolution. The focal concern is Follow-through Checklists, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Merge Conflict Resolution Follow-through Checklists determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Merge Conflict Resolution Follow-through Checklists riskier than the diff itself suggests?
- Which reviewer would challenge Merge Conflict Resolution Follow-through Checklists first, and what evidence would they need?
- How could Merge Conflict Resolution Follow-through Checklists fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Merge Conflict Resolution Follow-through Checklists would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Merge Conflict Resolution Follow-through Checklists concretely?
...
- A blast-radius note for Merge Conflict Resolution Follow-through Checklists.
...
- [ ] The repository-level blast radius of Merge Conflict Resolution Follow-through Checklists is explicit.
