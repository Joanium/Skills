---
name: Metric Lineage Planning
trigger: metric lineage planning, help with metric lineage planning, plan metric lineage planning, improve metric lineage planning
description: Practical guidance for planning and executing metric lineage planning with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Planning helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
