---
name: Cluster Tenancy Design
trigger: cluster tenancy design, help with cluster tenancy design, plan cluster tenancy design, improve cluster tenancy design
description: Practical guidance for planning and executing cluster tenancy design with clear scope, tradeoffs, and validation steps.
---

Cluster Tenancy Design focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
