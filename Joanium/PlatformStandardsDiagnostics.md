---
name: Platform Standards Diagnostics
trigger: platform standards diagnostics, help with platform standards diagnostics, plan platform standards diagnostics, improve platform standards diagnostics
description: Practical guidance for planning and executing platform standards diagnostics with clear scope, tradeoffs, and validation steps.
---

Platform Standards Diagnostics improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
