---
name: Pull Request Triage Change Narratives
trigger: pull request triage change narratives, help with pull request triage change narratives, plan pull request triage change narratives, improve pull request triage change narratives, expert pull request triage change narratives
description: Expert-level guidance for pull request triage change narratives with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Change Narratives is an expert repository and delivery skill for Pull Request Triage. The focal concern is Change Narratives, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Change Narratives determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Change Narratives riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Change Narratives first, and what evidence would they need?
- How could Pull Request Triage Change Narratives fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Change Narratives would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Change Narratives concretely?
...
- A blast-radius note for Pull Request Triage Change Narratives.
...
- [ ] The repository-level blast radius of Pull Request Triage Change Narratives is explicit.
