---
name: Identity Platforms Migration Seams
trigger: identity platforms migration seams, help with identity platforms migration seams, plan identity platforms migration seams, improve identity platforms migration seams, expert identity platforms migration seams
description: Expert-level guidance for identity platforms migration seams with action-oriented workflow, review criteria, and failure patterns.
---

Identity Platforms Migration Seams is an expert architecture and systems skill for Identity Platforms. The focal concern is Migration Seams, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Identity Platforms Migration Seams needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Identity Platforms Migration Seams becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Identity Platforms Migration Seams is currently cheap only because the bill has not arrived yet?
- How would Identity Platforms Migration Seams be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Identity Platforms Migration Seams too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Identity Platforms Migration Seams.
...
- [ ] The key boundaries inside Identity Platforms Migration Seams are explicit and justified.
