---
name: Agents Failure Analysis
trigger: agents failure analysis, help with agents failure analysis, plan agents failure analysis, improve agents failure analysis, expert agents failure analysis
description: Expert-level guidance for agents failure analysis with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Agents Failure Analysis is an expert applied-AI skill for Agents. The focal concern is Failure Analysis, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Agents Failure Analysis affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Agents Failure Analysis would look acceptable in a demo but fail under production ambiguity?
- Which part of Agents Failure Analysis lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Agents Failure Analysis fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Agents Failure Analysis is getting better rather than merely changing?
- Where should humans intervene in Agents Failure Analysis to add leverage instead of toil?
...
- A behavior contract for Agents Failure Analysis.
...
- [ ] The behavior contract for Agents Failure Analysis is explicit.
