---
name: Evaluation Harnesses Tool Reliability
trigger: evaluation harnesses tool reliability, help with evaluation harnesses tool reliability, plan evaluation harnesses tool reliability, improve evaluation harnesses tool reliability, expert evaluation harnesses tool reliability
description: Expert-level guidance for evaluation harnesses tool reliability with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Evaluation Harnesses Tool Reliability is an expert applied-AI skill for Evaluation Harnesses. The focal concern is Tool Reliability, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Evaluation Harnesses Tool Reliability affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Evaluation Harnesses Tool Reliability would look acceptable in a demo but fail under production ambiguity?
- Which part of Evaluation Harnesses Tool Reliability lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Evaluation Harnesses Tool Reliability fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Evaluation Harnesses Tool Reliability is getting better rather than merely changing?
- Where should humans intervene in Evaluation Harnesses Tool Reliability to add leverage instead of toil?
...
- A behavior contract for Evaluation Harnesses Tool Reliability.
...
- [ ] The behavior contract for Evaluation Harnesses Tool Reliability is explicit.
