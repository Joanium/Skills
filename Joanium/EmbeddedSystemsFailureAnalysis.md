---
name: Embedded Systems Failure Analysis
trigger: embedded systems failure analysis, help with embedded systems failure analysis, plan embedded systems failure analysis, improve embedded systems failure analysis, expert embedded systems failure analysis
description: Expert-level guidance for embedded systems failure analysis with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Embedded Systems Failure Analysis is an expert systems skill for Embedded Systems. The focal concern is Failure Analysis, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Embedded Systems Failure Analysis is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Embedded Systems Failure Analysis would break first under scale, timing, or hardware stress?
- Which state or resource in Embedded Systems Failure Analysis is hardest to observe when behavior goes wrong?
- How does Embedded Systems Failure Analysis trade correctness, throughput, and recoverability today?
- What tooling gap makes Embedded Systems Failure Analysis harder to reason about than it should be?
- Which optimization target inside Embedded Systems Failure Analysis is attractive but strategically secondary?
...
- A system model for Embedded Systems Failure Analysis that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Embedded Systems Failure Analysis is explicit.
