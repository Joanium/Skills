---
name: GitHub Actions Policy Automation
trigger: github actions policy automation, help with github actions policy automation, plan github actions policy automation, improve github actions policy automation, expert github actions policy automation
description: Expert-level guidance for github actions policy automation with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GitHub Actions Policy Automation is an expert cloud and platform skill for GitHub Actions. The focal concern is Policy Automation, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when GitHub Actions Policy Automation changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside GitHub Actions Policy Automation would fail first during a rushed rollout or incident?
- Which control in GitHub Actions Policy Automation is automated but not truly reversible?
- How will operators know whether GitHub Actions Policy Automation is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in GitHub Actions Policy Automation is invisible until it becomes expensive?
- Which dependency makes GitHub Actions Policy Automation less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for GitHub Actions Policy Automation.
...
- [ ] The rollback path for GitHub Actions Policy Automation is explicit and tested.
