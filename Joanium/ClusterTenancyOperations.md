---
name: Cluster Tenancy Operations
trigger: cluster tenancy operations, help with cluster tenancy operations, plan cluster tenancy operations, improve cluster tenancy operations
description: Practical guidance for planning and executing cluster tenancy operations with clear scope, tradeoffs, and validation steps.
---

Cluster Tenancy Operations focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
