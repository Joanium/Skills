---
name: Event Taxonomy Operations
trigger: event taxonomy operations, help with event taxonomy operations, plan event taxonomy operations, improve event taxonomy operations
description: Practical guidance for planning and executing event taxonomy operations with clear scope, tradeoffs, and validation steps.
---

Event Taxonomy Operations helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
