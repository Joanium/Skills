---
name: Next.js Design System Adoption
trigger: next.js design system adoption, help with next.js design system adoption, plan next.js design system adoption, improve next.js design system adoption, expert next.js design system adoption
description: Expert-level guidance for next.js design system adoption with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Next.js Design System Adoption is an expert frontend skill for Next.js. The focal concern is Design System Adoption, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Next.js Design System Adoption affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Next.js Design System Adoption make user state harder to reason about than it needs to be?
- Which interaction in Next.js Design System Adoption degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Next.js Design System Adoption would break if the DOM or state changed unexpectedly?
- How does Next.js Design System Adoption fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Next.js Design System Adoption looks correct in a mock but collapses under production behavior?
...
- A state transition map for Next.js Design System Adoption.
...
- [ ] The state model for Next.js Design System Adoption is clear enough to debug.
...
- [ ] Another engineer can extend Next.js Design System Adoption without guessing hidden UI contracts.
