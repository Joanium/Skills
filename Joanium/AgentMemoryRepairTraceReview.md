---
name: Agent Memory Repair Trace Review
trigger: agent memory repair trace review, help with agent memory repair trace review, plan agent memory repair trace review, improve agent memory repair trace review, expert agent memory repair trace review
description: Expert-level guidance for agent memory repair trace review with action-oriented workflow, review criteria, and failure patterns.
---

Agent Memory Repair Trace Review is an expert agent and tooling skill for Agent Memory Repair. The focal concern is Trace Review, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Agent Memory Repair Trace Review affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Agent Memory Repair Trace Review is still governed by intuition instead of a contract or label set?
- Which failure in Agent Memory Repair Trace Review would be hardest to detect before it compounds?
- How would Agent Memory Repair Trace Review behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Agent Memory Repair Trace Review?
...
- A contract and failure-label set for Agent Memory Repair Trace Review.
...
- [ ] The system behind Agent Memory Repair Trace Review is described more clearly than the prompt surface.
