---
name: GraphQL Pagination Systems
trigger: graphql pagination systems, help with graphql pagination systems, plan graphql pagination systems, improve graphql pagination systems, expert graphql pagination systems
description: Expert-level guidance for graphql pagination systems with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GraphQL Pagination Systems is an expert backend skill for GraphQL. The focal concern is Pagination Systems, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when GraphQL Pagination Systems shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside GraphQL Pagination Systems breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in GraphQL Pagination Systems?
- Where does GraphQL Pagination Systems need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether GraphQL Pagination Systems is unhealthy before customers do?
- What compatibility promise is implied by GraphQL Pagination Systems even if it was never written down?
...
- A contract note for GraphQL Pagination Systems that includes failure semantics.
...
- [ ] The contract for GraphQL Pagination Systems is explicit about success and failure behavior.
