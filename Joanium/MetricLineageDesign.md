---
name: Metric Lineage Design
trigger: metric lineage design, help with metric lineage design, plan metric lineage design, improve metric lineage design
description: Practical guidance for planning and executing metric lineage design with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Design helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
