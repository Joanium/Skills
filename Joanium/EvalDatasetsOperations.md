---
name: Evaluation Datasets Operations
trigger: evaluation datasets operations, help with evaluation datasets operations, plan evaluation datasets operations, improve evaluation datasets operations
description: Practical guidance for planning and executing evaluation datasets operations with clear scope, tradeoffs, and validation steps.
---

Evaluation Datasets Operations helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
