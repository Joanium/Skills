---
name: Retrieval Chunking Policies Design
trigger: retrieval chunking policies design, help with retrieval chunking policies design, plan retrieval chunking policies design, improve retrieval chunking policies design, expert retrieval chunking policies design
description: Expert-level guidance for retrieval chunking policies design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Retrieval Chunking Policies Design is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Retrieval Chunking Policies Design influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the core boundaries, contracts, and invariants in Retrieval Chunking Policies Design?
...
- An architecture or boundary diagram for Retrieval Chunking Policies Design.
