---
name: Algorithms Performance Models
trigger: algorithms performance models, help with algorithms performance models, plan algorithms performance models, improve algorithms performance models, expert algorithms performance models
description: Expert-level guidance for algorithms performance models with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Algorithms Performance Models is an expert systems skill for Algorithms. The focal concern is Performance Models, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Algorithms Performance Models is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Algorithms Performance Models would break first under scale, timing, or hardware stress?
- Which state or resource in Algorithms Performance Models is hardest to observe when behavior goes wrong?
- How does Algorithms Performance Models trade correctness, throughput, and recoverability today?
- What tooling gap makes Algorithms Performance Models harder to reason about than it should be?
- Which optimization target inside Algorithms Performance Models is attractive but strategically secondary?
...
- A system model for Algorithms Performance Models that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Algorithms Performance Models is explicit.
