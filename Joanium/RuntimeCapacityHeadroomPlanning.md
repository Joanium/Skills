---
name: Runtime Capacity Headroom Planning
trigger: runtime capacity headroom planning, help with runtime capacity headroom planning, plan runtime capacity headroom planning, improve runtime capacity headroom planning, expert runtime capacity headroom planning
description: Expert-level guidance for runtime capacity headroom planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Runtime Capacity Headroom Planning is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Runtime Capacity Headroom Planning changes service availability, deployment safety, or recovery behavior.
...
- What must be true before Runtime Capacity Headroom Planning can start safely?
...
- A milestone plan for Runtime Capacity Headroom Planning with explicit gating criteria.
