---
name: Upgrade Wave Planning Optimization
trigger: upgrade wave planning optimization, help with upgrade wave planning optimization, plan upgrade wave planning optimization, improve upgrade wave planning optimization, expert upgrade wave planning optimization
description: Expert-level guidance for upgrade wave planning optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Upgrade Wave Planning Optimization is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Upgrade Wave Planning Optimization affects codebase shape, team interfaces, or long-term delivery speed.
...
- What is the actual bottleneck in Upgrade Wave Planning Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Upgrade Wave Planning Optimization with representative workloads.
