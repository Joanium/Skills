---
name: Terraform Automation Safety
trigger: terraform automation safety, help with terraform automation safety, plan terraform automation safety, improve terraform automation safety, expert terraform automation safety
description: Expert-level guidance for terraform automation safety with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Terraform Automation Safety is an expert cloud and platform skill for Terraform. The focal concern is Automation Safety, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when Terraform Automation Safety changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside Terraform Automation Safety would fail first during a rushed rollout or incident?
- Which control in Terraform Automation Safety is automated but not truly reversible?
- How will operators know whether Terraform Automation Safety is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in Terraform Automation Safety is invisible until it becomes expensive?
- Which dependency makes Terraform Automation Safety less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for Terraform Automation Safety.
...
- [ ] The rollback path for Terraform Automation Safety is explicit and tested.
