---
name: Client State Recoverability Planning
trigger: client state recoverability planning, help with client state recoverability planning, plan client state recoverability planning, improve client state recoverability planning, expert client state recoverability planning
description: Expert-level guidance for client state recoverability planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Client State Recoverability Planning is an expert-level frontend skill for making client behavior understandable, resilient, and consistent across design and engineering. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Client State Recoverability Planning shapes user trust through responsiveness, clarity, or failure handling.
...
- What must be true before Client State Recoverability Planning can start safely?
...
- A milestone plan for Client State Recoverability Planning with explicit gating criteria.
