---
name: Model Quality Rubrics Planning
trigger: model quality rubrics planning, help with model quality rubrics planning, plan model quality rubrics planning, improve model quality rubrics planning, expert model quality rubrics planning
description: Expert-level guidance for model quality rubrics planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Model Quality Rubrics Planning is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Model Quality Rubrics Planning influences user-visible output, automation, or safety-sensitive decisions.
...
- What must be true before Model Quality Rubrics Planning can start safely?
...
- A milestone plan for Model Quality Rubrics Planning with explicit gating criteria.
