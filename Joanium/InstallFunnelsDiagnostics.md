---
name: Install Funnels Diagnostics
trigger: install funnels diagnostics, help with install funnels diagnostics, plan install funnels diagnostics, improve install funnels diagnostics
description: Practical guidance for planning and executing install funnels diagnostics with clear scope, tradeoffs, and validation steps.
---

Install Funnels Diagnostics focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
