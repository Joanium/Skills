---
name: Session Replay Analysis Artifact Capture
trigger: session replay analysis artifact capture, help with session replay analysis artifact capture, plan session replay analysis artifact capture, improve session replay analysis artifact capture, expert session replay analysis artifact capture
description: Expert-level guidance for session replay analysis artifact capture with action-oriented workflow, review criteria, and failure patterns.
---

Session Replay Analysis Artifact Capture is an expert browser automation skill for Session Replay Analysis. The focal concern is Artifact Capture, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Session Replay Analysis Artifact Capture needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Session Replay Analysis Artifact Capture unreliable across runs?
- Which timing or selector assumption in Session Replay Analysis Artifact Capture is least stable under real conditions?
- How would Session Replay Analysis Artifact Capture behave differently across browsers, profiles, or CI environments?
- What artifacts should Session Replay Analysis Artifact Capture capture so the next failure is diagnosable instead of mysterious?
- Which part of Session Replay Analysis Artifact Capture is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Session Replay Analysis Artifact Capture.
...
- [ ] The state model behind Session Replay Analysis Artifact Capture is explicit.
