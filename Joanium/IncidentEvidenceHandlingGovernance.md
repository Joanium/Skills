---
name: Incident Evidence Handling Governance
trigger: incident evidence handling governance, help with incident evidence handling governance, plan incident evidence handling governance, improve incident evidence handling governance, expert incident evidence handling governance
description: Expert-level guidance for incident evidence handling governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Incident Evidence Handling Governance is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Incident Evidence Handling Governance affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- Who sets the policy for Incident Evidence Handling Governance, and who is allowed to grant exceptions?
...
- A policy document for Incident Evidence Handling Governance with explicit scope.
