---
name: Architecture Fitness Functions Design
trigger: architecture fitness functions design, help with architecture fitness functions design, plan architecture fitness functions design, improve architecture fitness functions design, expert architecture fitness functions design
description: Expert-level guidance for architecture fitness functions design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Architecture Fitness Functions Design is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Architecture Fitness Functions Design affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the core boundaries, contracts, and invariants in Architecture Fitness Functions Design?
...
- An architecture or boundary diagram for Architecture Fitness Functions Design.
