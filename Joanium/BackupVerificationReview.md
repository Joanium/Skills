---
name: Backup Verification Review
trigger: backup verification review, help with backup verification review, plan backup verification review, improve backup verification review
description: Practical guidance for planning and executing backup verification review with clear scope, tradeoffs, and validation steps.
---

Backup Verification Review focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
