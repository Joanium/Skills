---
name: Design Tokens Diagnostics
trigger: design tokens diagnostics, help with design tokens diagnostics, plan design tokens diagnostics, improve design tokens diagnostics
description: Practical guidance for planning and executing design tokens diagnostics with clear scope, tradeoffs, and validation steps.
---

Design Tokens Diagnostics improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
