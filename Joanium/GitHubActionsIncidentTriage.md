---
name: GitHub Actions Incident Triage
trigger: github actions incident triage, help with github actions incident triage, plan github actions incident triage, improve github actions incident triage, expert github actions incident triage
description: Expert-level guidance for github actions incident triage with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GitHub Actions Incident Triage is an expert cloud and platform skill for GitHub Actions. The focal concern is Incident Triage, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when GitHub Actions Incident Triage changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside GitHub Actions Incident Triage would fail first during a rushed rollout or incident?
- Which control in GitHub Actions Incident Triage is automated but not truly reversible?
- How will operators know whether GitHub Actions Incident Triage is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in GitHub Actions Incident Triage is invisible until it becomes expensive?
- Which dependency makes GitHub Actions Incident Triage less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for GitHub Actions Incident Triage.
...
- [ ] The rollback path for GitHub Actions Incident Triage is explicit and tested.
