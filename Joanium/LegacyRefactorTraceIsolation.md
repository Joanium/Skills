---
name: Legacy Refactor Trace Isolation
trigger: legacy refactor trace isolation, help with legacy refactor trace isolation, plan legacy refactor trace isolation, improve legacy refactor trace isolation, expert legacy refactor trace isolation
description: Expert-level guidance for legacy refactor trace isolation with action-oriented workflow, review criteria, and failure patterns.
---

Legacy Refactor Trace Isolation is an expert coding workflow skill for Legacy Refactor. The focal concern is Trace Isolation, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Legacy Refactor Trace Isolation is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Legacy Refactor Trace Isolation is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Legacy Refactor Trace Isolation would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Legacy Refactor Trace Isolation create a silent regression that tests may miss?
- How would the AI explain the safety of Legacy Refactor Trace Isolation to a skeptical reviewer?
...
- A concise evidence note for Legacy Refactor Trace Isolation.
...
- [ ] The evidence supporting Legacy Refactor Trace Isolation is stronger than the assumptions.
