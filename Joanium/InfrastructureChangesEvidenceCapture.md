---
name: Infrastructure Changes Evidence Capture
trigger: infrastructure changes evidence capture, help with infrastructure changes evidence capture, plan infrastructure changes evidence capture, improve infrastructure changes evidence capture, expert infrastructure changes evidence capture
description: Expert-level guidance for infrastructure changes evidence capture with action-oriented workflow, review criteria, and failure patterns.
---

Infrastructure Changes Evidence Capture is an expert platform and automation skill for Infrastructure Changes. The focal concern is Evidence Capture, but the real objective is helping an AI make infrastructure and operational change without creating invisible blast radius.

## When To Use

- Use this when Infrastructure Changes Evidence Capture can affect deployment safety, service recovery, or operator trust in automation.
...
- What part of Infrastructure Changes Evidence Capture could fail silently while the automation still reports success?
- Which rollback or recovery step inside Infrastructure Changes Evidence Capture depends too much on tribal memory?
- How will operators know when Infrastructure Changes Evidence Capture should stop, wait, or reverse course?
- Where does Infrastructure Changes Evidence Capture blur access, policy, and execution boundaries dangerously?
...
- A change-and-recovery map for Infrastructure Changes Evidence Capture.
...
- [ ] The rollback model for Infrastructure Changes Evidence Capture is as real as the forward path.
