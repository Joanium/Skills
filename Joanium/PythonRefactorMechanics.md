---
name: Python Refactor Mechanics
trigger: python refactor mechanics, help with python refactor mechanics, plan python refactor mechanics, improve python refactor mechanics, expert python refactor mechanics
description: Expert-level guidance for python refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Python Refactor Mechanics is an expert programming-language skill for Python. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Python Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Python Refactor Mechanics?
- Which abstraction in Python Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Python Refactor Mechanics first?
- How will Python Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of Python Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Python Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside Python Refactor Mechanics.
...
- [ ] The main language-level risk in Python Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend Python Refactor Mechanics without reverse-engineering hidden contracts.
