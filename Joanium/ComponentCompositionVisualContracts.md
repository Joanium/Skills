---
name: Component Composition Visual Contracts
trigger: component composition visual contracts, help with component composition visual contracts, plan component composition visual contracts, improve component composition visual contracts, expert component composition visual contracts
description: Expert-level guidance for component composition visual contracts with action-oriented workflow, review criteria, and failure patterns.
---

Component Composition Visual Contracts is an expert frontend implementation skill for Component Composition. The focal concern is Visual Contracts, but the real objective is helping an AI create UI behavior that stays understandable when state, rendering, latency, and devices stop cooperating.

## When To Use

- Use this when Component Composition Visual Contracts affects whether a frontend change will remain coherent outside the happy path.
...
- What part of Component Composition Visual Contracts becomes hardest to reason about when the UI is slow or inconsistent?
- Which state transition inside Component Composition Visual Contracts would fail silently without stronger instrumentation?
- How does Component Composition Visual Contracts behave when the browser, network, or input method stops being ideal?
- What implementation choice in Component Composition Visual Contracts most threatens the original design intent?
- Which regression in Component Composition Visual Contracts would users notice long before the team does?
...
- A state and edge-case map for Component Composition Visual Contracts.
...
- [ ] The behavioral contract behind Component Composition Visual Contracts is clearer than the implementation shortcuts.
