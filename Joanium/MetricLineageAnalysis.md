---
name: Metric Lineage Analysis
trigger: metric lineage analysis, help with metric lineage analysis, plan metric lineage analysis, improve metric lineage analysis
description: Practical guidance for planning and executing metric lineage analysis with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Analysis helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
