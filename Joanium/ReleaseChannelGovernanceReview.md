---
name: Release Channel Governance Review
trigger: release channel governance review, help with release channel governance review, plan release channel governance review, improve release channel governance review, expert release channel governance review
description: Expert-level guidance for release channel governance review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Release Channel Governance Review is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Release Channel Governance Review affects release risk, device behavior, or user trust during degraded conditions.
...
- What claims about Release Channel Governance Review are supported by evidence, and which are still assertions?
...
- A review summary for Release Channel Governance Review with clear approval status.
