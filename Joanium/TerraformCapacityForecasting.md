---
name: Terraform Capacity Forecasting
trigger: terraform capacity forecasting, help with terraform capacity forecasting, plan terraform capacity forecasting, improve terraform capacity forecasting, expert terraform capacity forecasting
description: Expert-level guidance for terraform capacity forecasting with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Terraform Capacity Forecasting is an expert cloud and platform skill for Terraform. The focal concern is Capacity Forecasting, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when Terraform Capacity Forecasting changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside Terraform Capacity Forecasting would fail first during a rushed rollout or incident?
- Which control in Terraform Capacity Forecasting is automated but not truly reversible?
- How will operators know whether Terraform Capacity Forecasting is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in Terraform Capacity Forecasting is invisible until it becomes expensive?
- Which dependency makes Terraform Capacity Forecasting less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for Terraform Capacity Forecasting.
...
- [ ] The rollback path for Terraform Capacity Forecasting is explicit and tested.
