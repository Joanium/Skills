---
name: Threat Scenario Catalogs Planning
trigger: threat scenario catalogs planning, help with threat scenario catalogs planning, plan threat scenario catalogs planning, improve threat scenario catalogs planning, expert threat scenario catalogs planning
description: Expert-level guidance for threat scenario catalogs planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Threat Scenario Catalogs Planning is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Threat Scenario Catalogs Planning affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- What must be true before Threat Scenario Catalogs Planning can start safely?
...
- A milestone plan for Threat Scenario Catalogs Planning with explicit gating criteria.
