---
name: Legacy Boundary Extraction Design
trigger: legacy boundary extraction design, help with legacy boundary extraction design, plan legacy boundary extraction design, improve legacy boundary extraction design, expert legacy boundary extraction design
description: Expert-level guidance for legacy boundary extraction design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Legacy Boundary Extraction Design is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Legacy Boundary Extraction Design affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the core boundaries, contracts, and invariants in Legacy Boundary Extraction Design?
...
- An architecture or boundary diagram for Legacy Boundary Extraction Design.
