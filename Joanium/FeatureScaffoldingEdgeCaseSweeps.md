---
name: Feature Scaffolding Edge Case Sweeps
trigger: feature scaffolding edge case sweeps, help with feature scaffolding edge case sweeps, plan feature scaffolding edge case sweeps, improve feature scaffolding edge case sweeps, expert feature scaffolding edge case sweeps
description: Expert-level guidance for feature scaffolding edge case sweeps with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Edge Case Sweeps is an expert coding workflow skill for Feature Scaffolding. The focal concern is Edge Case Sweeps, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Edge Case Sweeps is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Edge Case Sweeps is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Edge Case Sweeps would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Edge Case Sweeps create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Edge Case Sweeps to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Edge Case Sweeps.
...
- [ ] The evidence supporting Feature Scaffolding Edge Case Sweeps is stronger than the assumptions.
