---
name: Test Flake Reduction Planning
trigger: test flake reduction planning, help with test flake reduction planning, plan test flake reduction planning, improve test flake reduction planning
description: Practical guidance for planning and executing test flake reduction planning with clear scope, tradeoffs, and validation steps.
---

Test Flake Reduction Planning improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
