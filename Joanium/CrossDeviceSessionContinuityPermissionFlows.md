---
name: Cross-device Session Continuity Permission Flows
trigger: cross-device session continuity permission flows, help with cross-device session continuity permission flows, plan cross-device session continuity permission flows, improve cross-device session continuity permission flows, expert cross-device session continuity permission flows
description: Expert-level guidance for cross-device session continuity permission flows with client delivery workflow, review criteria, and failure patterns.
---

Cross-device Session Continuity Permission Flows is an expert mobile and desktop delivery skill for Cross-device Session Continuity. The focal concern is Permission Flows, but the real objective is helping an AI ship client software that survives device constraints, stores, upgrades, and real user recovery paths.

## When To Use

- Use this when Cross-device Session Continuity Permission Flows affects whether client software remains trustworthy across devices, upgrades, and degraded conditions.
...
- Which user or device condition would expose the weakest assumption in Cross-device Session Continuity Permission Flows first?
- How will Cross-device Session Continuity Permission Flows behave during upgrade, rollback, or stale local state?
- What store, signing, or permission dependency could block or confuse Cross-device Session Continuity Permission Flows unexpectedly?
- How would support or operations diagnose Cross-device Session Continuity Permission Flows from telemetry instead of guesswork?
- What path inside Cross-device Session Continuity Permission Flows should help the user recover rather than merely fail loudly?
...
- A device and release risk note for Cross-device Session Continuity Permission Flows.
...
- [ ] The device, store, and upgrade assumptions behind Cross-device Session Continuity Permission Flows are explicit.
