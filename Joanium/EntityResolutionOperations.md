---
name: Entity Resolution Operations
trigger: entity resolution operations, help with entity resolution operations, plan entity resolution operations, improve entity resolution operations
description: Practical guidance for planning and executing entity resolution operations with clear scope, tradeoffs, and validation steps.
---

Entity Resolution Operations helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
