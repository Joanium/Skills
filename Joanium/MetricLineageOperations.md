---
name: Metric Lineage Operations
trigger: metric lineage operations, help with metric lineage operations, plan metric lineage operations, improve metric lineage operations
description: Practical guidance for planning and executing metric lineage operations with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Operations helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
