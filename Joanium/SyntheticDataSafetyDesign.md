---
name: Synthetic Data Safety Design
trigger: synthetic data safety design, help with synthetic data safety design, plan synthetic data safety design, improve synthetic data safety design, expert synthetic data safety design
description: Expert-level guidance for synthetic data safety design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Synthetic Data Safety Design is an expert applied-AI skill for Synthetic Data. The focal concern is Safety Design, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Synthetic Data Safety Design affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Synthetic Data Safety Design would look acceptable in a demo but fail under production ambiguity?
- Which part of Synthetic Data Safety Design lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Synthetic Data Safety Design fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Synthetic Data Safety Design is getting better rather than merely changing?
- Where should humans intervene in Synthetic Data Safety Design to add leverage instead of toil?
...
- A behavior contract for Synthetic Data Safety Design.
...
- [ ] The behavior contract for Synthetic Data Safety Design is explicit.
