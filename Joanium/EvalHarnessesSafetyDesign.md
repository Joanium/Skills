---
name: Evaluation Harnesses Safety Design
trigger: evaluation harnesses safety design, help with evaluation harnesses safety design, plan evaluation harnesses safety design, improve evaluation harnesses safety design, expert evaluation harnesses safety design
description: Expert-level guidance for evaluation harnesses safety design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Evaluation Harnesses Safety Design is an expert applied-AI skill for Evaluation Harnesses. The focal concern is Safety Design, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Evaluation Harnesses Safety Design affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Evaluation Harnesses Safety Design would look acceptable in a demo but fail under production ambiguity?
- Which part of Evaluation Harnesses Safety Design lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Evaluation Harnesses Safety Design fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Evaluation Harnesses Safety Design is getting better rather than merely changing?
- Where should humans intervene in Evaluation Harnesses Safety Design to add leverage instead of toil?
...
- A behavior contract for Evaluation Harnesses Safety Design.
...
- [ ] The behavior contract for Evaluation Harnesses Safety Design is explicit.
