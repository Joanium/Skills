---
name: Refactor Campaigns Diff Compression
trigger: refactor campaigns diff compression, help with refactor campaigns diff compression, plan refactor campaigns diff compression, improve refactor campaigns diff compression, expert refactor campaigns diff compression
description: Expert-level guidance for refactor campaigns diff compression with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Diff Compression is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Diff Compression, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Diff Compression determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Diff Compression riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Diff Compression first, and what evidence would they need?
- How could Refactor Campaigns Diff Compression fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Diff Compression would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Diff Compression concretely?
...
- A blast-radius note for Refactor Campaigns Diff Compression.
...
- [ ] The repository-level blast radius of Refactor Campaigns Diff Compression is explicit.
