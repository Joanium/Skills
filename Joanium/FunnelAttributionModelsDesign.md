---
name: Funnel Attribution Models Design
trigger: funnel attribution models design, help with funnel attribution models design, plan funnel attribution models design, improve funnel attribution models design, expert funnel attribution models design
description: Expert-level guidance for funnel attribution models design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Funnel Attribution Models Design is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Funnel Attribution Models Design affects acquisition, narrative clarity, or cross-channel execution.
...
- What are the core boundaries, contracts, and invariants in Funnel Attribution Models Design?
...
- An architecture or boundary diagram for Funnel Attribution Models Design.
