---
name: Event Taxonomy Strategy
trigger: event taxonomy strategy, help with event taxonomy strategy, plan event taxonomy strategy, improve event taxonomy strategy
description: Practical guidance for planning and executing event taxonomy strategy with clear scope, tradeoffs, and validation steps.
---

Event Taxonomy Strategy helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
