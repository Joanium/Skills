---
name: Modular Monoliths Dependency Graphs
trigger: modular monoliths dependency graphs, help with modular monoliths dependency graphs, plan modular monoliths dependency graphs, improve modular monoliths dependency graphs, expert modular monoliths dependency graphs
description: Expert-level guidance for modular monoliths dependency graphs with action-oriented workflow, review criteria, and failure patterns.
---

Modular Monoliths Dependency Graphs is an expert architecture and systems skill for Modular Monoliths. The focal concern is Dependency Graphs, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Modular Monoliths Dependency Graphs needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Modular Monoliths Dependency Graphs becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Modular Monoliths Dependency Graphs is currently cheap only because the bill has not arrived yet?
- How would Modular Monoliths Dependency Graphs be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Modular Monoliths Dependency Graphs too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Modular Monoliths Dependency Graphs.
...
- [ ] The key boundaries inside Modular Monoliths Dependency Graphs are explicit and justified.
