---
name: Robotics Architecture Patterns
trigger: robotics architecture patterns, help with robotics architecture patterns, plan robotics architecture patterns, improve robotics architecture patterns, expert robotics architecture patterns
description: Expert-level guidance for robotics architecture patterns with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Robotics Architecture Patterns is an expert systems skill for Robotics. The focal concern is Architecture Patterns, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Robotics Architecture Patterns is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Robotics Architecture Patterns would break first under scale, timing, or hardware stress?
- Which state or resource in Robotics Architecture Patterns is hardest to observe when behavior goes wrong?
- How does Robotics Architecture Patterns trade correctness, throughput, and recoverability today?
- What tooling gap makes Robotics Architecture Patterns harder to reason about than it should be?
- Which optimization target inside Robotics Architecture Patterns is attractive but strategically secondary?
...
- A system model for Robotics Architecture Patterns that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Robotics Architecture Patterns is explicit.
