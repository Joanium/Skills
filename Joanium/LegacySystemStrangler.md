---
name: Legacy System Strangler
trigger: legacy system strangler, help with legacy system strangler, plan legacy system strangler, improve legacy system strangler
description: Practical guidance for planning and executing legacy system strangler with clear scope, tradeoffs, and validation steps.
---

Legacy System Strangler is about improving engineering systems by making architecture and delivery rules explicit, reviewable, and repeatable.
