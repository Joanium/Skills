---
name: Contract Evolution Rules Planning
trigger: contract evolution rules planning, help with contract evolution rules planning, plan contract evolution rules planning, improve contract evolution rules planning, expert contract evolution rules planning
description: Expert-level guidance for contract evolution rules planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Contract Evolution Rules Planning is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Contract Evolution Rules Planning affects codebase shape, team interfaces, or long-term delivery speed.
...
- What must be true before Contract Evolution Rules Planning can start safely?
...
- A milestone plan for Contract Evolution Rules Planning with explicit gating criteria.
