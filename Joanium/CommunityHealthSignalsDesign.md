---
name: Community Health Signals Design
trigger: community health signals design, help with community health signals design, plan community health signals design, improve community health signals design, expert community health signals design
description: Expert-level guidance for community health signals design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Community Health Signals Design is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Community Health Signals Design affects acquisition, narrative clarity, or cross-channel execution.
...
- What are the core boundaries, contracts, and invariants in Community Health Signals Design?
...
- An architecture or boundary diagram for Community Health Signals Design.
