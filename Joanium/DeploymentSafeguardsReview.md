---
name: Deployment Safeguards Review
trigger: deployment safeguards review, help with deployment safeguards review, plan deployment safeguards review, improve deployment safeguards review, expert deployment safeguards review
description: Expert-level guidance for deployment safeguards review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Deployment Safeguards Review is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Deployment Safeguards Review changes service availability, deployment safety, or recovery behavior.
...
- What claims about Deployment Safeguards Review are supported by evidence, and which are still assertions?
...
- A review summary for Deployment Safeguards Review with clear approval status.
