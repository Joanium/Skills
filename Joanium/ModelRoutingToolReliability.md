---
name: Model Routing Tool Reliability
trigger: model routing tool reliability, help with model routing tool reliability, plan model routing tool reliability, improve model routing tool reliability, expert model routing tool reliability
description: Expert-level guidance for model routing tool reliability with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Model Routing Tool Reliability is an expert applied-AI skill for Model Routing. The focal concern is Tool Reliability, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Model Routing Tool Reliability affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Model Routing Tool Reliability would look acceptable in a demo but fail under production ambiguity?
- Which part of Model Routing Tool Reliability lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Model Routing Tool Reliability fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Model Routing Tool Reliability is getting better rather than merely changing?
- Where should humans intervene in Model Routing Tool Reliability to add leverage instead of toil?
...
- A behavior contract for Model Routing Tool Reliability.
...
- [ ] The behavior contract for Model Routing Tool Reliability is explicit.
