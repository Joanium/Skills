---
name: Safety Escalation Paths Design
trigger: safety escalation paths design, help with safety escalation paths design, plan safety escalation paths design, improve safety escalation paths design, expert safety escalation paths design
description: Expert-level guidance for safety escalation paths design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Safety Escalation Paths Design is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Safety Escalation Paths Design influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the core boundaries, contracts, and invariants in Safety Escalation Paths Design?
...
- An architecture or boundary diagram for Safety Escalation Paths Design.
