---
name: RAG Tool Reliability
trigger: rag tool reliability, help with rag tool reliability, plan rag tool reliability, improve rag tool reliability, expert rag tool reliability
description: Expert-level guidance for rag tool reliability with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

RAG Tool Reliability is an expert applied-AI skill for RAG. The focal concern is Tool Reliability, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when RAG Tool Reliability affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in RAG Tool Reliability would look acceptable in a demo but fail under production ambiguity?
- Which part of RAG Tool Reliability lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will RAG Tool Reliability fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that RAG Tool Reliability is getting better rather than merely changing?
- Where should humans intervene in RAG Tool Reliability to add leverage instead of toil?
...
- A behavior contract for RAG Tool Reliability.
...
- [ ] The behavior contract for RAG Tool Reliability is explicit.
