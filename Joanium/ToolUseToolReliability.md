---
name: Tool Use Tool Reliability
trigger: tool use tool reliability, help with tool use tool reliability, plan tool use tool reliability, improve tool use tool reliability, expert tool use tool reliability
description: Expert-level guidance for tool use tool reliability with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Tool Use Tool Reliability is an expert applied-AI skill for Tool Use. The focal concern is Tool Reliability, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Tool Use Tool Reliability affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Tool Use Tool Reliability would look acceptable in a demo but fail under production ambiguity?
- Which part of Tool Use Tool Reliability lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Tool Use Tool Reliability fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Tool Use Tool Reliability is getting better rather than merely changing?
- Where should humans intervene in Tool Use Tool Reliability to add leverage instead of toil?
...
- A behavior contract for Tool Use Tool Reliability.
...
- [ ] The behavior contract for Tool Use Tool Reliability is explicit.
