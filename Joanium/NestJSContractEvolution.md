---
name: NestJS Contract Evolution
trigger: nestjs contract evolution, help with nestjs contract evolution, plan nestjs contract evolution, improve nestjs contract evolution, expert nestjs contract evolution
description: Expert-level guidance for nestjs contract evolution with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

NestJS Contract Evolution is an expert backend skill for NestJS. The focal concern is Contract Evolution, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when NestJS Contract Evolution shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside NestJS Contract Evolution breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in NestJS Contract Evolution?
- Where does NestJS Contract Evolution need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether NestJS Contract Evolution is unhealthy before customers do?
- What compatibility promise is implied by NestJS Contract Evolution even if it was never written down?
...
- A contract note for NestJS Contract Evolution that includes failure semantics.
...
- [ ] The contract for NestJS Contract Evolution is explicit about success and failure behavior.
