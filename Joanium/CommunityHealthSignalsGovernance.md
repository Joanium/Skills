---
name: Community Health Signals Governance
trigger: community health signals governance, help with community health signals governance, plan community health signals governance, improve community health signals governance, expert community health signals governance
description: Expert-level guidance for community health signals governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Community Health Signals Governance is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Community Health Signals Governance affects acquisition, narrative clarity, or cross-channel execution.
...
- Who sets the policy for Community Health Signals Governance, and who is allowed to grant exceptions?
...
- A policy document for Community Health Signals Governance with explicit scope.
