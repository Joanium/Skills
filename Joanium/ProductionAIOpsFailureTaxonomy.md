---
name: Production AI Operations Failure Taxonomy
trigger: production ai operations failure taxonomy, help with production ai operations failure taxonomy, plan production ai operations failure taxonomy, improve production ai operations failure taxonomy, expert production ai operations failure taxonomy
description: Expert-level guidance for production ai operations failure taxonomy with action-oriented workflow, review criteria, and failure patterns.
---

Production AI Operations Failure Taxonomy is an expert applied AI skill for Production AI Operations. The focal concern is Failure Taxonomy, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Production AI Operations Failure Taxonomy affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Production AI Operations Failure Taxonomy is currently measured by vibes rather than a real contract?
- Which failure in Production AI Operations Failure Taxonomy would be hardest to notice before it harms users or operators?
- How will Production AI Operations Failure Taxonomy behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Production AI Operations Failure Taxonomy?
...
- A behavior contract for Production AI Operations Failure Taxonomy.
...
- [ ] The contract behind Production AI Operations Failure Taxonomy is explicit enough to evaluate.
