---
name: Service Mesh Observability Design
trigger: service mesh observability design, help with service mesh observability design, plan service mesh observability design, improve service mesh observability design, expert service mesh observability design
description: Expert-level guidance for service mesh observability design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Service Mesh Observability Design is an expert cloud and platform skill for Service Mesh. The focal concern is Observability Design, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when Service Mesh Observability Design changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside Service Mesh Observability Design would fail first during a rushed rollout or incident?
- Which control in Service Mesh Observability Design is automated but not truly reversible?
- How will operators know whether Service Mesh Observability Design is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in Service Mesh Observability Design is invisible until it becomes expensive?
- Which dependency makes Service Mesh Observability Design less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for Service Mesh Observability Design.
...
- [ ] The rollback path for Service Mesh Observability Design is explicit and tested.
