---
name: Metric Lineage Review
trigger: metric lineage review, help with metric lineage review, plan metric lineage review, improve metric lineage review
description: Practical guidance for planning and executing metric lineage review with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Review helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
