---
name: Robotics Fault Recovery Design
trigger: robotics fault recovery design, help with robotics fault recovery design, plan robotics fault recovery design, improve robotics fault recovery design, expert robotics fault recovery design
description: Expert-level guidance for robotics fault recovery design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Robotics Fault Recovery Design is an expert-level specialized systems skill for operating in technical domains where physical, protocol, or computational limits dominate design choices. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Robotics Fault Recovery Design has tight performance, correctness, or hardware constraints.
...
- What are the core boundaries, contracts, and invariants in Robotics Fault Recovery Design?
...
- An architecture or boundary diagram for Robotics Fault Recovery Design.
