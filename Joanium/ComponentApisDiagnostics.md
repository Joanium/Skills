---
name: Component APIs Diagnostics
trigger: component apis diagnostics, help with component apis diagnostics, plan component apis diagnostics, improve component apis diagnostics
description: Practical guidance for planning and executing component apis diagnostics with clear scope, tradeoffs, and validation steps.
---

Component APIs Diagnostics improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
