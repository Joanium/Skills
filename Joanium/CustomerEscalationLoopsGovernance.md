---
name: Customer Escalation Loops Governance
trigger: customer escalation loops governance, help with customer escalation loops governance, plan customer escalation loops governance, improve customer escalation loops governance, expert customer escalation loops governance
description: Expert-level guidance for customer escalation loops governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Customer Escalation Loops Governance is an expert-level product skill for making high-leverage decisions with sharper tradeoffs, stronger evidence, and cleaner follow-through. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Customer Escalation Loops Governance affects roadmap choices, customer outcomes, or cross-functional alignment.
...
- Who sets the policy for Customer Escalation Loops Governance, and who is allowed to grant exceptions?
...
- A policy document for Customer Escalation Loops Governance with explicit scope.
