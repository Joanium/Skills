---
name: Model Routing Safety Design
trigger: model routing safety design, help with model routing safety design, plan model routing safety design, improve model routing safety design, expert model routing safety design
description: Expert-level guidance for model routing safety design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Model Routing Safety Design is an expert applied-AI skill for Model Routing. The focal concern is Safety Design, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Model Routing Safety Design affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Model Routing Safety Design would look acceptable in a demo but fail under production ambiguity?
- Which part of Model Routing Safety Design lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Model Routing Safety Design fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Model Routing Safety Design is getting better rather than merely changing?
- Where should humans intervene in Model Routing Safety Design to add leverage instead of toil?
...
- A behavior contract for Model Routing Safety Design.
...
- [ ] The behavior contract for Model Routing Safety Design is explicit.
