---
name: Platform Paved Roads Optimization
trigger: platform paved roads optimization, help with platform paved roads optimization, plan platform paved roads optimization, improve platform paved roads optimization, expert platform paved roads optimization
description: Expert-level guidance for platform paved roads optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Platform Paved Roads Optimization is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Platform Paved Roads Optimization affects codebase shape, team interfaces, or long-term delivery speed.
...
- What is the actual bottleneck in Platform Paved Roads Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Platform Paved Roads Optimization with representative workloads.
