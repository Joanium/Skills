---
name: Synthetic Data Experiment Tracking
trigger: synthetic data experiment tracking, help with synthetic data experiment tracking, plan synthetic data experiment tracking, improve synthetic data experiment tracking, expert synthetic data experiment tracking
description: Expert-level guidance for synthetic data experiment tracking with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Synthetic Data Experiment Tracking is an expert applied-AI skill for Synthetic Data. The focal concern is Experiment Tracking, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Synthetic Data Experiment Tracking affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Synthetic Data Experiment Tracking would look acceptable in a demo but fail under production ambiguity?
- Which part of Synthetic Data Experiment Tracking lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Synthetic Data Experiment Tracking fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Synthetic Data Experiment Tracking is getting better rather than merely changing?
- Where should humans intervene in Synthetic Data Experiment Tracking to add leverage instead of toil?
...
- A behavior contract for Synthetic Data Experiment Tracking.
...
- [ ] The behavior contract for Synthetic Data Experiment Tracking is explicit.
