---
name: Agent Memory Repair Quality Gates
trigger: agent memory repair quality gates, help with agent memory repair quality gates, plan agent memory repair quality gates, improve agent memory repair quality gates, expert agent memory repair quality gates
description: Expert-level guidance for agent memory repair quality gates with action-oriented workflow, review criteria, and failure patterns.
---

Agent Memory Repair Quality Gates is an expert agent and tooling skill for Agent Memory Repair. The focal concern is Quality Gates, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Agent Memory Repair Quality Gates affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Agent Memory Repair Quality Gates is still governed by intuition instead of a contract or label set?
- Which failure in Agent Memory Repair Quality Gates would be hardest to detect before it compounds?
- How would Agent Memory Repair Quality Gates behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Agent Memory Repair Quality Gates?
...
- A contract and failure-label set for Agent Memory Repair Quality Gates.
...
- [ ] The system behind Agent Memory Repair Quality Gates is described more clearly than the prompt surface.
