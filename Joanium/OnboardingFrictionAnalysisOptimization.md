---
name: Onboarding Friction Analysis Optimization
trigger: onboarding friction analysis optimization, help with onboarding friction analysis optimization, plan onboarding friction analysis optimization, improve onboarding friction analysis optimization, expert onboarding friction analysis optimization
description: Expert-level guidance for onboarding friction analysis optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Onboarding Friction Analysis Optimization is an expert-level product skill for making high-leverage decisions with sharper tradeoffs, stronger evidence, and cleaner follow-through. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Onboarding Friction Analysis Optimization affects roadmap choices, customer outcomes, or cross-functional alignment.
...
- What is the actual bottleneck in Onboarding Friction Analysis Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Onboarding Friction Analysis Optimization with representative workloads.
