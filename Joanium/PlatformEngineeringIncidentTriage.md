---
name: Platform Engineering Incident Triage
trigger: platform engineering incident triage, help with platform engineering incident triage, plan platform engineering incident triage, improve platform engineering incident triage, expert platform engineering incident triage
description: Expert-level guidance for platform engineering incident triage with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Platform Engineering Incident Triage is an expert cloud and platform skill for Platform Engineering. The focal concern is Incident Triage, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when Platform Engineering Incident Triage changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside Platform Engineering Incident Triage would fail first during a rushed rollout or incident?
- Which control in Platform Engineering Incident Triage is automated but not truly reversible?
- How will operators know whether Platform Engineering Incident Triage is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in Platform Engineering Incident Triage is invisible until it becomes expensive?
- Which dependency makes Platform Engineering Incident Triage less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for Platform Engineering Incident Triage.
...
- [ ] The rollback path for Platform Engineering Incident Triage is explicit and tested.
