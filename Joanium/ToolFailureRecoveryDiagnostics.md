---
name: Tool Failure Recovery Diagnostics
trigger: tool failure recovery diagnostics, help with tool failure recovery diagnostics, plan tool failure recovery diagnostics, improve tool failure recovery diagnostics, expert tool failure recovery diagnostics
description: Expert-level guidance for tool failure recovery diagnostics, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Tool Failure Recovery Diagnostics is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is turning vague symptoms into testable hypotheses fast enough to reduce mean time to clarity.

## When To Use

- Use this when Tool Failure Recovery Diagnostics influences user-visible output, automation, or safety-sensitive decisions.
...
- What changed most recently in or around Tool Failure Recovery Diagnostics?
...
- An evidence-backed timeline for Tool Failure Recovery Diagnostics.
