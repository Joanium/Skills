---
name: Metric Lineage Optimization
trigger: metric lineage optimization, help with metric lineage optimization, plan metric lineage optimization, improve metric lineage optimization
description: Practical guidance for planning and executing metric lineage optimization with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Optimization helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
