---
name: C# Performance Profiling
trigger: c# performance profiling, help with c# performance profiling, plan c# performance profiling, improve c# performance profiling, expert c# performance profiling
description: Expert-level guidance for c# performance profiling with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

C# Performance Profiling is an expert programming-language skill for C#. The focal concern is Performance Profiling, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when C# Performance Profiling affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside C# Performance Profiling?
- Which abstraction in C# Performance Profiling becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in C# Performance Profiling first?
- How will C# Performance Profiling behave when multiple contributors evolve it independently?
- Which part of C# Performance Profiling is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for C# Performance Profiling.
- A failure-mode note that explains the sharp edges inside C# Performance Profiling.
...
- [ ] The main language-level risk in C# Performance Profiling is named explicitly.
...
- [ ] Future contributors can extend C# Performance Profiling without reverse-engineering hidden contracts.
