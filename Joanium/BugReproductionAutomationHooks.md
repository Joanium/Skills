---
name: Bug Reproduction Automation Hooks
trigger: bug reproduction automation hooks, help with bug reproduction automation hooks, plan bug reproduction automation hooks, improve bug reproduction automation hooks, expert bug reproduction automation hooks
description: Expert-level guidance for bug reproduction automation hooks with action-oriented workflow, review criteria, and failure patterns.
---

Bug Reproduction Automation Hooks is an expert coding workflow skill for Bug Reproduction. The focal concern is Automation Hooks, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Bug Reproduction Automation Hooks is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Bug Reproduction Automation Hooks is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Bug Reproduction Automation Hooks would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Bug Reproduction Automation Hooks create a silent regression that tests may miss?
- How would the AI explain the safety of Bug Reproduction Automation Hooks to a skeptical reviewer?
...
- A concise evidence note for Bug Reproduction Automation Hooks.
...
- [ ] The evidence supporting Bug Reproduction Automation Hooks is stronger than the assumptions.
