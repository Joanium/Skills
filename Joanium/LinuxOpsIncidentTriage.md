---
name: Linux Operations Incident Triage
trigger: linux operations incident triage, help with linux operations incident triage, plan linux operations incident triage, improve linux operations incident triage, expert linux operations incident triage
description: Expert-level guidance for linux operations incident triage with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Linux Operations Incident Triage is an expert cloud and platform skill for Linux Operations. The focal concern is Incident Triage, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when Linux Operations Incident Triage changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside Linux Operations Incident Triage would fail first during a rushed rollout or incident?
- Which control in Linux Operations Incident Triage is automated but not truly reversible?
- How will operators know whether Linux Operations Incident Triage is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in Linux Operations Incident Triage is invisible until it becomes expensive?
- Which dependency makes Linux Operations Incident Triage less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for Linux Operations Incident Triage.
...
- [ ] The rollback path for Linux Operations Incident Triage is explicit and tested.
