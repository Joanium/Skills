---
name: Prompt Safety Design
trigger: prompt safety design, help with prompt safety design, plan prompt safety design, improve prompt safety design
description: Practical guidance for planning and executing prompt safety design with clear scope, tradeoffs, and validation steps.
---

Prompt Safety Design helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
