---
name: Data Product Ownership Review
trigger: data product ownership review, help with data product ownership review, plan data product ownership review, improve data product ownership review, expert data product ownership review
description: Expert-level guidance for data product ownership review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Data Product Ownership Review is an expert-level data systems skill for turning analysis and pipelines into governed, trusted, and operationally stable assets. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Data Product Ownership Review affects downstream metrics, decisions, or customer-facing data products.
...
- What claims about Data Product Ownership Review are supported by evidence, and which are still assertions?
...
- A review summary for Data Product Ownership Review with clear approval status.
