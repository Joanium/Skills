---
name: Build Failure Response Regression Forecasting
trigger: build failure response regression forecasting, help with build failure response regression forecasting, plan build failure response regression forecasting, improve build failure response regression forecasting, expert build failure response regression forecasting
description: Expert-level guidance for build failure response regression forecasting with action-oriented workflow, review criteria, and failure patterns.
---

Build Failure Response Regression Forecasting is an expert repository and delivery skill for Build Failure Response. The focal concern is Regression Forecasting, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Build Failure Response Regression Forecasting determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Build Failure Response Regression Forecasting riskier than the diff itself suggests?
- Which reviewer would challenge Build Failure Response Regression Forecasting first, and what evidence would they need?
- How could Build Failure Response Regression Forecasting fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Build Failure Response Regression Forecasting would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Build Failure Response Regression Forecasting concretely?
...
- A blast-radius note for Build Failure Response Regression Forecasting.
...
- [ ] The repository-level blast radius of Build Failure Response Regression Forecasting is explicit.
