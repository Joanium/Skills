---
name: Platform Paved Roads Design
trigger: platform paved roads design, help with platform paved roads design, plan platform paved roads design, improve platform paved roads design, expert platform paved roads design
description: Expert-level guidance for platform paved roads design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Platform Paved Roads Design is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Platform Paved Roads Design affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the core boundaries, contracts, and invariants in Platform Paved Roads Design?
...
- An architecture or boundary diagram for Platform Paved Roads Design.
