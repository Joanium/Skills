---
name: Device Capability Matrices Design
trigger: device capability matrices design, help with device capability matrices design, plan device capability matrices design, improve device capability matrices design, expert device capability matrices design
description: Expert-level guidance for device capability matrices design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Device Capability Matrices Design is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Device Capability Matrices Design affects release risk, device behavior, or user trust during degraded conditions.
...
- What are the core boundaries, contracts, and invariants in Device Capability Matrices Design?
...
- An architecture or boundary diagram for Device Capability Matrices Design.
