---
name: Prompt Safety Analysis
trigger: prompt safety analysis, help with prompt safety analysis, plan prompt safety analysis, improve prompt safety analysis
description: Practical guidance for planning and executing prompt safety analysis with clear scope, tradeoffs, and validation steps.
---

Prompt Safety Analysis helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
