---
name: Refactor Campaigns Reviewer Alignment
trigger: refactor campaigns reviewer alignment, help with refactor campaigns reviewer alignment, plan refactor campaigns reviewer alignment, improve refactor campaigns reviewer alignment, expert refactor campaigns reviewer alignment
description: Expert-level guidance for refactor campaigns reviewer alignment with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Reviewer Alignment is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Reviewer Alignment, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Reviewer Alignment determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Reviewer Alignment riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Reviewer Alignment first, and what evidence would they need?
- How could Refactor Campaigns Reviewer Alignment fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Reviewer Alignment would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Reviewer Alignment concretely?
...
- A blast-radius note for Refactor Campaigns Reviewer Alignment.
...
- [ ] The repository-level blast radius of Refactor Campaigns Reviewer Alignment is explicit.
