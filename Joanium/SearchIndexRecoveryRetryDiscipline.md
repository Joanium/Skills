---
name: Search Index Recovery Retry Discipline
trigger: search index recovery retry discipline, help with search index recovery retry discipline, plan search index recovery retry discipline, improve search index recovery retry discipline, expert search index recovery retry discipline
description: Expert-level guidance for search index recovery retry discipline with action-oriented workflow, review criteria, and failure patterns.
---

Search Index Recovery Retry Discipline is an expert backend execution skill for Search Index Recovery. The focal concern is Retry Discipline, but the real objective is helping an AI design service behavior that stays coherent under retries, queues, partial failure, and operational pressure.

## When To Use

- Use this when Search Index Recovery Retry Discipline affects whether backend changes remain safe once real production behavior kicks in.
...
- Which failure ordering inside Search Index Recovery Retry Discipline would create the most misleading symptom?
- Where does Search Index Recovery Retry Discipline need stronger idempotency or retry discipline?
- What dependency in Search Index Recovery Retry Discipline is currently hiding behind timeout or queue noise?
- How would an operator explain the health of Search Index Recovery Retry Discipline in the first five minutes of an incident?
- What contract assumption in Search Index Recovery Retry Discipline is least defensible under partial failure?
...
- A failure-sequence note for Search Index Recovery Retry Discipline.
...
- [ ] The real behavior of Search Index Recovery Retry Discipline under retries and failures is explicit.
