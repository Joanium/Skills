---
name: Context Window Budgeting Design
trigger: context window budgeting design, help with context window budgeting design, plan context window budgeting design, improve context window budgeting design, expert context window budgeting design
description: Expert-level guidance for context window budgeting design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Context Window Budgeting Design is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Context Window Budgeting Design influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the core boundaries, contracts, and invariants in Context Window Budgeting Design?
...
- An architecture or boundary diagram for Context Window Budgeting Design.
