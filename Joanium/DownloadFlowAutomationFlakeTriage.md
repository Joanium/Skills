---
name: Download Flow Automation Flake Triage
trigger: download flow automation flake triage, help with download flow automation flake triage, plan download flow automation flake triage, improve download flow automation flake triage, expert download flow automation flake triage
description: Expert-level guidance for download flow automation flake triage with action-oriented workflow, review criteria, and failure patterns.
---

Download Flow Automation Flake Triage is an expert browser automation skill for Download Flow Automation. The focal concern is Flake Triage, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Download Flow Automation Flake Triage needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Download Flow Automation Flake Triage unreliable across runs?
- Which timing or selector assumption in Download Flow Automation Flake Triage is least stable under real conditions?
- How would Download Flow Automation Flake Triage behave differently across browsers, profiles, or CI environments?
- What artifacts should Download Flow Automation Flake Triage capture so the next failure is diagnosable instead of mysterious?
- Which part of Download Flow Automation Flake Triage is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Download Flow Automation Flake Triage.
...
- [ ] The state model behind Download Flow Automation Flake Triage is explicit.
