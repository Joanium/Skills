---
name: Monolith Decomposition Review
trigger: monolith decomposition review, help with monolith decomposition review, plan monolith decomposition review, improve monolith decomposition review
description: Practical guidance for planning and executing monolith decomposition review with clear scope, tradeoffs, and validation steps.
---

Monolith Decomposition Review improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
