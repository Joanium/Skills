---
name: Refactor Campaigns Staging Plans
trigger: refactor campaigns staging plans, help with refactor campaigns staging plans, plan refactor campaigns staging plans, improve refactor campaigns staging plans, expert refactor campaigns staging plans
description: Expert-level guidance for refactor campaigns staging plans with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Staging Plans is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Staging Plans, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Staging Plans determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Staging Plans riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Staging Plans first, and what evidence would they need?
- How could Refactor Campaigns Staging Plans fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Staging Plans would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Staging Plans concretely?
...
- A blast-radius note for Refactor Campaigns Staging Plans.
...
- [ ] The repository-level blast radius of Refactor Campaigns Staging Plans is explicit.
