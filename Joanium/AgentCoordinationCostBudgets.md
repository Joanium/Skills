---
name: Agent Coordination Cost Budgets
trigger: agent coordination cost budgets, help with agent coordination cost budgets, plan agent coordination cost budgets, improve agent coordination cost budgets, expert agent coordination cost budgets
description: Expert-level guidance for agent coordination cost budgets with action-oriented workflow, review criteria, and failure patterns.
---

Agent Coordination Cost Budgets is an expert applied AI skill for Agent Coordination. The focal concern is Cost Budgets, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Agent Coordination Cost Budgets affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Agent Coordination Cost Budgets is currently measured by vibes rather than a real contract?
- Which failure in Agent Coordination Cost Budgets would be hardest to notice before it harms users or operators?
- How will Agent Coordination Cost Budgets behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Agent Coordination Cost Budgets?
...
- A behavior contract for Agent Coordination Cost Budgets.
...
- [ ] The contract behind Agent Coordination Cost Budgets is explicit enough to evaluate.
