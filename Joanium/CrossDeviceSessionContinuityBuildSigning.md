---
name: Cross-device Session Continuity Build Signing
trigger: cross-device session continuity build signing, help with cross-device session continuity build signing, plan cross-device session continuity build signing, improve cross-device session continuity build signing, expert cross-device session continuity build signing
description: Expert-level guidance for cross-device session continuity build signing with client delivery workflow, review criteria, and failure patterns.
---

Cross-device Session Continuity Build Signing is an expert mobile and desktop delivery skill for Cross-device Session Continuity. The focal concern is Build Signing, but the real objective is helping an AI ship client software that survives device constraints, stores, upgrades, and real user recovery paths.

## When To Use

- Use this when Cross-device Session Continuity Build Signing affects whether client software remains trustworthy across devices, upgrades, and degraded conditions.
...
- Which user or device condition would expose the weakest assumption in Cross-device Session Continuity Build Signing first?
- How will Cross-device Session Continuity Build Signing behave during upgrade, rollback, or stale local state?
- What store, signing, or permission dependency could block or confuse Cross-device Session Continuity Build Signing unexpectedly?
- How would support or operations diagnose Cross-device Session Continuity Build Signing from telemetry instead of guesswork?
- What path inside Cross-device Session Continuity Build Signing should help the user recover rather than merely fail loudly?
...
- A device and release risk note for Cross-device Session Continuity Build Signing.
...
- [ ] The device, store, and upgrade assumptions behind Cross-device Session Continuity Build Signing are explicit.
