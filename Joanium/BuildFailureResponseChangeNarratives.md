---
name: Build Failure Response Change Narratives
trigger: build failure response change narratives, help with build failure response change narratives, plan build failure response change narratives, improve build failure response change narratives, expert build failure response change narratives
description: Expert-level guidance for build failure response change narratives with action-oriented workflow, review criteria, and failure patterns.
---

Build Failure Response Change Narratives is an expert repository and delivery skill for Build Failure Response. The focal concern is Change Narratives, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Build Failure Response Change Narratives determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Build Failure Response Change Narratives riskier than the diff itself suggests?
- Which reviewer would challenge Build Failure Response Change Narratives first, and what evidence would they need?
- How could Build Failure Response Change Narratives fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Build Failure Response Change Narratives would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Build Failure Response Change Narratives concretely?
...
- A blast-radius note for Build Failure Response Change Narratives.
...
- [ ] The repository-level blast radius of Build Failure Response Change Narratives is explicit.
