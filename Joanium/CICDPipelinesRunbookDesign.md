---
name: CI/CD Pipelines Runbook Design
trigger: ci/cd pipelines runbook design, help with ci/cd pipelines runbook design, plan ci/cd pipelines runbook design, improve ci/cd pipelines runbook design, expert ci/cd pipelines runbook design
description: Expert-level guidance for ci/cd pipelines runbook design with action-oriented workflow, review criteria, and failure patterns.
---

CI/CD Pipelines Runbook Design is an expert platform and automation skill for CI/CD Pipelines. The focal concern is Runbook Design, but the real objective is helping an AI make infrastructure and operational change without creating invisible blast radius.

## When To Use

- Use this when CI/CD Pipelines Runbook Design can affect deployment safety, service recovery, or operator trust in automation.
...
- What part of CI/CD Pipelines Runbook Design could fail silently while the automation still reports success?
- Which rollback or recovery step inside CI/CD Pipelines Runbook Design depends too much on tribal memory?
- How will operators know when CI/CD Pipelines Runbook Design should stop, wait, or reverse course?
- Where does CI/CD Pipelines Runbook Design blur access, policy, and execution boundaries dangerously?
...
- A change-and-recovery map for CI/CD Pipelines Runbook Design.
...
- [ ] The rollback model for CI/CD Pipelines Runbook Design is as real as the forward path.
