---
name: Service Decomposition Interface Contracts
trigger: service decomposition interface contracts, help with service decomposition interface contracts, plan service decomposition interface contracts, improve service decomposition interface contracts, expert service decomposition interface contracts
description: Expert-level guidance for service decomposition interface contracts with action-oriented workflow, review criteria, and failure patterns.
---

Service Decomposition Interface Contracts is an expert architecture and systems skill for Service Decomposition. The focal concern is Interface Contracts, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Service Decomposition Interface Contracts needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Service Decomposition Interface Contracts becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Service Decomposition Interface Contracts is currently cheap only because the bill has not arrived yet?
- How would Service Decomposition Interface Contracts be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Service Decomposition Interface Contracts too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Service Decomposition Interface Contracts.
...
- [ ] The key boundaries inside Service Decomposition Interface Contracts are explicit and justified.
