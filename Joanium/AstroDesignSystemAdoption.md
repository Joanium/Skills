---
name: Astro Design System Adoption
trigger: astro design system adoption, help with astro design system adoption, plan astro design system adoption, improve astro design system adoption, expert astro design system adoption
description: Expert-level guidance for astro design system adoption with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Astro Design System Adoption is an expert frontend skill for Astro. The focal concern is Design System Adoption, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Astro Design System Adoption affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Astro Design System Adoption make user state harder to reason about than it needs to be?
- Which interaction in Astro Design System Adoption degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Astro Design System Adoption would break if the DOM or state changed unexpectedly?
- How does Astro Design System Adoption fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Astro Design System Adoption looks correct in a mock but collapses under production behavior?
...
- A state transition map for Astro Design System Adoption.
...
- [ ] The state model for Astro Design System Adoption is clear enough to debug.
...
- [ ] Another engineer can extend Astro Design System Adoption without guessing hidden UI contracts.
