---
name: Svelte Design System Adoption
trigger: svelte design system adoption, help with svelte design system adoption, plan svelte design system adoption, improve svelte design system adoption, expert svelte design system adoption
description: Expert-level guidance for svelte design system adoption with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Svelte Design System Adoption is an expert frontend skill for Svelte. The focal concern is Design System Adoption, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Svelte Design System Adoption affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Svelte Design System Adoption make user state harder to reason about than it needs to be?
- Which interaction in Svelte Design System Adoption degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Svelte Design System Adoption would break if the DOM or state changed unexpectedly?
- How does Svelte Design System Adoption fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Svelte Design System Adoption looks correct in a mock but collapses under production behavior?
...
- A state transition map for Svelte Design System Adoption.
...
- [ ] The state model for Svelte Design System Adoption is clear enough to debug.
...
- [ ] Another engineer can extend Svelte Design System Adoption without guessing hidden UI contracts.
