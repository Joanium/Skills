---
name: Architecture Fitness Functions Optimization
trigger: architecture fitness functions optimization, help with architecture fitness functions optimization, plan architecture fitness functions optimization, improve architecture fitness functions optimization, expert architecture fitness functions optimization
description: Expert-level guidance for architecture fitness functions optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Architecture Fitness Functions Optimization is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Architecture Fitness Functions Optimization affects codebase shape, team interfaces, or long-term delivery speed.
...
- What is the actual bottleneck in Architecture Fitness Functions Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Architecture Fitness Functions Optimization with representative workloads.
