---
name: Cross-device Session Continuity Upgrade Safety
trigger: cross-device session continuity upgrade safety, help with cross-device session continuity upgrade safety, plan cross-device session continuity upgrade safety, improve cross-device session continuity upgrade safety, expert cross-device session continuity upgrade safety
description: Expert-level guidance for cross-device session continuity upgrade safety with client delivery workflow, review criteria, and failure patterns.
---

Cross-device Session Continuity Upgrade Safety is an expert mobile and desktop delivery skill for Cross-device Session Continuity. The focal concern is Upgrade Safety, but the real objective is helping an AI ship client software that survives device constraints, stores, upgrades, and real user recovery paths.

## When To Use

- Use this when Cross-device Session Continuity Upgrade Safety affects whether client software remains trustworthy across devices, upgrades, and degraded conditions.
...
- Which user or device condition would expose the weakest assumption in Cross-device Session Continuity Upgrade Safety first?
- How will Cross-device Session Continuity Upgrade Safety behave during upgrade, rollback, or stale local state?
- What store, signing, or permission dependency could block or confuse Cross-device Session Continuity Upgrade Safety unexpectedly?
- How would support or operations diagnose Cross-device Session Continuity Upgrade Safety from telemetry instead of guesswork?
- What path inside Cross-device Session Continuity Upgrade Safety should help the user recover rather than merely fail loudly?
...
- A device and release risk note for Cross-device Session Continuity Upgrade Safety.
...
- [ ] The device, store, and upgrade assumptions behind Cross-device Session Continuity Upgrade Safety are explicit.
