---
name: Swift Refactor Mechanics
trigger: swift refactor mechanics, help with swift refactor mechanics, plan swift refactor mechanics, improve swift refactor mechanics, expert swift refactor mechanics
description: Expert-level guidance for swift refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Swift Refactor Mechanics is an expert programming-language skill for Swift. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Swift Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Swift Refactor Mechanics?
- Which abstraction in Swift Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Swift Refactor Mechanics first?
- How will Swift Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of Swift Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Swift Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside Swift Refactor Mechanics.
...
- [ ] The main language-level risk in Swift Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend Swift Refactor Mechanics without reverse-engineering hidden contracts.
