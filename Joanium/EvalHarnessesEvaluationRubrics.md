---
name: Evaluation Harnesses Evaluation Rubrics
trigger: evaluation harnesses evaluation rubrics, help with evaluation harnesses evaluation rubrics, plan evaluation harnesses evaluation rubrics, improve evaluation harnesses evaluation rubrics, expert evaluation harnesses evaluation rubrics
description: Expert-level guidance for evaluation harnesses evaluation rubrics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Evaluation Harnesses Evaluation Rubrics is an expert applied-AI skill for Evaluation Harnesses. The focal concern is Evaluation Rubrics, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Evaluation Harnesses Evaluation Rubrics affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Evaluation Harnesses Evaluation Rubrics would look acceptable in a demo but fail under production ambiguity?
- Which part of Evaluation Harnesses Evaluation Rubrics lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Evaluation Harnesses Evaluation Rubrics fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Evaluation Harnesses Evaluation Rubrics is getting better rather than merely changing?
- Where should humans intervene in Evaluation Harnesses Evaluation Rubrics to add leverage instead of toil?
...
- A behavior contract for Evaluation Harnesses Evaluation Rubrics.
...
- [ ] The behavior contract for Evaluation Harnesses Evaluation Rubrics is explicit.
