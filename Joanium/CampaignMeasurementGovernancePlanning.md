---
name: Campaign Measurement Governance Planning
trigger: campaign measurement governance planning, help with campaign measurement governance planning, plan campaign measurement governance planning, improve campaign measurement governance planning, expert campaign measurement governance planning
description: Expert-level guidance for campaign measurement governance planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Campaign Measurement Governance Planning is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Campaign Measurement Governance Planning affects acquisition, narrative clarity, or cross-channel execution.
...
- What must be true before Campaign Measurement Governance Planning can start safely?
...
- A milestone plan for Campaign Measurement Governance Planning with explicit gating criteria.
