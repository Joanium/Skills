---
name: Traffic Shaping Strategy
trigger: traffic shaping strategy, help with traffic shaping strategy, plan traffic shaping strategy, improve traffic shaping strategy
description: Practical guidance for planning and executing traffic shaping strategy with clear scope, tradeoffs, and validation steps.
---

Traffic Shaping Strategy focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
