---
name: Prompting Cost Control
trigger: prompting cost control, help with prompting cost control, plan prompting cost control, improve prompting cost control, expert prompting cost control
description: Expert-level guidance for prompting cost control with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Prompting Cost Control is an expert applied-AI skill for Prompting. The focal concern is Cost Control, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Prompting Cost Control affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Prompting Cost Control would look acceptable in a demo but fail under production ambiguity?
- Which part of Prompting Cost Control lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Prompting Cost Control fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Prompting Cost Control is getting better rather than merely changing?
- Where should humans intervene in Prompting Cost Control to add leverage instead of toil?
...
- A behavior contract for Prompting Cost Control.
...
- [ ] The behavior contract for Prompting Cost Control is explicit.
