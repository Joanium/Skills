---
name: Crash Signal Triage Design
trigger: crash signal triage design, help with crash signal triage design, plan crash signal triage design, improve crash signal triage design, expert crash signal triage design
description: Expert-level guidance for crash signal triage design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Crash Signal Triage Design is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Crash Signal Triage Design affects release risk, device behavior, or user trust during degraded conditions.
...
- What are the core boundaries, contracts, and invariants in Crash Signal Triage Design?
...
- An architecture or boundary diagram for Crash Signal Triage Design.
