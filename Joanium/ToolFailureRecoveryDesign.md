---
name: Tool Failure Recovery Design
trigger: tool failure recovery design, help with tool failure recovery design, plan tool failure recovery design, improve tool failure recovery design, expert tool failure recovery design
description: Expert-level guidance for tool failure recovery design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Tool Failure Recovery Design is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Tool Failure Recovery Design influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the core boundaries, contracts, and invariants in Tool Failure Recovery Design?
...
- An architecture or boundary diagram for Tool Failure Recovery Design.
