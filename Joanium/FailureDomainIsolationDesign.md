---
name: Failure Domain Isolation Design
trigger: failure domain isolation design, help with failure domain isolation design, plan failure domain isolation design, improve failure domain isolation design, expert failure domain isolation design
description: Expert-level guidance for failure domain isolation design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Failure Domain Isolation Design is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Failure Domain Isolation Design changes service availability, deployment safety, or recovery behavior.
...
- What are the core boundaries, contracts, and invariants in Failure Domain Isolation Design?
...
- An architecture or boundary diagram for Failure Domain Isolation Design.
