---
name: Secret Distribution Analysis
trigger: secret distribution analysis, help with secret distribution analysis, plan secret distribution analysis, improve secret distribution analysis
description: Practical guidance for planning and executing secret distribution analysis with clear scope, tradeoffs, and validation steps.
---

Secret Distribution Analysis focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
