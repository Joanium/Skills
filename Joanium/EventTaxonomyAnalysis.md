---
name: Event Taxonomy Analysis
trigger: event taxonomy analysis, help with event taxonomy analysis, plan event taxonomy analysis, improve event taxonomy analysis
description: Practical guidance for planning and executing event taxonomy analysis with clear scope, tradeoffs, and validation steps.
---

Event Taxonomy Analysis helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
