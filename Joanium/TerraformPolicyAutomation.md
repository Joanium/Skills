---
name: Terraform Policy Automation
trigger: terraform policy automation, help with terraform policy automation, plan terraform policy automation, improve terraform policy automation, expert terraform policy automation
description: Expert-level guidance for terraform policy automation with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Terraform Policy Automation is an expert cloud and platform skill for Terraform. The focal concern is Policy Automation, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when Terraform Policy Automation changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside Terraform Policy Automation would fail first during a rushed rollout or incident?
- Which control in Terraform Policy Automation is automated but not truly reversible?
- How will operators know whether Terraform Policy Automation is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in Terraform Policy Automation is invisible until it becomes expensive?
- Which dependency makes Terraform Policy Automation less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for Terraform Policy Automation.
...
- [ ] The rollback path for Terraform Policy Automation is explicit and tested.
