---
name: Agents Experiment Tracking
trigger: agents experiment tracking, help with agents experiment tracking, plan agents experiment tracking, improve agents experiment tracking, expert agents experiment tracking
description: Expert-level guidance for agents experiment tracking with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Agents Experiment Tracking is an expert applied-AI skill for Agents. The focal concern is Experiment Tracking, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Agents Experiment Tracking affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Agents Experiment Tracking would look acceptable in a demo but fail under production ambiguity?
- Which part of Agents Experiment Tracking lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Agents Experiment Tracking fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Agents Experiment Tracking is getting better rather than merely changing?
- Where should humans intervene in Agents Experiment Tracking to add leverage instead of toil?
...
- A behavior contract for Agents Experiment Tracking.
...
- [ ] The behavior contract for Agents Experiment Tracking is explicit.
