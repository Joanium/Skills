---
name: Install Funnels Planning
trigger: install funnels planning, help with install funnels planning, plan install funnels planning, improve install funnels planning
description: Practical guidance for planning and executing install funnels planning with clear scope, tradeoffs, and validation steps.
---

Install Funnels Planning focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
