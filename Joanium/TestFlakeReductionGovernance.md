---
name: Test Flake Reduction Governance
trigger: test flake reduction governance, help with test flake reduction governance, plan test flake reduction governance, improve test flake reduction governance
description: Practical guidance for planning and executing test flake reduction governance with clear scope, tradeoffs, and validation steps.
---

Test Flake Reduction Governance improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
