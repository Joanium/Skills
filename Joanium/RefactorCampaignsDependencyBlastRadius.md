---
name: Refactor Campaigns Dependency Blast Radius
trigger: refactor campaigns dependency blast radius, help with refactor campaigns dependency blast radius, plan refactor campaigns dependency blast radius, improve refactor campaigns dependency blast radius, expert refactor campaigns dependency blast radius
description: Expert-level guidance for refactor campaigns dependency blast radius with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Dependency Blast Radius is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Dependency Blast Radius, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Dependency Blast Radius determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Dependency Blast Radius riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Dependency Blast Radius first, and what evidence would they need?
- How could Refactor Campaigns Dependency Blast Radius fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Dependency Blast Radius would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Dependency Blast Radius concretely?
...
- A blast-radius note for Refactor Campaigns Dependency Blast Radius.
...
- [ ] The repository-level blast radius of Refactor Campaigns Dependency Blast Radius is explicit.
