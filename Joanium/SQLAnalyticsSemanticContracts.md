---
name: SQL Analytics Semantic Contracts
trigger: sql analytics semantic contracts, help with sql analytics semantic contracts, plan sql analytics semantic contracts, improve sql analytics semantic contracts, expert sql analytics semantic contracts
description: Expert-level guidance for sql analytics semantic contracts with action-oriented workflow, review criteria, and failure patterns.
---

SQL Analytics Semantic Contracts is an expert data and analytics skill for SQL Analytics. The focal concern is Semantic Contracts, but the real objective is helping an AI produce data systems and analysis that remain trustworthy when definitions, sources, and consumers all evolve.

## When To Use

- Use this when SQL Analytics Semantic Contracts needs stronger semantics, validation, and consumer awareness than a working query or pipeline alone can provide.
...
- What part of SQL Analytics Semantic Contracts would two consumers interpret differently if nothing were documented?
- Which anomaly in SQL Analytics Semantic Contracts is most likely to be ignored until it becomes a business argument?
- How would SQL Analytics Semantic Contracts be repaired if the source data arrived late, duplicated, or wrong?
- What cost pattern in SQL Analytics Semantic Contracts is growing because nobody owns the semantic boundary?
- Which downstream decision is too fragile for SQL Analytics Semantic Contracts to remain loosely defined?
...
- A semantic contract for SQL Analytics Semantic Contracts.
...
- [ ] The meaning of SQL Analytics Semantic Contracts is explicit and consumer-facing.
