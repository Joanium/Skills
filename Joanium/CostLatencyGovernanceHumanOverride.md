---
name: Cost Latency Governance Human Override
trigger: cost latency governance human override, help with cost latency governance human override, plan cost latency governance human override, improve cost latency governance human override, expert cost latency governance human override
description: Expert-level guidance for cost latency governance human override with action-oriented workflow, review criteria, and failure patterns.
---

Cost Latency Governance Human Override is an expert agent and tooling skill for Cost Latency Governance. The focal concern is Human Override, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Cost Latency Governance Human Override affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Cost Latency Governance Human Override is still governed by intuition instead of a contract or label set?
- Which failure in Cost Latency Governance Human Override would be hardest to detect before it compounds?
- How would Cost Latency Governance Human Override behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Cost Latency Governance Human Override?
...
- A contract and failure-label set for Cost Latency Governance Human Override.
...
- [ ] The system behind Cost Latency Governance Human Override is described more clearly than the prompt surface.
