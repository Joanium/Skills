---
name: Spring Boot Contract Evolution
trigger: spring boot contract evolution, help with spring boot contract evolution, plan spring boot contract evolution, improve spring boot contract evolution, expert spring boot contract evolution
description: Expert-level guidance for spring boot contract evolution with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Spring Boot Contract Evolution is an expert backend skill for Spring Boot. The focal concern is Contract Evolution, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when Spring Boot Contract Evolution shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside Spring Boot Contract Evolution breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in Spring Boot Contract Evolution?
- Where does Spring Boot Contract Evolution need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether Spring Boot Contract Evolution is unhealthy before customers do?
- What compatibility promise is implied by Spring Boot Contract Evolution even if it was never written down?
...
- A contract note for Spring Boot Contract Evolution that includes failure semantics.
...
- [ ] The contract for Spring Boot Contract Evolution is explicit about success and failure behavior.
