---
name: Refactor Campaigns Change Narratives
trigger: refactor campaigns change narratives, help with refactor campaigns change narratives, plan refactor campaigns change narratives, improve refactor campaigns change narratives, expert refactor campaigns change narratives
description: Expert-level guidance for refactor campaigns change narratives with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Change Narratives is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Change Narratives, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Change Narratives determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Change Narratives riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Change Narratives first, and what evidence would they need?
- How could Refactor Campaigns Change Narratives fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Change Narratives would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Change Narratives concretely?
...
- A blast-radius note for Refactor Campaigns Change Narratives.
...
- [ ] The repository-level blast radius of Refactor Campaigns Change Narratives is explicit.
