---
name: Computer Vision Tooling Workflows
trigger: computer vision tooling workflows, help with computer vision tooling workflows, plan computer vision tooling workflows, improve computer vision tooling workflows, expert computer vision tooling workflows
description: Expert-level guidance for computer vision tooling workflows with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Computer Vision Tooling Workflows is an expert systems skill for Computer Vision. The focal concern is Tooling Workflows, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Computer Vision Tooling Workflows is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Computer Vision Tooling Workflows would break first under scale, timing, or hardware stress?
- Which state or resource in Computer Vision Tooling Workflows is hardest to observe when behavior goes wrong?
- How does Computer Vision Tooling Workflows trade correctness, throughput, and recoverability today?
- What tooling gap makes Computer Vision Tooling Workflows harder to reason about than it should be?
- Which optimization target inside Computer Vision Tooling Workflows is attractive but strategically secondary?
...
- A system model for Computer Vision Tooling Workflows that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Computer Vision Tooling Workflows is explicit.
