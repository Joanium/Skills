---
name: Model Routing Operations
trigger: model routing operations, help with model routing operations, plan model routing operations, improve model routing operations
description: Practical guidance for planning and executing model routing operations with clear scope, tradeoffs, and validation steps.
---

Model Routing Operations helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
