---
name: Rails Contract Evolution
trigger: rails contract evolution, help with rails contract evolution, plan rails contract evolution, improve rails contract evolution, expert rails contract evolution
description: Expert-level guidance for rails contract evolution with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Rails Contract Evolution is an expert backend skill for Rails. The focal concern is Contract Evolution, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when Rails Contract Evolution shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside Rails Contract Evolution breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in Rails Contract Evolution?
- Where does Rails Contract Evolution need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether Rails Contract Evolution is unhealthy before customers do?
- What compatibility promise is implied by Rails Contract Evolution even if it was never written down?
...
- A contract note for Rails Contract Evolution that includes failure semantics.
...
- [ ] The contract for Rails Contract Evolution is explicit about success and failure behavior.
