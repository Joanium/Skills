---
name: Modular Monoliths Data Ownership
trigger: modular monoliths data ownership, help with modular monoliths data ownership, plan modular monoliths data ownership, improve modular monoliths data ownership, expert modular monoliths data ownership
description: Expert-level guidance for modular monoliths data ownership with action-oriented workflow, review criteria, and failure patterns.
---

Modular Monoliths Data Ownership is an expert architecture and systems skill for Modular Monoliths. The focal concern is Data Ownership, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Modular Monoliths Data Ownership needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Modular Monoliths Data Ownership becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Modular Monoliths Data Ownership is currently cheap only because the bill has not arrived yet?
- How would Modular Monoliths Data Ownership be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Modular Monoliths Data Ownership too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Modular Monoliths Data Ownership.
...
- [ ] The key boundaries inside Modular Monoliths Data Ownership are explicit and justified.
