---
name: Bug Reproduction Verification Loops
trigger: bug reproduction verification loops, help with bug reproduction verification loops, plan bug reproduction verification loops, improve bug reproduction verification loops, expert bug reproduction verification loops
description: Expert-level guidance for bug reproduction verification loops with action-oriented workflow, review criteria, and failure patterns.
---

Bug Reproduction Verification Loops is an expert coding workflow skill for Bug Reproduction. The focal concern is Verification Loops, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Bug Reproduction Verification Loops is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Bug Reproduction Verification Loops is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Bug Reproduction Verification Loops would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Bug Reproduction Verification Loops create a silent regression that tests may miss?
- How would the AI explain the safety of Bug Reproduction Verification Loops to a skeptical reviewer?
...
- A concise evidence note for Bug Reproduction Verification Loops.
...
- [ ] The evidence supporting Bug Reproduction Verification Loops is stronger than the assumptions.
