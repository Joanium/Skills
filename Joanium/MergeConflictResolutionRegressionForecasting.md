---
name: Merge Conflict Resolution Regression Forecasting
trigger: merge conflict resolution regression forecasting, help with merge conflict resolution regression forecasting, plan merge conflict resolution regression forecasting, improve merge conflict resolution regression forecasting, expert merge conflict resolution regression forecasting
description: Expert-level guidance for merge conflict resolution regression forecasting with action-oriented workflow, review criteria, and failure patterns.
---

Merge Conflict Resolution Regression Forecasting is an expert repository and delivery skill for Merge Conflict Resolution. The focal concern is Regression Forecasting, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Merge Conflict Resolution Regression Forecasting determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Merge Conflict Resolution Regression Forecasting riskier than the diff itself suggests?
- Which reviewer would challenge Merge Conflict Resolution Regression Forecasting first, and what evidence would they need?
- How could Merge Conflict Resolution Regression Forecasting fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Merge Conflict Resolution Regression Forecasting would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Merge Conflict Resolution Regression Forecasting concretely?
...
- A blast-radius note for Merge Conflict Resolution Regression Forecasting.
...
- [ ] The repository-level blast radius of Merge Conflict Resolution Regression Forecasting is explicit.
