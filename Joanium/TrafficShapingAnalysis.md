---
name: Traffic Shaping Analysis
trigger: traffic shaping analysis, help with traffic shaping analysis, plan traffic shaping analysis, improve traffic shaping analysis
description: Practical guidance for planning and executing traffic shaping analysis with clear scope, tradeoffs, and validation steps.
---

Traffic Shaping Analysis focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
