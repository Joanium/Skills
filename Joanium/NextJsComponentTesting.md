---
name: Next.js Component Testing
trigger: next.js component testing, help with next.js component testing, plan next.js component testing, improve next.js component testing, expert next.js component testing
description: Expert-level guidance for next.js component testing with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Next.js Component Testing is an expert frontend skill for Next.js. The focal concern is Component Testing, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when Next.js Component Testing affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does Next.js Component Testing make user state harder to reason about than it needs to be?
- Which interaction in Next.js Component Testing degrades first under latency, stale data, or partial failure?
- What accessibility behavior in Next.js Component Testing would break if the DOM or state changed unexpectedly?
- How does Next.js Component Testing fail when routing, hydration, or rendering order becomes non-ideal?
- What part of Next.js Component Testing looks correct in a mock but collapses under production behavior?
...
- A state transition map for Next.js Component Testing.
...
- [ ] The state model for Next.js Component Testing is clear enough to debug.
...
- [ ] Another engineer can extend Next.js Component Testing without guessing hidden UI contracts.
