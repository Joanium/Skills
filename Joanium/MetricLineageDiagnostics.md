---
name: Metric Lineage Diagnostics
trigger: metric lineage diagnostics, help with metric lineage diagnostics, plan metric lineage diagnostics, improve metric lineage diagnostics
description: Practical guidance for planning and executing metric lineage diagnostics with clear scope, tradeoffs, and validation steps.
---

Metric Lineage Diagnostics helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
