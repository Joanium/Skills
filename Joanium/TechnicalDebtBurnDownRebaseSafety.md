---
name: Technical Debt Burn Down Rebase Safety
trigger: technical debt burn down rebase safety, help with technical debt burn down rebase safety, plan technical debt burn down rebase safety, improve technical debt burn down rebase safety, expert technical debt burn down rebase safety
description: Expert-level guidance for technical debt burn down rebase safety with action-oriented workflow, review criteria, and failure patterns.
---

Technical Debt Burn Down Rebase Safety is an expert repository and delivery skill for Technical Debt Burn Down. The focal concern is Rebase Safety, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Technical Debt Burn Down Rebase Safety determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Technical Debt Burn Down Rebase Safety riskier than the diff itself suggests?
- Which reviewer would challenge Technical Debt Burn Down Rebase Safety first, and what evidence would they need?
- How could Technical Debt Burn Down Rebase Safety fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Technical Debt Burn Down Rebase Safety would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Technical Debt Burn Down Rebase Safety concretely?
...
- A blast-radius note for Technical Debt Burn Down Rebase Safety.
...
- [ ] The repository-level blast radius of Technical Debt Burn Down Rebase Safety is explicit.
