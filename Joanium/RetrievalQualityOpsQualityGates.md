---
name: Retrieval Quality Operations Quality Gates
trigger: retrieval quality operations quality gates, help with retrieval quality operations quality gates, plan retrieval quality operations quality gates, improve retrieval quality operations quality gates, expert retrieval quality operations quality gates
description: Expert-level guidance for retrieval quality operations quality gates with action-oriented workflow, review criteria, and failure patterns.
---

Retrieval Quality Operations Quality Gates is an expert agent and tooling skill for Retrieval Quality Operations. The focal concern is Quality Gates, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Retrieval Quality Operations Quality Gates affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Retrieval Quality Operations Quality Gates is still governed by intuition instead of a contract or label set?
- Which failure in Retrieval Quality Operations Quality Gates would be hardest to detect before it compounds?
- How would Retrieval Quality Operations Quality Gates behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Retrieval Quality Operations Quality Gates?
...
- A contract and failure-label set for Retrieval Quality Operations Quality Gates.
...
- [ ] The system behind Retrieval Quality Operations Quality Gates is described more clearly than the prompt surface.
