---
name: Install Funnels Analysis
trigger: install funnels analysis, help with install funnels analysis, plan install funnels analysis, improve install funnels analysis
description: Practical guidance for planning and executing install funnels analysis with clear scope, tradeoffs, and validation steps.
---

Install Funnels Analysis focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
