---
name: Campaign Measurement Governance Design
trigger: campaign measurement governance design, help with campaign measurement governance design, plan campaign measurement governance design, improve campaign measurement governance design, expert campaign measurement governance design
description: Expert-level guidance for campaign measurement governance design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Campaign Measurement Governance Design is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Campaign Measurement Governance Design affects acquisition, narrative clarity, or cross-channel execution.
...
- What are the core boundaries, contracts, and invariants in Campaign Measurement Governance Design?
...
- An architecture or boundary diagram for Campaign Measurement Governance Design.
