---
name: Flaky Test Repair Result Interpretation
trigger: flaky test repair result interpretation, help with flaky test repair result interpretation, plan flaky test repair result interpretation, improve flaky test repair result interpretation, expert flaky test repair result interpretation
description: Expert-level guidance for flaky test repair result interpretation with action-oriented workflow, review criteria, and failure patterns.
---

Flaky Test Repair Result Interpretation is an expert testing and quality skill for Flaky Test Repair. The focal concern is Result Interpretation, but the real objective is helping an AI create evidence that code is correct under change, not merely green under ideal conditions.

## When To Use

- Use this when Flaky Test Repair Result Interpretation needs to prove behavior under realistic change and failure conditions rather than just increase test count.
...
- What uncertainty inside Flaky Test Repair Result Interpretation is still untested even if coverage looks healthy?
- Which assertion in Flaky Test Repair Result Interpretation would stay green while the user-visible behavior regressed?
- How much of Flaky Test Repair Result Interpretation depends on mocks, fixtures, or timing assumptions that may be lying?
- What test failure pattern would be most actionable for a future AI debugging pass?
- Where does Flaky Test Repair Result Interpretation need stronger negative cases rather than more positive cases?
...
- A behavior protection map for Flaky Test Repair Result Interpretation.
- A test design note covering fixtures, timing, and oracle choice.
- A failure matrix for the important negative scenarios.
- A triage guide for what failing signals in Flaky Test Repair Result Interpretation should mean.
...
- [ ] The key behavior protected by Flaky Test Repair Result Interpretation is explicit.
