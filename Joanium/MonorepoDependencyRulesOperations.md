---
name: Monorepo Dependency Rules Operations
trigger: monorepo dependency rules operations, help with monorepo dependency rules operations, plan monorepo dependency rules operations, improve monorepo dependency rules operations, expert monorepo dependency rules operations
description: Expert-level guidance for monorepo dependency rules operations, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Monorepo Dependency Rules Operations is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is repeatable day-two execution under real load, incomplete information, and ordinary human error.

## When To Use

- Use this when Monorepo Dependency Rules Operations affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the recurring operational decisions inside Monorepo Dependency Rules Operations?
...
- A runbook for Monorepo Dependency Rules Operations covering routine and degraded modes.
