---
name: Evaluation Harnesses Cost Control
trigger: evaluation harnesses cost control, help with evaluation harnesses cost control, plan evaluation harnesses cost control, improve evaluation harnesses cost control, expert evaluation harnesses cost control
description: Expert-level guidance for evaluation harnesses cost control with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Evaluation Harnesses Cost Control is an expert applied-AI skill for Evaluation Harnesses. The focal concern is Cost Control, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Evaluation Harnesses Cost Control affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Evaluation Harnesses Cost Control would look acceptable in a demo but fail under production ambiguity?
- Which part of Evaluation Harnesses Cost Control lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Evaluation Harnesses Cost Control fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Evaluation Harnesses Cost Control is getting better rather than merely changing?
- Where should humans intervene in Evaluation Harnesses Cost Control to add leverage instead of toil?
...
- A behavior contract for Evaluation Harnesses Cost Control.
...
- [ ] The behavior contract for Evaluation Harnesses Cost Control is explicit.
