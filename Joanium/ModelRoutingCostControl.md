---
name: Model Routing Cost Control
trigger: model routing cost control, help with model routing cost control, plan model routing cost control, improve model routing cost control, expert model routing cost control
description: Expert-level guidance for model routing cost control with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Model Routing Cost Control is an expert applied-AI skill for Model Routing. The focal concern is Cost Control, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Model Routing Cost Control affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Model Routing Cost Control would look acceptable in a demo but fail under production ambiguity?
- Which part of Model Routing Cost Control lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Model Routing Cost Control fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Model Routing Cost Control is getting better rather than merely changing?
- Where should humans intervene in Model Routing Cost Control to add leverage instead of toil?
...
- A behavior contract for Model Routing Cost Control.
...
- [ ] The behavior contract for Model Routing Cost Control is explicit.
