---
name: Legacy Boundary Extraction Operations
trigger: legacy boundary extraction operations, help with legacy boundary extraction operations, plan legacy boundary extraction operations, improve legacy boundary extraction operations, expert legacy boundary extraction operations
description: Expert-level guidance for legacy boundary extraction operations, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Legacy Boundary Extraction Operations is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is repeatable day-two execution under real load, incomplete information, and ordinary human error.

## When To Use

- Use this when Legacy Boundary Extraction Operations affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the recurring operational decisions inside Legacy Boundary Extraction Operations?
...
- A runbook for Legacy Boundary Extraction Operations covering routine and degraded modes.
