---
name: Background Job Recovery Retry Discipline
trigger: background job recovery retry discipline, help with background job recovery retry discipline, plan background job recovery retry discipline, improve background job recovery retry discipline, expert background job recovery retry discipline
description: Expert-level guidance for background job recovery retry discipline with action-oriented workflow, review criteria, and failure patterns.
---

Background Job Recovery Retry Discipline is an expert backend execution skill for Background Job Recovery. The focal concern is Retry Discipline, but the real objective is helping an AI design service behavior that stays coherent under retries, queues, partial failure, and operational pressure.

## When To Use

- Use this when Background Job Recovery Retry Discipline affects whether backend changes remain safe once real production behavior kicks in.
...
- Which failure ordering inside Background Job Recovery Retry Discipline would create the most misleading symptom?
- Where does Background Job Recovery Retry Discipline need stronger idempotency or retry discipline?
- What dependency in Background Job Recovery Retry Discipline is currently hiding behind timeout or queue noise?
- How would an operator explain the health of Background Job Recovery Retry Discipline in the first five minutes of an incident?
- What contract assumption in Background Job Recovery Retry Discipline is least defensible under partial failure?
...
- A failure-sequence note for Background Job Recovery Retry Discipline.
...
- [ ] The real behavior of Background Job Recovery Retry Discipline under retries and failures is explicit.
