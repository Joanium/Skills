---
name: RAG Systems Experiment Tracking
trigger: rag systems experiment tracking, help with rag systems experiment tracking, plan rag systems experiment tracking, improve rag systems experiment tracking, expert rag systems experiment tracking
description: Expert-level guidance for rag systems experiment tracking with action-oriented workflow, review criteria, and failure patterns.
---

RAG Systems Experiment Tracking is an expert applied AI skill for RAG Systems. The focal concern is Experiment Tracking, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when RAG Systems Experiment Tracking affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of RAG Systems Experiment Tracking is currently measured by vibes rather than a real contract?
- Which failure in RAG Systems Experiment Tracking would be hardest to notice before it harms users or operators?
- How will RAG Systems Experiment Tracking behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside RAG Systems Experiment Tracking?
...
- A behavior contract for RAG Systems Experiment Tracking.
...
- [ ] The contract behind RAG Systems Experiment Tracking is explicit enough to evaluate.
