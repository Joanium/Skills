---
name: Evaluation Harnesses Data Contracts
trigger: evaluation harnesses data contracts, help with evaluation harnesses data contracts, plan evaluation harnesses data contracts, improve evaluation harnesses data contracts, expert evaluation harnesses data contracts
description: Expert-level guidance for evaluation harnesses data contracts with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Evaluation Harnesses Data Contracts is an expert applied-AI skill for Evaluation Harnesses. The focal concern is Data Contracts, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Evaluation Harnesses Data Contracts affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Evaluation Harnesses Data Contracts would look acceptable in a demo but fail under production ambiguity?
- Which part of Evaluation Harnesses Data Contracts lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Evaluation Harnesses Data Contracts fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Evaluation Harnesses Data Contracts is getting better rather than merely changing?
- Where should humans intervene in Evaluation Harnesses Data Contracts to add leverage instead of toil?
...
- A behavior contract for Evaluation Harnesses Data Contracts.
...
- [ ] The behavior contract for Evaluation Harnesses Data Contracts is explicit.
