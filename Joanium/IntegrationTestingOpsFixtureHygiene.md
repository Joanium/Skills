---
name: Integration Testing Operations Fixture Hygiene
trigger: integration testing operations fixture hygiene, help with integration testing operations fixture hygiene, plan integration testing operations fixture hygiene, improve integration testing operations fixture hygiene, expert integration testing operations fixture hygiene
description: Expert-level guidance for integration testing operations fixture hygiene with action-oriented workflow, review criteria, and failure patterns.
---

Integration Testing Operations Fixture Hygiene is an expert testing and quality skill for Integration Testing Operations. The focal concern is Fixture Hygiene, but the real objective is helping an AI create evidence that code is correct under change, not merely green under ideal conditions.

## When To Use

- Use this when Integration Testing Operations Fixture Hygiene needs to prove behavior under realistic change and failure conditions rather than just increase test count.
...
- What uncertainty inside Integration Testing Operations Fixture Hygiene is still untested even if coverage looks healthy?
- Which assertion in Integration Testing Operations Fixture Hygiene would stay green while the user-visible behavior regressed?
- How much of Integration Testing Operations Fixture Hygiene depends on mocks, fixtures, or timing assumptions that may be lying?
- What test failure pattern would be most actionable for a future AI debugging pass?
- Where does Integration Testing Operations Fixture Hygiene need stronger negative cases rather than more positive cases?
...
- A behavior protection map for Integration Testing Operations Fixture Hygiene.
- A test design note covering fixtures, timing, and oracle choice.
- A failure matrix for the important negative scenarios.
- A triage guide for what failing signals in Integration Testing Operations Fixture Hygiene should mean.
...
- [ ] The key behavior protected by Integration Testing Operations Fixture Hygiene is explicit.
