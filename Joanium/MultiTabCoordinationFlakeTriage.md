---
name: Multi-Tab Coordination Flake Triage
trigger: multi-tab coordination flake triage, help with multi-tab coordination flake triage, plan multi-tab coordination flake triage, improve multi-tab coordination flake triage, expert multi-tab coordination flake triage
description: Expert-level guidance for multi-tab coordination flake triage with action-oriented workflow, review criteria, and failure patterns.
---

Multi-Tab Coordination Flake Triage is an expert browser automation skill for Multi-Tab Coordination. The focal concern is Flake Triage, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Multi-Tab Coordination Flake Triage needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Multi-Tab Coordination Flake Triage unreliable across runs?
- Which timing or selector assumption in Multi-Tab Coordination Flake Triage is least stable under real conditions?
- How would Multi-Tab Coordination Flake Triage behave differently across browsers, profiles, or CI environments?
- What artifacts should Multi-Tab Coordination Flake Triage capture so the next failure is diagnosable instead of mysterious?
- Which part of Multi-Tab Coordination Flake Triage is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Multi-Tab Coordination Flake Triage.
...
- [ ] The state model behind Multi-Tab Coordination Flake Triage is explicit.
