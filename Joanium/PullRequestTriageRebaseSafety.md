---
name: Pull Request Triage Rebase Safety
trigger: pull request triage rebase safety, help with pull request triage rebase safety, plan pull request triage rebase safety, improve pull request triage rebase safety, expert pull request triage rebase safety
description: Expert-level guidance for pull request triage rebase safety with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Rebase Safety is an expert repository and delivery skill for Pull Request Triage. The focal concern is Rebase Safety, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Rebase Safety determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Rebase Safety riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Rebase Safety first, and what evidence would they need?
- How could Pull Request Triage Rebase Safety fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Rebase Safety would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Rebase Safety concretely?
...
- A blast-radius note for Pull Request Triage Rebase Safety.
...
- [ ] The repository-level blast radius of Pull Request Triage Rebase Safety is explicit.
