---
name: Semantic Contracts Design
trigger: semantic contracts design, help with semantic contracts design, plan semantic contracts design, improve semantic contracts design, expert semantic contracts design
description: Expert-level guidance for semantic contracts design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Semantic Contracts Design is an expert-level data systems skill for turning analysis and pipelines into governed, trusted, and operationally stable assets. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Semantic Contracts Design affects downstream metrics, decisions, or customer-facing data products.
...
- What are the core boundaries, contracts, and invariants in Semantic Contracts Design?
...
- An architecture or boundary diagram for Semantic Contracts Design.
