---
name: Battery Budget Enforcement Governance
trigger: battery budget enforcement governance, help with battery budget enforcement governance, plan battery budget enforcement governance, improve battery budget enforcement governance, expert battery budget enforcement governance
description: Expert-level guidance for battery budget enforcement governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Battery Budget Enforcement Governance is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Battery Budget Enforcement Governance affects release risk, device behavior, or user trust during degraded conditions.
...
- Who sets the policy for Battery Budget Enforcement Governance, and who is allowed to grant exceptions?
...
- A policy document for Battery Budget Enforcement Governance with explicit scope.
