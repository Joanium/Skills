---
name: Backup Verification Design
trigger: backup verification design, help with backup verification design, plan backup verification design, improve backup verification design
description: Practical guidance for planning and executing backup verification design with clear scope, tradeoffs, and validation steps.
---

Backup Verification Design focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
