---
name: Design Tokens Analysis
trigger: design tokens analysis, help with design tokens analysis, plan design tokens analysis, improve design tokens analysis
description: Practical guidance for planning and executing design tokens analysis with clear scope, tradeoffs, and validation steps.
---

Design Tokens Analysis improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
