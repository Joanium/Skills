---
name: Client Observability Diagnostics
trigger: client observability diagnostics, help with client observability diagnostics, plan client observability diagnostics, improve client observability diagnostics
description: Practical guidance for planning and executing client observability diagnostics with clear scope, tradeoffs, and validation steps.
---

Client Observability Diagnostics improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
