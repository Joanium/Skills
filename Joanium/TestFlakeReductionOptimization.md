---
name: Test Flake Reduction Optimization
trigger: test flake reduction optimization, help with test flake reduction optimization, plan test flake reduction optimization, improve test flake reduction optimization
description: Practical guidance for planning and executing test flake reduction optimization with clear scope, tradeoffs, and validation steps.
---

Test Flake Reduction Optimization improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
