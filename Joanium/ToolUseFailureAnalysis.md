---
name: Tool Use Failure Analysis
trigger: tool use failure analysis, help with tool use failure analysis, plan tool use failure analysis, improve tool use failure analysis, expert tool use failure analysis
description: Expert-level guidance for tool use failure analysis with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Tool Use Failure Analysis is an expert applied-AI skill for Tool Use. The focal concern is Failure Analysis, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Tool Use Failure Analysis affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Tool Use Failure Analysis would look acceptable in a demo but fail under production ambiguity?
- Which part of Tool Use Failure Analysis lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Tool Use Failure Analysis fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Tool Use Failure Analysis is getting better rather than merely changing?
- Where should humans intervene in Tool Use Failure Analysis to add leverage instead of toil?
...
- A behavior contract for Tool Use Failure Analysis.
...
- [ ] The behavior contract for Tool Use Failure Analysis is explicit.
