---
name: Permission Prompt Triage Artifact Capture
trigger: permission prompt triage artifact capture, help with permission prompt triage artifact capture, plan permission prompt triage artifact capture, improve permission prompt triage artifact capture, expert permission prompt triage artifact capture
description: Expert-level guidance for permission prompt triage artifact capture with action-oriented workflow, review criteria, and failure patterns.
---

Permission Prompt Triage Artifact Capture is an expert browser automation skill for Permission Prompt Triage. The focal concern is Artifact Capture, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Permission Prompt Triage Artifact Capture needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Permission Prompt Triage Artifact Capture unreliable across runs?
- Which timing or selector assumption in Permission Prompt Triage Artifact Capture is least stable under real conditions?
- How would Permission Prompt Triage Artifact Capture behave differently across browsers, profiles, or CI environments?
- What artifacts should Permission Prompt Triage Artifact Capture capture so the next failure is diagnosable instead of mysterious?
- Which part of Permission Prompt Triage Artifact Capture is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Permission Prompt Triage Artifact Capture.
...
- [ ] The state model behind Permission Prompt Triage Artifact Capture is explicit.
