---
name: Component APIs Operations
trigger: component apis operations, help with component apis operations, plan component apis operations, improve component apis operations
description: Practical guidance for planning and executing component apis operations with clear scope, tradeoffs, and validation steps.
---

Component APIs Operations improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
