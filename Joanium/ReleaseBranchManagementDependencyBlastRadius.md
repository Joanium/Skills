---
name: Release Branch Management Dependency Blast Radius
trigger: release branch management dependency blast radius, help with release branch management dependency blast radius, plan release branch management dependency blast radius, improve release branch management dependency blast radius, expert release branch management dependency blast radius
description: Expert-level guidance for release branch management dependency blast radius with action-oriented workflow, review criteria, and failure patterns.
---

Release Branch Management Dependency Blast Radius is an expert repository and delivery skill for Release Branch Management. The focal concern is Dependency Blast Radius, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Release Branch Management Dependency Blast Radius determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Release Branch Management Dependency Blast Radius riskier than the diff itself suggests?
- Which reviewer would challenge Release Branch Management Dependency Blast Radius first, and what evidence would they need?
- How could Release Branch Management Dependency Blast Radius fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Release Branch Management Dependency Blast Radius would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Release Branch Management Dependency Blast Radius concretely?
...
- A blast-radius note for Release Branch Management Dependency Blast Radius.
...
- [ ] The repository-level blast radius of Release Branch Management Dependency Blast Radius is explicit.
