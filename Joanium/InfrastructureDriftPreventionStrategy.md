---
name: Infrastructure Drift Prevention Strategy
trigger: infrastructure drift prevention strategy, help with infrastructure drift prevention strategy, plan infrastructure drift prevention strategy, improve infrastructure drift prevention strategy, expert infrastructure drift prevention strategy
description: Expert-level guidance for infrastructure drift prevention strategy, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Infrastructure Drift Prevention Strategy is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is on choosing the operating model, decision boundaries, and success criteria before local optimizations become policy by accident.

## When To Use

- Use this when Infrastructure Drift Prevention Strategy changes service availability, deployment safety, or recovery behavior.
...
- What decision is Infrastructure Drift Prevention Strategy supposed to improve over the next planning horizon?
- Which constraints are fixed, and which are merely habits that can be challenged?
- Where does failure in Infrastructure Drift Prevention Strategy create the largest technical, business, or trust cost?
...
- A written decision statement for Infrastructure Drift Prevention Strategy.
