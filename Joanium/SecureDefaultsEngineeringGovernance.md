---
name: Secure Defaults Engineering Governance
trigger: secure defaults engineering governance, help with secure defaults engineering governance, plan secure defaults engineering governance, improve secure defaults engineering governance, expert secure defaults engineering governance
description: Expert-level guidance for secure defaults engineering governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Secure Defaults Engineering Governance is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Secure Defaults Engineering Governance affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- Who sets the policy for Secure Defaults Engineering Governance, and who is allowed to grant exceptions?
...
- A policy document for Secure Defaults Engineering Governance with explicit scope.
