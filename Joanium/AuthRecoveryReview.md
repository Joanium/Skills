---
name: Auth Recovery Review
trigger: auth recovery review, help with auth recovery review, plan auth recovery review, improve auth recovery review
description: Practical guidance for planning and executing auth recovery review with clear scope, tradeoffs, and validation steps.
---

Auth Recovery Review is about reducing exploitable gaps by pairing preventive controls with review, evidence, and response readiness.
