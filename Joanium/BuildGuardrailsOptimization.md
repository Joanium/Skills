---
name: Build Guardrails Optimization
trigger: build guardrails optimization, help with build guardrails optimization, plan build guardrails optimization, improve build guardrails optimization
description: Practical guidance for planning and executing build guardrails optimization with clear scope, tradeoffs, and validation steps.
---

Build Guardrails Optimization improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
