---
name: Fact Modeling Grain Planning
trigger: fact modeling grain planning, help with fact modeling grain planning, plan fact modeling grain planning, improve fact modeling grain planning, expert fact modeling grain planning
description: Expert-level guidance for fact modeling grain planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Fact Modeling Grain Planning is an expert-level data systems skill for turning analysis and pipelines into governed, trusted, and operationally stable assets. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Fact Modeling Grain Planning affects downstream metrics, decisions, or customer-facing data products.
...
- What must be true before Fact Modeling Grain Planning can start safely?
...
- A milestone plan for Fact Modeling Grain Planning with explicit gating criteria.
