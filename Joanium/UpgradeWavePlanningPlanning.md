---
name: Upgrade Wave Planning Planning
trigger: upgrade wave planning planning, help with upgrade wave planning planning, plan upgrade wave planning planning, improve upgrade wave planning planning, expert upgrade wave planning planning
description: Expert-level guidance for upgrade wave planning planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Upgrade Wave Planning Planning is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Upgrade Wave Planning Planning affects codebase shape, team interfaces, or long-term delivery speed.
...
- What must be true before Upgrade Wave Planning Planning can start safely?
...
- A milestone plan for Upgrade Wave Planning Planning with explicit gating criteria.
