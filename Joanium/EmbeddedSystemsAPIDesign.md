---
name: Embedded Systems API Design
trigger: embedded systems api design, help with embedded systems api design, plan embedded systems api design, improve embedded systems api design, expert embedded systems api design
description: Expert-level guidance for embedded systems api design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Embedded Systems API Design is an expert systems skill for Embedded Systems. The focal concern is API Design, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Embedded Systems API Design is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Embedded Systems API Design would break first under scale, timing, or hardware stress?
- Which state or resource in Embedded Systems API Design is hardest to observe when behavior goes wrong?
- How does Embedded Systems API Design trade correctness, throughput, and recoverability today?
- What tooling gap makes Embedded Systems API Design harder to reason about than it should be?
- Which optimization target inside Embedded Systems API Design is attractive but strategically secondary?
...
- A system model for Embedded Systems API Design that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Embedded Systems API Design is explicit.
