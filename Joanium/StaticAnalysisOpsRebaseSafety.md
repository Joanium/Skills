---
name: Static Analysis Operations Rebase Safety
trigger: static analysis operations rebase safety, help with static analysis operations rebase safety, plan static analysis operations rebase safety, improve static analysis operations rebase safety, expert static analysis operations rebase safety
description: Expert-level guidance for static analysis operations rebase safety with action-oriented workflow, review criteria, and failure patterns.
---

Static Analysis Operations Rebase Safety is an expert repository and delivery skill for Static Analysis Operations. The focal concern is Rebase Safety, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Static Analysis Operations Rebase Safety determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Static Analysis Operations Rebase Safety riskier than the diff itself suggests?
- Which reviewer would challenge Static Analysis Operations Rebase Safety first, and what evidence would they need?
- How could Static Analysis Operations Rebase Safety fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Static Analysis Operations Rebase Safety would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Static Analysis Operations Rebase Safety concretely?
...
- A blast-radius note for Static Analysis Operations Rebase Safety.
...
- [ ] The repository-level blast radius of Static Analysis Operations Rebase Safety is explicit.
