---
name: Install Funnels Strategy
trigger: install funnels strategy, help with install funnels strategy, plan install funnels strategy, improve install funnels strategy
description: Practical guidance for planning and executing install funnels strategy with clear scope, tradeoffs, and validation steps.
---

Install Funnels Strategy focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
