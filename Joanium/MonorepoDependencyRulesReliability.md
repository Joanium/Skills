---
name: Monorepo Dependency Rules Reliability
trigger: monorepo dependency rules reliability, help with monorepo dependency rules reliability, plan monorepo dependency rules reliability, improve monorepo dependency rules reliability, expert monorepo dependency rules reliability
description: Expert-level guidance for monorepo dependency rules reliability, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Monorepo Dependency Rules Reliability is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is designing graceful degradation, recovery paths, and explicit reliability targets before the system is stressed.

## When To Use

- Use this when Monorepo Dependency Rules Reliability affects codebase shape, team interfaces, or long-term delivery speed.
...
- What are the most likely and most damaging failure modes in Monorepo Dependency Rules Reliability?
...
- A failure mode catalog for Monorepo Dependency Rules Reliability.
