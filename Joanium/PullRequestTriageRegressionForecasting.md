---
name: Pull Request Triage Regression Forecasting
trigger: pull request triage regression forecasting, help with pull request triage regression forecasting, plan pull request triage regression forecasting, improve pull request triage regression forecasting, expert pull request triage regression forecasting
description: Expert-level guidance for pull request triage regression forecasting with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Regression Forecasting is an expert repository and delivery skill for Pull Request Triage. The focal concern is Regression Forecasting, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Regression Forecasting determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Regression Forecasting riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Regression Forecasting first, and what evidence would they need?
- How could Pull Request Triage Regression Forecasting fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Regression Forecasting would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Regression Forecasting concretely?
...
- A blast-radius note for Pull Request Triage Regression Forecasting.
...
- [ ] The repository-level blast radius of Pull Request Triage Regression Forecasting is explicit.
