---
name: Narrative Testing Systems Governance
trigger: narrative testing systems governance, help with narrative testing systems governance, plan narrative testing systems governance, improve narrative testing systems governance, expert narrative testing systems governance
description: Expert-level guidance for narrative testing systems governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Narrative Testing Systems Governance is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Narrative Testing Systems Governance affects acquisition, narrative clarity, or cross-channel execution.
...
- Who sets the policy for Narrative Testing Systems Governance, and who is allowed to grant exceptions?
...
- A policy document for Narrative Testing Systems Governance with explicit scope.
