---
name: Agent Coordination Task Contracts
trigger: agent coordination task contracts, help with agent coordination task contracts, plan agent coordination task contracts, improve agent coordination task contracts, expert agent coordination task contracts
description: Expert-level guidance for agent coordination task contracts with action-oriented workflow, review criteria, and failure patterns.
---

Agent Coordination Task Contracts is an expert applied AI skill for Agent Coordination. The focal concern is Task Contracts, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Agent Coordination Task Contracts affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Agent Coordination Task Contracts is currently measured by vibes rather than a real contract?
- Which failure in Agent Coordination Task Contracts would be hardest to notice before it harms users or operators?
- How will Agent Coordination Task Contracts behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Agent Coordination Task Contracts?
...
- A behavior contract for Agent Coordination Task Contracts.
...
- [ ] The contract behind Agent Coordination Task Contracts is explicit enough to evaluate.
