---
name: Graphics Programming API Design
trigger: graphics programming api design, help with graphics programming api design, plan graphics programming api design, improve graphics programming api design, expert graphics programming api design
description: Expert-level guidance for graphics programming api design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Graphics Programming API Design is an expert systems skill for Graphics Programming. The focal concern is API Design, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Graphics Programming API Design is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Graphics Programming API Design would break first under scale, timing, or hardware stress?
- Which state or resource in Graphics Programming API Design is hardest to observe when behavior goes wrong?
- How does Graphics Programming API Design trade correctness, throughput, and recoverability today?
- What tooling gap makes Graphics Programming API Design harder to reason about than it should be?
- Which optimization target inside Graphics Programming API Design is attractive but strategically secondary?
...
- A system model for Graphics Programming API Design that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Graphics Programming API Design is explicit.
