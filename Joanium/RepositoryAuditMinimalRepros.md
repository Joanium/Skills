---
name: Repository Audit Minimal Repros
trigger: repository audit minimal repros, help with repository audit minimal repros, plan repository audit minimal repros, improve repository audit minimal repros, expert repository audit minimal repros
description: Expert-level guidance for repository audit minimal repros with action-oriented workflow, review criteria, and failure patterns.
---

Repository Audit Minimal Repros is an expert coding workflow skill for Repository Audit. The focal concern is Minimal Repros, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Repository Audit Minimal Repros is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Repository Audit Minimal Repros is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Repository Audit Minimal Repros would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Repository Audit Minimal Repros create a silent regression that tests may miss?
- How would the AI explain the safety of Repository Audit Minimal Repros to a skeptical reviewer?
...
- A concise evidence note for Repository Audit Minimal Repros.
...
- [ ] The evidence supporting Repository Audit Minimal Repros is stronger than the assumptions.
