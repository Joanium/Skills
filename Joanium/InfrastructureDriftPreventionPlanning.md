---
name: Infrastructure Drift Prevention Planning
trigger: infrastructure drift prevention planning, help with infrastructure drift prevention planning, plan infrastructure drift prevention planning, improve infrastructure drift prevention planning, expert infrastructure drift prevention planning
description: Expert-level guidance for infrastructure drift prevention planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Infrastructure Drift Prevention Planning is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Infrastructure Drift Prevention Planning changes service availability, deployment safety, or recovery behavior.
...
- What must be true before Infrastructure Drift Prevention Planning can start safely?
...
- A milestone plan for Infrastructure Drift Prevention Planning with explicit gating criteria.
