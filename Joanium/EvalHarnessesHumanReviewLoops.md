---
name: Evaluation Harnesses Human Review Loops
trigger: evaluation harnesses human review loops, help with evaluation harnesses human review loops, plan evaluation harnesses human review loops, improve evaluation harnesses human review loops, expert evaluation harnesses human review loops
description: Expert-level guidance for evaluation harnesses human review loops with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Evaluation Harnesses Human Review Loops is an expert applied-AI skill for Evaluation Harnesses. The focal concern is Human Review Loops, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Evaluation Harnesses Human Review Loops affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Evaluation Harnesses Human Review Loops would look acceptable in a demo but fail under production ambiguity?
- Which part of Evaluation Harnesses Human Review Loops lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Evaluation Harnesses Human Review Loops fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Evaluation Harnesses Human Review Loops is getting better rather than merely changing?
- Where should humans intervene in Evaluation Harnesses Human Review Loops to add leverage instead of toil?
...
- A behavior contract for Evaluation Harnesses Human Review Loops.
...
- [ ] The behavior contract for Evaluation Harnesses Human Review Loops is explicit.
