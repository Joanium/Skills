---
name: API Incident Triage Retry Discipline
trigger: api incident triage retry discipline, help with api incident triage retry discipline, plan api incident triage retry discipline, improve api incident triage retry discipline, expert api incident triage retry discipline
description: Expert-level guidance for api incident triage retry discipline with action-oriented workflow, review criteria, and failure patterns.
---

API Incident Triage Retry Discipline is an expert backend execution skill for API Incident Triage. The focal concern is Retry Discipline, but the real objective is helping an AI design service behavior that stays coherent under retries, queues, partial failure, and operational pressure.

## When To Use

- Use this when API Incident Triage Retry Discipline affects whether backend changes remain safe once real production behavior kicks in.
...
- Which failure ordering inside API Incident Triage Retry Discipline would create the most misleading symptom?
- Where does API Incident Triage Retry Discipline need stronger idempotency or retry discipline?
- What dependency in API Incident Triage Retry Discipline is currently hiding behind timeout or queue noise?
- How would an operator explain the health of API Incident Triage Retry Discipline in the first five minutes of an incident?
- What contract assumption in API Incident Triage Retry Discipline is least defensible under partial failure?
...
- A failure-sequence note for API Incident Triage Retry Discipline.
...
- [ ] The real behavior of API Incident Triage Retry Discipline under retries and failures is explicit.
