---
name: Legacy Refactor Automation Hooks
trigger: legacy refactor automation hooks, help with legacy refactor automation hooks, plan legacy refactor automation hooks, improve legacy refactor automation hooks, expert legacy refactor automation hooks
description: Expert-level guidance for legacy refactor automation hooks with action-oriented workflow, review criteria, and failure patterns.
---

Legacy Refactor Automation Hooks is an expert coding workflow skill for Legacy Refactor. The focal concern is Automation Hooks, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Legacy Refactor Automation Hooks is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Legacy Refactor Automation Hooks is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Legacy Refactor Automation Hooks would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Legacy Refactor Automation Hooks create a silent regression that tests may miss?
- How would the AI explain the safety of Legacy Refactor Automation Hooks to a skeptical reviewer?
...
- A concise evidence note for Legacy Refactor Automation Hooks.
...
- [ ] The evidence supporting Legacy Refactor Automation Hooks is stronger than the assumptions.
