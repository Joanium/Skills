---
name: GraphQL Contract Evolution
trigger: graphql contract evolution, help with graphql contract evolution, plan graphql contract evolution, improve graphql contract evolution, expert graphql contract evolution
description: Expert-level guidance for graphql contract evolution with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GraphQL Contract Evolution is an expert backend skill for GraphQL. The focal concern is Contract Evolution, but the real task is creating server behavior that remains understandable under load, retries, and partial failure.

## When To Use

- Use this when GraphQL Contract Evolution shapes correctness, reliability, or compatibility for a backend surface that other systems depend on.
...
- What assumption inside GraphQL Contract Evolution breaks first under concurrency, retries, or partial failure?
- Which client or downstream system will feel contract ambiguity most painfully in GraphQL Contract Evolution?
- Where does GraphQL Contract Evolution need stronger semantics: authentication, errors, ordering, or isolation?
- How will operators know whether GraphQL Contract Evolution is unhealthy before customers do?
- What compatibility promise is implied by GraphQL Contract Evolution even if it was never written down?
...
- A contract note for GraphQL Contract Evolution that includes failure semantics.
...
- [ ] The contract for GraphQL Contract Evolution is explicit about success and failure behavior.
