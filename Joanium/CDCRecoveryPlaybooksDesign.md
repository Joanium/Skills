---
name: CDC Recovery Playbooks Design
trigger: cdc recovery playbooks design, help with cdc recovery playbooks design, plan cdc recovery playbooks design, improve cdc recovery playbooks design, expert cdc recovery playbooks design
description: Expert-level guidance for cdc recovery playbooks design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

CDC Recovery Playbooks Design is an expert-level data systems skill for turning analysis and pipelines into governed, trusted, and operationally stable assets. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when CDC Recovery Playbooks Design affects downstream metrics, decisions, or customer-facing data products.
...
- What are the core boundaries, contracts, and invariants in CDC Recovery Playbooks Design?
...
- An architecture or boundary diagram for CDC Recovery Playbooks Design.
