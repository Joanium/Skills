---
name: Cluster Tenancy Optimization
trigger: cluster tenancy optimization, help with cluster tenancy optimization, plan cluster tenancy optimization, improve cluster tenancy optimization
description: Practical guidance for planning and executing cluster tenancy optimization with clear scope, tradeoffs, and validation steps.
---

Cluster Tenancy Optimization focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
