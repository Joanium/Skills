---
name: Context Window Budgeting Strategy
trigger: context window budgeting strategy, help with context window budgeting strategy, plan context window budgeting strategy, improve context window budgeting strategy, expert context window budgeting strategy
description: Expert-level guidance for context window budgeting strategy, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---
...
- Use this when Context Window Budgeting Strategy influences user-visible output, automation, or safety-sensitive decisions.
...
- What decision is Context Window Budgeting Strategy supposed to improve over the next planning horizon?
- Which constraints are fixed, and which are merely habits that can be challenged?
- Where does failure in Context Window Budgeting Strategy create the largest technical, business, or trust cost?
...
- A written decision statement for Context Window Budgeting Strategy.
