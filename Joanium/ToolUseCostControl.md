---
name: Tool Use Cost Control
trigger: tool use cost control, help with tool use cost control, plan tool use cost control, improve tool use cost control, expert tool use cost control
description: Expert-level guidance for tool use cost control with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Tool Use Cost Control is an expert applied-AI skill for Tool Use. The focal concern is Cost Control, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Tool Use Cost Control affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Tool Use Cost Control would look acceptable in a demo but fail under production ambiguity?
- Which part of Tool Use Cost Control lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Tool Use Cost Control fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Tool Use Cost Control is getting better rather than merely changing?
- Where should humans intervene in Tool Use Cost Control to add leverage instead of toil?
...
- A behavior contract for Tool Use Cost Control.
...
- [ ] The behavior contract for Tool Use Cost Control is explicit.
