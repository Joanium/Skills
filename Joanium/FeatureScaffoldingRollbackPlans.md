---
name: Feature Scaffolding Rollback Plans
trigger: feature scaffolding rollback plans, help with feature scaffolding rollback plans, plan feature scaffolding rollback plans, improve feature scaffolding rollback plans, expert feature scaffolding rollback plans
description: Expert-level guidance for feature scaffolding rollback plans with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Rollback Plans is an expert coding workflow skill for Feature Scaffolding. The focal concern is Rollback Plans, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Rollback Plans is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Rollback Plans is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Rollback Plans would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Rollback Plans create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Rollback Plans to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Rollback Plans.
...
- [ ] The evidence supporting Feature Scaffolding Rollback Plans is stronger than the assumptions.
