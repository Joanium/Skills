---
name: Evaluation Datasets Analysis
trigger: evaluation datasets analysis, help with evaluation datasets analysis, plan evaluation datasets analysis, improve evaluation datasets analysis
description: Practical guidance for planning and executing evaluation datasets analysis with clear scope, tradeoffs, and validation steps.
---

Evaluation Datasets Analysis helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
