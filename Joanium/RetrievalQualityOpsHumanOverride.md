---
name: Retrieval Quality Operations Human Override
trigger: retrieval quality operations human override, help with retrieval quality operations human override, plan retrieval quality operations human override, improve retrieval quality operations human override, expert retrieval quality operations human override
description: Expert-level guidance for retrieval quality operations human override with action-oriented workflow, review criteria, and failure patterns.
---

Retrieval Quality Operations Human Override is an expert agent and tooling skill for Retrieval Quality Operations. The focal concern is Human Override, but the real objective is helping an AI system use tools, prompts, memory, and review loops without drifting into fragile automation.

## When To Use

- Use this when Retrieval Quality Operations Human Override affects whether an AI system remains useful once prompts, tools, and real operational noise are involved.
...
- What part of Retrieval Quality Operations Human Override is still governed by intuition instead of a contract or label set?
- Which failure in Retrieval Quality Operations Human Override would be hardest to detect before it compounds?
- How would Retrieval Quality Operations Human Override behave if the tool was slow, retrieval was weak, or the prompt version drifted?
- What should escalate to a human because the system is structurally unreliable there?
- Which comparison run would actually falsify the current design confidence in Retrieval Quality Operations Human Override?
...
- A contract and failure-label set for Retrieval Quality Operations Human Override.
...
- [ ] The system behind Retrieval Quality Operations Human Override is described more clearly than the prompt surface.
