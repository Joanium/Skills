---
name: Bug Reproduction Minimal Repros
trigger: bug reproduction minimal repros, help with bug reproduction minimal repros, plan bug reproduction minimal repros, improve bug reproduction minimal repros, expert bug reproduction minimal repros
description: Expert-level guidance for bug reproduction minimal repros with action-oriented workflow, review criteria, and failure patterns.
---

Bug Reproduction Minimal Repros is an expert coding workflow skill for Bug Reproduction. The focal concern is Minimal Repros, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Bug Reproduction Minimal Repros is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Bug Reproduction Minimal Repros is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Bug Reproduction Minimal Repros would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Bug Reproduction Minimal Repros create a silent regression that tests may miss?
- How would the AI explain the safety of Bug Reproduction Minimal Repros to a skeptical reviewer?
...
- A concise evidence note for Bug Reproduction Minimal Repros.
...
- [ ] The evidence supporting Bug Reproduction Minimal Repros is stronger than the assumptions.
