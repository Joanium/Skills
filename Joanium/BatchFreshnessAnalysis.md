---
name: Batch Freshness Analysis
trigger: batch freshness analysis, help with batch freshness analysis, plan batch freshness analysis, improve batch freshness analysis
description: Practical guidance for planning and executing batch freshness analysis with clear scope, tradeoffs, and validation steps.
---

Batch Freshness Analysis helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
