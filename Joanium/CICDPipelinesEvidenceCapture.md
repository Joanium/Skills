---
name: CI/CD Pipelines Evidence Capture
trigger: ci/cd pipelines evidence capture, help with ci/cd pipelines evidence capture, plan ci/cd pipelines evidence capture, improve ci/cd pipelines evidence capture, expert ci/cd pipelines evidence capture
description: Expert-level guidance for ci/cd pipelines evidence capture with action-oriented workflow, review criteria, and failure patterns.
---

CI/CD Pipelines Evidence Capture is an expert platform and automation skill for CI/CD Pipelines. The focal concern is Evidence Capture, but the real objective is helping an AI make infrastructure and operational change without creating invisible blast radius.

## When To Use

- Use this when CI/CD Pipelines Evidence Capture can affect deployment safety, service recovery, or operator trust in automation.
...
- What part of CI/CD Pipelines Evidence Capture could fail silently while the automation still reports success?
- Which rollback or recovery step inside CI/CD Pipelines Evidence Capture depends too much on tribal memory?
- How will operators know when CI/CD Pipelines Evidence Capture should stop, wait, or reverse course?
- Where does CI/CD Pipelines Evidence Capture blur access, policy, and execution boundaries dangerously?
...
- A change-and-recovery map for CI/CD Pipelines Evidence Capture.
...
- [ ] The rollback model for CI/CD Pipelines Evidence Capture is as real as the forward path.
