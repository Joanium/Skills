---
name: Model Routing Data Contracts
trigger: model routing data contracts, help with model routing data contracts, plan model routing data contracts, improve model routing data contracts, expert model routing data contracts
description: Expert-level guidance for model routing data contracts with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Model Routing Data Contracts is an expert applied-AI skill for Model Routing. The focal concern is Data Contracts, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Model Routing Data Contracts affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Model Routing Data Contracts would look acceptable in a demo but fail under production ambiguity?
- Which part of Model Routing Data Contracts lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Model Routing Data Contracts fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Model Routing Data Contracts is getting better rather than merely changing?
- Where should humans intervene in Model Routing Data Contracts to add leverage instead of toil?
...
- A behavior contract for Model Routing Data Contracts.
...
- [ ] The behavior contract for Model Routing Data Contracts is explicit.
