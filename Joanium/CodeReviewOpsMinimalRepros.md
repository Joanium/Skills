---
name: Code Review Operations Minimal Repros
trigger: code review operations minimal repros, help with code review operations minimal repros, plan code review operations minimal repros, improve code review operations minimal repros, expert code review operations minimal repros
description: Expert-level guidance for code review operations minimal repros with action-oriented workflow, review criteria, and failure patterns.
---

Code Review Operations Minimal Repros is an expert coding workflow skill for Code Review Operations. The focal concern is Minimal Repros, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Code Review Operations Minimal Repros is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Code Review Operations Minimal Repros is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Code Review Operations Minimal Repros would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Code Review Operations Minimal Repros create a silent regression that tests may miss?
- How would the AI explain the safety of Code Review Operations Minimal Repros to a skeptical reviewer?
...
- A concise evidence note for Code Review Operations Minimal Repros.
...
- [ ] The evidence supporting Code Review Operations Minimal Repros is stronger than the assumptions.
