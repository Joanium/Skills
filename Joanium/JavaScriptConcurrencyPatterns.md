---
name: JavaScript Concurrency Patterns
trigger: javascript concurrency patterns, help with javascript concurrency patterns, plan javascript concurrency patterns, improve javascript concurrency patterns, expert javascript concurrency patterns
description: Expert-level guidance for javascript concurrency patterns with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

JavaScript Concurrency Patterns is an expert programming-language skill for JavaScript. The focal concern is Concurrency Patterns, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when JavaScript Concurrency Patterns affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside JavaScript Concurrency Patterns?
- Which abstraction in JavaScript Concurrency Patterns becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in JavaScript Concurrency Patterns first?
- How will JavaScript Concurrency Patterns behave when multiple contributors evolve it independently?
- Which part of JavaScript Concurrency Patterns is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for JavaScript Concurrency Patterns.
- A failure-mode note that explains the sharp edges inside JavaScript Concurrency Patterns.
...
- [ ] The main language-level risk in JavaScript Concurrency Patterns is named explicitly.
...
- [ ] Future contributors can extend JavaScript Concurrency Patterns without reverse-engineering hidden contracts.
