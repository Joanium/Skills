---
name: Zero Trust Exception Governance
trigger: zero trust exception governance, help with zero trust exception governance, plan zero trust exception governance, improve zero trust exception governance, expert zero trust exception governance
description: Expert-level guidance for zero trust exception governance with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Zero Trust Exception Governance is an expert security skill for Zero Trust. The focal concern is Exception Governance, but the real bar is a control model that withstands attackers, operator mistakes, and messy exceptions.

## When To Use

- Use this when Zero Trust Exception Governance influences trust boundaries, privileged behavior, or post-incident accountability.
...
- What realistic attacker behavior would expose the weakest assumption in Zero Trust Exception Governance first?
- Which exception or emergency path makes Zero Trust Exception Governance less true in practice than in policy?
- What evidence would be missing if Zero Trust Exception Governance failed during a real incident?
- Which operator action could accidentally bypass the intended control?
- How does Zero Trust Exception Governance degrade when dependencies, keys, or identities become stale?
...
- A control model and threat note for Zero Trust Exception Governance.
...
- [ ] The attacker model for Zero Trust Exception Governance is realistic and current.
...
- [ ] The team can explain how Zero Trust Exception Governance fails and how it recovers.
