---
name: Test Flake Reduction Review
trigger: test flake reduction review, help with test flake reduction review, plan test flake reduction review, improve test flake reduction review
description: Practical guidance for planning and executing test flake reduction review with clear scope, tradeoffs, and validation steps.
---

Test Flake Reduction Review improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
