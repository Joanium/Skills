---
name: Legacy Refactor Risk Ranking
trigger: legacy refactor risk ranking, help with legacy refactor risk ranking, plan legacy refactor risk ranking, improve legacy refactor risk ranking, expert legacy refactor risk ranking
description: Expert-level guidance for legacy refactor risk ranking with action-oriented workflow, review criteria, and failure patterns.
---

Legacy Refactor Risk Ranking is an expert coding workflow skill for Legacy Refactor. The focal concern is Risk Ranking, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Legacy Refactor Risk Ranking is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Legacy Refactor Risk Ranking is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Legacy Refactor Risk Ranking would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Legacy Refactor Risk Ranking create a silent regression that tests may miss?
- How would the AI explain the safety of Legacy Refactor Risk Ranking to a skeptical reviewer?
...
- A concise evidence note for Legacy Refactor Risk Ranking.
...
- [ ] The evidence supporting Legacy Refactor Risk Ranking is stronger than the assumptions.
