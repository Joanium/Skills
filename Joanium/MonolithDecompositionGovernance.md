---
name: Monolith Decomposition Governance
trigger: monolith decomposition governance, help with monolith decomposition governance, plan monolith decomposition governance, improve monolith decomposition governance
description: Practical guidance for planning and executing monolith decomposition governance with clear scope, tradeoffs, and validation steps.
---

Monolith Decomposition Governance improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
