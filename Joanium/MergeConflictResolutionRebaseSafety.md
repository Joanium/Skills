---
name: Merge Conflict Resolution Rebase Safety
trigger: merge conflict resolution rebase safety, help with merge conflict resolution rebase safety, plan merge conflict resolution rebase safety, improve merge conflict resolution rebase safety, expert merge conflict resolution rebase safety
description: Expert-level guidance for merge conflict resolution rebase safety with action-oriented workflow, review criteria, and failure patterns.
---

Merge Conflict Resolution Rebase Safety is an expert repository and delivery skill for Merge Conflict Resolution. The focal concern is Rebase Safety, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Merge Conflict Resolution Rebase Safety determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Merge Conflict Resolution Rebase Safety riskier than the diff itself suggests?
- Which reviewer would challenge Merge Conflict Resolution Rebase Safety first, and what evidence would they need?
- How could Merge Conflict Resolution Rebase Safety fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Merge Conflict Resolution Rebase Safety would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Merge Conflict Resolution Rebase Safety concretely?
...
- A blast-radius note for Merge Conflict Resolution Rebase Safety.
...
- [ ] The repository-level blast radius of Merge Conflict Resolution Rebase Safety is explicit.
