---
name: Flaky Test Repair Mock Discipline
trigger: flaky test repair mock discipline, help with flaky test repair mock discipline, plan flaky test repair mock discipline, improve flaky test repair mock discipline, expert flaky test repair mock discipline
description: Expert-level guidance for flaky test repair mock discipline with action-oriented workflow, review criteria, and failure patterns.
---

Flaky Test Repair Mock Discipline is an expert testing and quality skill for Flaky Test Repair. The focal concern is Mock Discipline, but the real objective is helping an AI create evidence that code is correct under change, not merely green under ideal conditions.

## When To Use

- Use this when Flaky Test Repair Mock Discipline needs to prove behavior under realistic change and failure conditions rather than just increase test count.
...
- What uncertainty inside Flaky Test Repair Mock Discipline is still untested even if coverage looks healthy?
- Which assertion in Flaky Test Repair Mock Discipline would stay green while the user-visible behavior regressed?
- How much of Flaky Test Repair Mock Discipline depends on mocks, fixtures, or timing assumptions that may be lying?
- What test failure pattern would be most actionable for a future AI debugging pass?
- Where does Flaky Test Repair Mock Discipline need stronger negative cases rather than more positive cases?
...
- A behavior protection map for Flaky Test Repair Mock Discipline.
- A test design note covering fixtures, timing, and oracle choice.
- A failure matrix for the important negative scenarios.
- A triage guide for what failing signals in Flaky Test Repair Mock Discipline should mean.
...
- [ ] The key behavior protected by Flaky Test Repair Mock Discipline is explicit.
