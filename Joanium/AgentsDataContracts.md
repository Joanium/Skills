---
name: Agents Data Contracts
trigger: agents data contracts, help with agents data contracts, plan agents data contracts, improve agents data contracts, expert agents data contracts
description: Expert-level guidance for agents data contracts with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Agents Data Contracts is an expert applied-AI skill for Agents. The focal concern is Data Contracts, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Agents Data Contracts affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Agents Data Contracts would look acceptable in a demo but fail under production ambiguity?
- Which part of Agents Data Contracts lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Agents Data Contracts fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Agents Data Contracts is getting better rather than merely changing?
- Where should humans intervene in Agents Data Contracts to add leverage instead of toil?
...
- A behavior contract for Agents Data Contracts.
...
- [ ] The behavior contract for Agents Data Contracts is explicit.
