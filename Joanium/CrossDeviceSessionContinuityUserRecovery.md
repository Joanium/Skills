---
name: Cross-device Session Continuity User Recovery
trigger: cross-device session continuity user recovery, help with cross-device session continuity user recovery, plan cross-device session continuity user recovery, improve cross-device session continuity user recovery, expert cross-device session continuity user recovery
description: Expert-level guidance for cross-device session continuity user recovery with client delivery workflow, review criteria, and failure patterns.
---

Cross-device Session Continuity User Recovery is an expert mobile and desktop delivery skill for Cross-device Session Continuity. The focal concern is User Recovery, but the real objective is helping an AI ship client software that survives device constraints, stores, upgrades, and real user recovery paths.

## When To Use

- Use this when Cross-device Session Continuity User Recovery affects whether client software remains trustworthy across devices, upgrades, and degraded conditions.
...
- Which user or device condition would expose the weakest assumption in Cross-device Session Continuity User Recovery first?
- How will Cross-device Session Continuity User Recovery behave during upgrade, rollback, or stale local state?
- What store, signing, or permission dependency could block or confuse Cross-device Session Continuity User Recovery unexpectedly?
- How would support or operations diagnose Cross-device Session Continuity User Recovery from telemetry instead of guesswork?
- What path inside Cross-device Session Continuity User Recovery should help the user recover rather than merely fail loudly?
...
- A device and release risk note for Cross-device Session Continuity User Recovery.
...
- [ ] The device, store, and upgrade assumptions behind Cross-device Session Continuity User Recovery are explicit.
