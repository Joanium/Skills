---
name: Client Observability Optimization
trigger: client observability optimization, help with client observability optimization, plan client observability optimization, improve client observability optimization
description: Practical guidance for planning and executing client observability optimization with clear scope, tradeoffs, and validation steps.
---

Client Observability Optimization improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
