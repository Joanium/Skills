---
name: Tool Failure Recovery Planning
trigger: tool failure recovery planning, help with tool failure recovery planning, plan tool failure recovery planning, improve tool failure recovery planning, expert tool failure recovery planning
description: Expert-level guidance for tool failure recovery planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Tool Failure Recovery Planning is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Tool Failure Recovery Planning influences user-visible output, automation, or safety-sensitive decisions.
...
- What must be true before Tool Failure Recovery Planning can start safely?
...
- A milestone plan for Tool Failure Recovery Planning with explicit gating criteria.
