---
name: Refactor Campaigns Approval Heuristics
trigger: refactor campaigns approval heuristics, help with refactor campaigns approval heuristics, plan refactor campaigns approval heuristics, improve refactor campaigns approval heuristics, expert refactor campaigns approval heuristics
description: Expert-level guidance for refactor campaigns approval heuristics with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Approval Heuristics is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Approval Heuristics, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Approval Heuristics determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Approval Heuristics riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Approval Heuristics first, and what evidence would they need?
- How could Refactor Campaigns Approval Heuristics fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Approval Heuristics would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Approval Heuristics concretely?
...
- A blast-radius note for Refactor Campaigns Approval Heuristics.
...
- [ ] The repository-level blast radius of Refactor Campaigns Approval Heuristics is explicit.
