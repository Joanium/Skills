---
name: Operating Systems API Design
trigger: operating systems api design, help with operating systems api design, plan operating systems api design, improve operating systems api design, expert operating systems api design
description: Expert-level guidance for operating systems api design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Operating Systems API Design is an expert systems skill for Operating Systems. The focal concern is API Design, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Operating Systems API Design is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Operating Systems API Design would break first under scale, timing, or hardware stress?
- Which state or resource in Operating Systems API Design is hardest to observe when behavior goes wrong?
- How does Operating Systems API Design trade correctness, throughput, and recoverability today?
- What tooling gap makes Operating Systems API Design harder to reason about than it should be?
- Which optimization target inside Operating Systems API Design is attractive but strategically secondary?
...
- A system model for Operating Systems API Design that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Operating Systems API Design is explicit.
