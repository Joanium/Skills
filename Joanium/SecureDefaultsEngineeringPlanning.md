---
name: Secure Defaults Engineering Planning
trigger: secure defaults engineering planning, help with secure defaults engineering planning, plan secure defaults engineering planning, improve secure defaults engineering planning, expert secure defaults engineering planning
description: Expert-level guidance for secure defaults engineering planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Secure Defaults Engineering Planning is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Secure Defaults Engineering Planning affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- What must be true before Secure Defaults Engineering Planning can start safely?
...
- A milestone plan for Secure Defaults Engineering Planning with explicit gating criteria.
