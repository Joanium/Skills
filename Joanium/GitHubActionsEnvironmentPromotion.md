---
name: GitHub Actions Environment Promotion
trigger: github actions environment promotion, help with github actions environment promotion, plan github actions environment promotion, improve github actions environment promotion, expert github actions environment promotion
description: Expert-level guidance for github actions environment promotion with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

GitHub Actions Environment Promotion is an expert cloud and platform skill for GitHub Actions. The focal concern is Environment Promotion, but the real bar is safe change under pressure, with operators who can still recover when automation gets it wrong.

## When To Use

- Use this when GitHub Actions Environment Promotion changes the risk profile of deploying, operating, or recovering infrastructure.
...
- What platform assumption inside GitHub Actions Environment Promotion would fail first during a rushed rollout or incident?
- Which control in GitHub Actions Environment Promotion is automated but not truly reversible?
- How will operators know whether GitHub Actions Environment Promotion is helping or harming recovery in the first ten minutes?
- What cost or policy behavior in GitHub Actions Environment Promotion is invisible until it becomes expensive?
- Which dependency makes GitHub Actions Environment Promotion less deterministic than the team assumes?
...
- A rollout-and-recovery diagram for GitHub Actions Environment Promotion.
...
- [ ] The rollback path for GitHub Actions Environment Promotion is explicit and tested.
