---
name: Model Quality Rubrics Governance
trigger: model quality rubrics governance, help with model quality rubrics governance, plan model quality rubrics governance, improve model quality rubrics governance, expert model quality rubrics governance
description: Expert-level guidance for model quality rubrics governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Model Quality Rubrics Governance is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Model Quality Rubrics Governance influences user-visible output, automation, or safety-sensitive decisions.
...
- Who sets the policy for Model Quality Rubrics Governance, and who is allowed to grant exceptions?
...
- A policy document for Model Quality Rubrics Governance with explicit scope.
