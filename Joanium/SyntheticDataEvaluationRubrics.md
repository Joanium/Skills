---
name: Synthetic Data Evaluation Rubrics
trigger: synthetic data evaluation rubrics, help with synthetic data evaluation rubrics, plan synthetic data evaluation rubrics, improve synthetic data evaluation rubrics, expert synthetic data evaluation rubrics
description: Expert-level guidance for synthetic data evaluation rubrics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Synthetic Data Evaluation Rubrics is an expert applied-AI skill for Synthetic Data. The focal concern is Evaluation Rubrics, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Synthetic Data Evaluation Rubrics affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Synthetic Data Evaluation Rubrics would look acceptable in a demo but fail under production ambiguity?
- Which part of Synthetic Data Evaluation Rubrics lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Synthetic Data Evaluation Rubrics fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Synthetic Data Evaluation Rubrics is getting better rather than merely changing?
- Where should humans intervene in Synthetic Data Evaluation Rubrics to add leverage instead of toil?
...
- A behavior contract for Synthetic Data Evaluation Rubrics.
...
- [ ] The behavior contract for Synthetic Data Evaluation Rubrics is explicit.
