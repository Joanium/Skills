---
name: Refactor Campaigns Regression Forecasting
trigger: refactor campaigns regression forecasting, help with refactor campaigns regression forecasting, plan refactor campaigns regression forecasting, improve refactor campaigns regression forecasting, expert refactor campaigns regression forecasting
description: Expert-level guidance for refactor campaigns regression forecasting with action-oriented workflow, review criteria, and failure patterns.
---

Refactor Campaigns Regression Forecasting is an expert repository and delivery skill for Refactor Campaigns. The focal concern is Regression Forecasting, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Refactor Campaigns Regression Forecasting determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Refactor Campaigns Regression Forecasting riskier than the diff itself suggests?
- Which reviewer would challenge Refactor Campaigns Regression Forecasting first, and what evidence would they need?
- How could Refactor Campaigns Regression Forecasting fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Refactor Campaigns Regression Forecasting would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Refactor Campaigns Regression Forecasting concretely?
...
- A blast-radius note for Refactor Campaigns Regression Forecasting.
...
- [ ] The repository-level blast radius of Refactor Campaigns Regression Forecasting is explicit.
