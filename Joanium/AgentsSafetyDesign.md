---
name: Agents Safety Design
trigger: agents safety design, help with agents safety design, plan agents safety design, improve agents safety design, expert agents safety design
description: Expert-level guidance for agents safety design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Agents Safety Design is an expert applied-AI skill for Agents. The focal concern is Safety Design, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Agents Safety Design affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Agents Safety Design would look acceptable in a demo but fail under production ambiguity?
- Which part of Agents Safety Design lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Agents Safety Design fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Agents Safety Design is getting better rather than merely changing?
- Where should humans intervene in Agents Safety Design to add leverage instead of toil?
...
- A behavior contract for Agents Safety Design.
...
- [ ] The behavior contract for Agents Safety Design is explicit.
