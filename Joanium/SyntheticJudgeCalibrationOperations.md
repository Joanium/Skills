---
name: Synthetic Judge Calibration Operations
trigger: synthetic judge calibration operations, help with synthetic judge calibration operations, plan synthetic judge calibration operations, improve synthetic judge calibration operations, expert synthetic judge calibration operations
description: Expert-level guidance for synthetic judge calibration operations, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Synthetic Judge Calibration Operations is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is repeatable day-two execution under real load, incomplete information, and ordinary human error.

## When To Use

- Use this when Synthetic Judge Calibration Operations influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the recurring operational decisions inside Synthetic Judge Calibration Operations?
...
- A runbook for Synthetic Judge Calibration Operations covering routine and degraded modes.
