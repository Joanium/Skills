---
name: Agent Memory Automation
trigger: agent memory automation, help with agent memory automation, plan agent memory automation, improve agent memory automation
description: Practical guidance for planning and executing agent memory automation with clear scope, tradeoffs, and validation steps.
---

Agent Memory Automation helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
