---
name: Evaluation Datasets Planning
trigger: evaluation datasets planning, help with evaluation datasets planning, plan evaluation datasets planning, improve evaluation datasets planning
description: Practical guidance for planning and executing evaluation datasets planning with clear scope, tradeoffs, and validation steps.
---

Evaluation Datasets Planning helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
