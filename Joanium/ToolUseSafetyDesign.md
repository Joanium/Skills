---
name: Tool Use Safety Design
trigger: tool use safety design, help with tool use safety design, plan tool use safety design, improve tool use safety design, expert tool use safety design
description: Expert-level guidance for tool use safety design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Tool Use Safety Design is an expert applied-AI skill for Tool Use. The focal concern is Safety Design, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Tool Use Safety Design affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Tool Use Safety Design would look acceptable in a demo but fail under production ambiguity?
- Which part of Tool Use Safety Design lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Tool Use Safety Design fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Tool Use Safety Design is getting better rather than merely changing?
- Where should humans intervene in Tool Use Safety Design to add leverage instead of toil?
...
- A behavior contract for Tool Use Safety Design.
...
- [ ] The behavior contract for Tool Use Safety Design is explicit.
