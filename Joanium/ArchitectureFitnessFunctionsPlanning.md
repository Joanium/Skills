---
name: Architecture Fitness Functions Planning
trigger: architecture fitness functions planning, help with architecture fitness functions planning, plan architecture fitness functions planning, improve architecture fitness functions planning, expert architecture fitness functions planning
description: Expert-level guidance for architecture fitness functions planning, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Architecture Fitness Functions Planning is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is sequencing work, dependencies, and proof points so execution moves quickly without creating blind risk.

## When To Use

- Use this when Architecture Fitness Functions Planning affects codebase shape, team interfaces, or long-term delivery speed.
...
- What must be true before Architecture Fitness Functions Planning can start safely?
...
- A milestone plan for Architecture Fitness Functions Planning with explicit gating criteria.
