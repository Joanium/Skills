---
name: Deep Link Recovery Paths Design
trigger: deep link recovery paths design, help with deep link recovery paths design, plan deep link recovery paths design, improve deep link recovery paths design, expert deep link recovery paths design
description: Expert-level guidance for deep link recovery paths design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Deep Link Recovery Paths Design is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Deep Link Recovery Paths Design affects release risk, device behavior, or user trust during degraded conditions.
...
- What are the core boundaries, contracts, and invariants in Deep Link Recovery Paths Design?
...
- An architecture or boundary diagram for Deep Link Recovery Paths Design.
