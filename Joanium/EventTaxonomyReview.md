---
name: Event Taxonomy Review
trigger: event taxonomy review, help with event taxonomy review, plan event taxonomy review, improve event taxonomy review
description: Practical guidance for planning and executing event taxonomy review with clear scope, tradeoffs, and validation steps.
---

Event Taxonomy Review helps teams treat data work as a governed product with explicit definitions, lineage, and validation.
