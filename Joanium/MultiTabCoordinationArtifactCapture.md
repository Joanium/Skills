---
name: Multi-Tab Coordination Artifact Capture
trigger: multi-tab coordination artifact capture, help with multi-tab coordination artifact capture, plan multi-tab coordination artifact capture, improve multi-tab coordination artifact capture, expert multi-tab coordination artifact capture
description: Expert-level guidance for multi-tab coordination artifact capture with action-oriented workflow, review criteria, and failure patterns.
---

Multi-Tab Coordination Artifact Capture is an expert browser automation skill for Multi-Tab Coordination. The focal concern is Artifact Capture, but the real objective is helping an AI automate real user behavior without collapsing under timing, state, or environment noise.

## When To Use

- Use this when Multi-Tab Coordination Artifact Capture needs to survive realistic browser noise rather than only pass in ideal local runs.
...
- What hidden browser state makes Multi-Tab Coordination Artifact Capture unreliable across runs?
- Which timing or selector assumption in Multi-Tab Coordination Artifact Capture is least stable under real conditions?
- How would Multi-Tab Coordination Artifact Capture behave differently across browsers, profiles, or CI environments?
- What artifacts should Multi-Tab Coordination Artifact Capture capture so the next failure is diagnosable instead of mysterious?
- Which part of Multi-Tab Coordination Artifact Capture is simulating clicks while failing to model user intent?
...
- A browser state and timing map for Multi-Tab Coordination Artifact Capture.
...
- [ ] The state model behind Multi-Tab Coordination Artifact Capture is explicit.
