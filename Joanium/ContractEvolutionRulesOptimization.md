---
name: Contract Evolution Rules Optimization
trigger: contract evolution rules optimization, help with contract evolution rules optimization, plan contract evolution rules optimization, improve contract evolution rules optimization, expert contract evolution rules optimization
description: Expert-level guidance for contract evolution rules optimization, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Contract Evolution Rules Optimization is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is improving the limiting resource without merely moving cost, fragility, or risk somewhere else.

## When To Use

- Use this when Contract Evolution Rules Optimization affects codebase shape, team interfaces, or long-term delivery speed.
...
- What is the actual bottleneck in Contract Evolution Rules Optimization: CPU, memory, latency, network, human time, or policy friction?
...
- A baseline report for Contract Evolution Rules Optimization with representative workloads.
