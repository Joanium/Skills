---
name: Agent Coordination Human Escalation
trigger: agent coordination human escalation, help with agent coordination human escalation, plan agent coordination human escalation, improve agent coordination human escalation, expert agent coordination human escalation
description: Expert-level guidance for agent coordination human escalation with action-oriented workflow, review criteria, and failure patterns.
---

Agent Coordination Human Escalation is an expert applied AI skill for Agent Coordination. The focal concern is Human Escalation, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Agent Coordination Human Escalation affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Agent Coordination Human Escalation is currently measured by vibes rather than a real contract?
- Which failure in Agent Coordination Human Escalation would be hardest to notice before it harms users or operators?
- How will Agent Coordination Human Escalation behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Agent Coordination Human Escalation?
...
- A behavior contract for Agent Coordination Human Escalation.
...
- [ ] The contract behind Agent Coordination Human Escalation is explicit enough to evaluate.
