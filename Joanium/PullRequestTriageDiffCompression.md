---
name: Pull Request Triage Diff Compression
trigger: pull request triage diff compression, help with pull request triage diff compression, plan pull request triage diff compression, improve pull request triage diff compression, expert pull request triage diff compression
description: Expert-level guidance for pull request triage diff compression with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Diff Compression is an expert repository and delivery skill for Pull Request Triage. The focal concern is Diff Compression, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Diff Compression determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Diff Compression riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Diff Compression first, and what evidence would they need?
- How could Pull Request Triage Diff Compression fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Diff Compression would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Diff Compression concretely?
...
- A blast-radius note for Pull Request Triage Diff Compression.
...
- [ ] The repository-level blast radius of Pull Request Triage Diff Compression is explicit.
