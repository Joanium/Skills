---
name: Test Data Factories Mock Discipline
trigger: test data factories mock discipline, help with test data factories mock discipline, plan test data factories mock discipline, improve test data factories mock discipline, expert test data factories mock discipline
description: Expert-level guidance for test data factories mock discipline with action-oriented workflow, review criteria, and failure patterns.
---

Test Data Factories Mock Discipline is an expert testing and quality skill for Test Data Factories. The focal concern is Mock Discipline, but the real objective is helping an AI create evidence that code is correct under change, not merely green under ideal conditions.

## When To Use

- Use this when Test Data Factories Mock Discipline needs to prove behavior under realistic change and failure conditions rather than just increase test count.
...
- What uncertainty inside Test Data Factories Mock Discipline is still untested even if coverage looks healthy?
- Which assertion in Test Data Factories Mock Discipline would stay green while the user-visible behavior regressed?
- How much of Test Data Factories Mock Discipline depends on mocks, fixtures, or timing assumptions that may be lying?
- What test failure pattern would be most actionable for a future AI debugging pass?
- Where does Test Data Factories Mock Discipline need stronger negative cases rather than more positive cases?
...
- A behavior protection map for Test Data Factories Mock Discipline.
- A test design note covering fixtures, timing, and oracle choice.
- A failure matrix for the important negative scenarios.
- A triage guide for what failing signals in Test Data Factories Mock Discipline should mean.
...
- [ ] The key behavior protected by Test Data Factories Mock Discipline is explicit.
