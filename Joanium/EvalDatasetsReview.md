---
name: Evaluation Datasets Review
trigger: evaluation datasets review, help with evaluation datasets review, plan evaluation datasets review, improve evaluation datasets review
description: Practical guidance for planning and executing evaluation datasets review with clear scope, tradeoffs, and validation steps.
---

Evaluation Datasets Review helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
