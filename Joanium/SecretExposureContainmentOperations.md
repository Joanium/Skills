---
name: Secret Exposure Containment Operations
trigger: secret exposure containment operations, help with secret exposure containment operations, plan secret exposure containment operations, improve secret exposure containment operations, expert secret exposure containment operations
description: Expert-level guidance for secret exposure containment operations, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Secret Exposure Containment Operations is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is repeatable day-two execution under real load, incomplete information, and ordinary human error.

## When To Use

- Use this when Secret Exposure Containment Operations affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- What are the recurring operational decisions inside Secret Exposure Containment Operations?
...
- A runbook for Secret Exposure Containment Operations covering routine and degraded modes.
