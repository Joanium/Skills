---
name: Runtime Capacity Headroom Design
trigger: runtime capacity headroom design, help with runtime capacity headroom design, plan runtime capacity headroom design, improve runtime capacity headroom design, expert runtime capacity headroom design
description: Expert-level guidance for runtime capacity headroom design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Runtime Capacity Headroom Design is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Runtime Capacity Headroom Design changes service availability, deployment safety, or recovery behavior.
...
- What are the core boundaries, contracts, and invariants in Runtime Capacity Headroom Design?
...
- An architecture or boundary diagram for Runtime Capacity Headroom Design.
