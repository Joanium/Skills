---
name: Architecture Fitness Functions Review
trigger: architecture fitness functions review, help with architecture fitness functions review, plan architecture fitness functions review, improve architecture fitness functions review, expert architecture fitness functions review
description: Expert-level guidance for architecture fitness functions review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Architecture Fitness Functions Review is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Architecture Fitness Functions Review affects codebase shape, team interfaces, or long-term delivery speed.
...
- What claims about Architecture Fitness Functions Review are supported by evidence, and which are still assertions?
...
- A review summary for Architecture Fitness Functions Review with clear approval status.
