---
name: Model Routing Human Review Loops
trigger: model routing human review loops, help with model routing human review loops, plan model routing human review loops, improve model routing human review loops, expert model routing human review loops
description: Expert-level guidance for model routing human review loops with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Model Routing Human Review Loops is an expert applied-AI skill for Model Routing. The focal concern is Human Review Loops, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Model Routing Human Review Loops affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Model Routing Human Review Loops would look acceptable in a demo but fail under production ambiguity?
- Which part of Model Routing Human Review Loops lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Model Routing Human Review Loops fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Model Routing Human Review Loops is getting better rather than merely changing?
- Where should humans intervene in Model Routing Human Review Loops to add leverage instead of toil?
...
- A behavior contract for Model Routing Human Review Loops.
...
- [ ] The behavior contract for Model Routing Human Review Loops is explicit.
