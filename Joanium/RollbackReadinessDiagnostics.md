---
name: Rollback Readiness Diagnostics
trigger: rollback readiness diagnostics, help with rollback readiness diagnostics, plan rollback readiness diagnostics, improve rollback readiness diagnostics
description: Practical guidance for planning and executing rollback readiness diagnostics with clear scope, tradeoffs, and validation steps.
---

Rollback Readiness Diagnostics focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
