---
name: Battery Budget Enforcement Design
trigger: battery budget enforcement design, help with battery budget enforcement design, plan battery budget enforcement design, improve battery budget enforcement design, expert battery budget enforcement design
description: Expert-level guidance for battery budget enforcement design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Battery Budget Enforcement Design is an expert-level client platform skill for shipping resilient mobile or desktop behavior across devices, stores, networks, and operating-system constraints. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Battery Budget Enforcement Design affects release risk, device behavior, or user trust during degraded conditions.
...
- What are the core boundaries, contracts, and invariants in Battery Budget Enforcement Design?
...
- An architecture or boundary diagram for Battery Budget Enforcement Design.
