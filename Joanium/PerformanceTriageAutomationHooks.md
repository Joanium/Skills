---
name: Performance Triage Automation Hooks
trigger: performance triage automation hooks, help with performance triage automation hooks, plan performance triage automation hooks, improve performance triage automation hooks, expert performance triage automation hooks
description: Expert-level guidance for performance triage automation hooks with action-oriented workflow, review criteria, and failure patterns.
---

Performance Triage Automation Hooks is an expert coding workflow skill for Performance Triage. The focal concern is Automation Hooks, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Performance Triage Automation Hooks is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Performance Triage Automation Hooks is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Performance Triage Automation Hooks would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Performance Triage Automation Hooks create a silent regression that tests may miss?
- How would the AI explain the safety of Performance Triage Automation Hooks to a skeptical reviewer?
...
- A concise evidence note for Performance Triage Automation Hooks.
...
- [ ] The evidence supporting Performance Triage Automation Hooks is stronger than the assumptions.
