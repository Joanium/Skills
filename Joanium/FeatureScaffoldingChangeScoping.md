---
name: Feature Scaffolding Change Scoping
trigger: feature scaffolding change scoping, help with feature scaffolding change scoping, plan feature scaffolding change scoping, improve feature scaffolding change scoping, expert feature scaffolding change scoping
description: Expert-level guidance for feature scaffolding change scoping with action-oriented workflow, review criteria, and failure patterns.
---

Feature Scaffolding Change Scoping is an expert coding workflow skill for Feature Scaffolding. The focal concern is Change Scoping, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Feature Scaffolding Change Scoping is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Feature Scaffolding Change Scoping is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Feature Scaffolding Change Scoping would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Feature Scaffolding Change Scoping create a silent regression that tests may miss?
- How would the AI explain the safety of Feature Scaffolding Change Scoping to a skeptical reviewer?
...
- A concise evidence note for Feature Scaffolding Change Scoping.
...
- [ ] The evidence supporting Feature Scaffolding Change Scoping is stronger than the assumptions.
