---
name: Incident Evidence Handling Design
trigger: incident evidence handling design, help with incident evidence handling design, plan incident evidence handling design, improve incident evidence handling design, expert incident evidence handling design
description: Expert-level guidance for incident evidence handling design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Incident Evidence Handling Design is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Incident Evidence Handling Design affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- What are the core boundaries, contracts, and invariants in Incident Evidence Handling Design?
...
- An architecture or boundary diagram for Incident Evidence Handling Design.
