---
name: CSS System Refactors Handoff Specs
trigger: css system refactors handoff specs, help with css system refactors handoff specs, plan css system refactors handoff specs, improve css system refactors handoff specs, expert css system refactors handoff specs
description: Expert-level guidance for css system refactors handoff specs with action-oriented workflow, review criteria, and failure patterns.
---

CSS System Refactors Handoff Specs is an expert frontend implementation skill for CSS System Refactors. The focal concern is Handoff Specs, but the real objective is helping an AI create UI behavior that stays understandable when state, rendering, latency, and devices stop cooperating.

## When To Use

- Use this when CSS System Refactors Handoff Specs affects whether a frontend change will remain coherent outside the happy path.
...
- What part of CSS System Refactors Handoff Specs becomes hardest to reason about when the UI is slow or inconsistent?
- Which state transition inside CSS System Refactors Handoff Specs would fail silently without stronger instrumentation?
- How does CSS System Refactors Handoff Specs behave when the browser, network, or input method stops being ideal?
- What implementation choice in CSS System Refactors Handoff Specs most threatens the original design intent?
- Which regression in CSS System Refactors Handoff Specs would users notice long before the team does?
...
- A state and edge-case map for CSS System Refactors Handoff Specs.
...
- [ ] The behavioral contract behind CSS System Refactors Handoff Specs is clearer than the implementation shortcuts.
