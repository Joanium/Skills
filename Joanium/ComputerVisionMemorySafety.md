---
name: Computer Vision Memory Safety
trigger: computer vision memory safety, help with computer vision memory safety, plan computer vision memory safety, improve computer vision memory safety, expert computer vision memory safety
description: Expert-level guidance for computer vision memory safety with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Computer Vision Memory Safety is an expert systems skill for Computer Vision. The focal concern is Memory Safety, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Computer Vision Memory Safety is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Computer Vision Memory Safety would break first under scale, timing, or hardware stress?
- Which state or resource in Computer Vision Memory Safety is hardest to observe when behavior goes wrong?
- How does Computer Vision Memory Safety trade correctness, throughput, and recoverability today?
- What tooling gap makes Computer Vision Memory Safety harder to reason about than it should be?
- Which optimization target inside Computer Vision Memory Safety is attractive but strategically secondary?
...
- A system model for Computer Vision Memory Safety that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Computer Vision Memory Safety is explicit.
