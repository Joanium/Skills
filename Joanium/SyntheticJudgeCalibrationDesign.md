---
name: Synthetic Judge Calibration Design
trigger: synthetic judge calibration design, help with synthetic judge calibration design, plan synthetic judge calibration design, improve synthetic judge calibration design, expert synthetic judge calibration design
description: Expert-level guidance for synthetic judge calibration design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Synthetic Judge Calibration Design is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Synthetic Judge Calibration Design influences user-visible output, automation, or safety-sensitive decisions.
...
- What are the core boundaries, contracts, and invariants in Synthetic Judge Calibration Design?
...
- An architecture or boundary diagram for Synthetic Judge Calibration Design.
