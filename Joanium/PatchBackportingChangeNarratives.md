---
name: Patch Backporting Change Narratives
trigger: patch backporting change narratives, help with patch backporting change narratives, plan patch backporting change narratives, improve patch backporting change narratives, expert patch backporting change narratives
description: Expert-level guidance for patch backporting change narratives with action-oriented workflow, review criteria, and failure patterns.
---

Patch Backporting Change Narratives is an expert repository and delivery skill for Patch Backporting. The focal concern is Change Narratives, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Patch Backporting Change Narratives determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Patch Backporting Change Narratives riskier than the diff itself suggests?
- Which reviewer would challenge Patch Backporting Change Narratives first, and what evidence would they need?
- How could Patch Backporting Change Narratives fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Patch Backporting Change Narratives would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Patch Backporting Change Narratives concretely?
...
- A blast-radius note for Patch Backporting Change Narratives.
...
- [ ] The repository-level blast radius of Patch Backporting Change Narratives is explicit.
