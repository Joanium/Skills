---
name: Rendering Failure Containment Review
trigger: rendering failure containment review, help with rendering failure containment review, plan rendering failure containment review, improve rendering failure containment review, expert rendering failure containment review
description: Expert-level guidance for rendering failure containment review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Rendering Failure Containment Review is an expert-level frontend skill for making client behavior understandable, resilient, and consistent across design and engineering. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Rendering Failure Containment Review shapes user trust through responsiveness, clarity, or failure handling.
...
- What claims about Rendering Failure Containment Review are supported by evidence, and which are still assertions?
...
- A review summary for Rendering Failure Containment Review with clear approval status.
