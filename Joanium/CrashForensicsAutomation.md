---
name: Crash Forensics Automation
trigger: crash forensics automation, help with crash forensics automation, plan crash forensics automation, improve crash forensics automation
description: Practical guidance for planning and executing crash forensics automation with clear scope, tradeoffs, and validation steps.
---

Crash Forensics Automation focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
