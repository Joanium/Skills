---
name: Secret Distribution Optimization
trigger: secret distribution optimization, help with secret distribution optimization, plan secret distribution optimization, improve secret distribution optimization
description: Practical guidance for planning and executing secret distribution optimization with clear scope, tradeoffs, and validation steps.
---

Secret Distribution Optimization focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
