---
name: Event-Driven Systems Migration Seams
trigger: event-driven systems migration seams, help with event-driven systems migration seams, plan event-driven systems migration seams, improve event-driven systems migration seams, expert event-driven systems migration seams
description: Expert-level guidance for event-driven systems migration seams with action-oriented workflow, review criteria, and failure patterns.
---

Event-Driven Systems Migration Seams is an expert architecture and systems skill for Event-Driven Systems. The focal concern is Migration Seams, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Event-Driven Systems Migration Seams needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Event-Driven Systems Migration Seams becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Event-Driven Systems Migration Seams is currently cheap only because the bill has not arrived yet?
- How would Event-Driven Systems Migration Seams be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Event-Driven Systems Migration Seams too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Event-Driven Systems Migration Seams.
...
- [ ] The key boundaries inside Event-Driven Systems Migration Seams are explicit and justified.
