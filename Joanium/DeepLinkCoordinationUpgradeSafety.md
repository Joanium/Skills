---
name: Deep Link Coordination Upgrade Safety
trigger: deep link coordination upgrade safety, help with deep link coordination upgrade safety, plan deep link coordination upgrade safety, improve deep link coordination upgrade safety, expert deep link coordination upgrade safety
description: Expert-level guidance for deep link coordination upgrade safety with client delivery workflow, review criteria, and failure patterns.
---

Deep Link Coordination Upgrade Safety is an expert mobile and desktop delivery skill for Deep Link Coordination. The focal concern is Upgrade Safety, but the real objective is helping an AI ship client software that survives device constraints, stores, upgrades, and real user recovery paths.

## When To Use

- Use this when Deep Link Coordination Upgrade Safety affects whether client software remains trustworthy across devices, upgrades, and degraded conditions.
...
- Which user or device condition would expose the weakest assumption in Deep Link Coordination Upgrade Safety first?
- How will Deep Link Coordination Upgrade Safety behave during upgrade, rollback, or stale local state?
- What store, signing, or permission dependency could block or confuse Deep Link Coordination Upgrade Safety unexpectedly?
- How would support or operations diagnose Deep Link Coordination Upgrade Safety from telemetry instead of guesswork?
- What path inside Deep Link Coordination Upgrade Safety should help the user recover rather than merely fail loudly?
...
- A device and release risk note for Deep Link Coordination Upgrade Safety.
...
- [ ] The device, store, and upgrade assumptions behind Deep Link Coordination Upgrade Safety are explicit.
