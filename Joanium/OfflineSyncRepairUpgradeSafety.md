---
name: Offline Sync Repair Upgrade Safety
trigger: offline sync repair upgrade safety, help with offline sync repair upgrade safety, plan offline sync repair upgrade safety, improve offline sync repair upgrade safety, expert offline sync repair upgrade safety
description: Expert-level guidance for offline sync repair upgrade safety with client delivery workflow, review criteria, and failure patterns.
---

Offline Sync Repair Upgrade Safety is an expert mobile and desktop delivery skill for Offline Sync Repair. The focal concern is Upgrade Safety, but the real objective is helping an AI ship client software that survives device constraints, stores, upgrades, and real user recovery paths.

## When To Use

- Use this when Offline Sync Repair Upgrade Safety affects whether client software remains trustworthy across devices, upgrades, and degraded conditions.
...
- Which user or device condition would expose the weakest assumption in Offline Sync Repair Upgrade Safety first?
- How will Offline Sync Repair Upgrade Safety behave during upgrade, rollback, or stale local state?
- What store, signing, or permission dependency could block or confuse Offline Sync Repair Upgrade Safety unexpectedly?
- How would support or operations diagnose Offline Sync Repair Upgrade Safety from telemetry instead of guesswork?
- What path inside Offline Sync Repair Upgrade Safety should help the user recover rather than merely fail loudly?
...
- A device and release risk note for Offline Sync Repair Upgrade Safety.
...
- [ ] The device, store, and upgrade assumptions behind Offline Sync Repair Upgrade Safety are explicit.
