---
name: Python Test Harness Design
trigger: python test harness design, help with python test harness design, plan python test harness design, improve python test harness design, expert python test harness design
description: Expert-level guidance for python test harness design with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Python Test Harness Design is an expert programming-language skill for Python. The focal concern is Test Harness Design, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Python Test Harness Design affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Python Test Harness Design?
- Which abstraction in Python Test Harness Design becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Python Test Harness Design first?
- How will Python Test Harness Design behave when multiple contributors evolve it independently?
- Which part of Python Test Harness Design is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Python Test Harness Design.
- A failure-mode note that explains the sharp edges inside Python Test Harness Design.
...
- [ ] The main language-level risk in Python Test Harness Design is named explicitly.
...
- [ ] Future contributors can extend Python Test Harness Design without reverse-engineering hidden contracts.
