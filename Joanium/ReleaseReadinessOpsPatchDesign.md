---
name: Release Readiness Operations Patch Design
trigger: release readiness operations patch design, help with release readiness operations patch design, plan release readiness operations patch design, improve release readiness operations patch design, expert release readiness operations patch design
description: Expert-level guidance for release readiness operations patch design with action-oriented workflow, review criteria, and failure patterns.
---

Release Readiness Operations Patch Design is an expert coding workflow skill for Release Readiness Operations. The focal concern is Patch Design, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Release Readiness Operations Patch Design is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Release Readiness Operations Patch Design is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Release Readiness Operations Patch Design would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Release Readiness Operations Patch Design create a silent regression that tests may miss?
- How would the AI explain the safety of Release Readiness Operations Patch Design to a skeptical reviewer?
...
- A concise evidence note for Release Readiness Operations Patch Design.
...
- [ ] The evidence supporting Release Readiness Operations Patch Design is stronger than the assumptions.
