---
name: Traffic Shaping Optimization
trigger: traffic shaping optimization, help with traffic shaping optimization, plan traffic shaping optimization, improve traffic shaping optimization
description: Practical guidance for planning and executing traffic shaping optimization with clear scope, tradeoffs, and validation steps.
---

Traffic Shaping Optimization focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
