---
name: Client Observability Analysis
trigger: client observability analysis, help with client observability analysis, plan client observability analysis, improve client observability analysis
description: Practical guidance for planning and executing client observability analysis with clear scope, tradeoffs, and validation steps.
---

Client Observability Analysis improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
