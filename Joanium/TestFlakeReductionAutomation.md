---
name: Test Flake Reduction Automation
trigger: test flake reduction automation, help with test flake reduction automation, plan test flake reduction automation, improve test flake reduction automation
description: Practical guidance for planning and executing test flake reduction automation with clear scope, tradeoffs, and validation steps.
---

Test Flake Reduction Automation improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
