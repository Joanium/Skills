---
name: Prompt Attack Resilience Governance
trigger: prompt attack resilience governance, help with prompt attack resilience governance, plan prompt attack resilience governance, improve prompt attack resilience governance, expert prompt attack resilience governance
description: Expert-level guidance for prompt attack resilience governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Prompt Attack Resilience Governance is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Prompt Attack Resilience Governance influences user-visible output, automation, or safety-sensitive decisions.
...
- Who sets the policy for Prompt Attack Resilience Governance, and who is allowed to grant exceptions?
...
- A policy document for Prompt Attack Resilience Governance with explicit scope.
