---
name: Tool Use Evaluation Rubrics
trigger: tool use evaluation rubrics, help with tool use evaluation rubrics, plan tool use evaluation rubrics, improve tool use evaluation rubrics, expert tool use evaluation rubrics
description: Expert-level guidance for tool use evaluation rubrics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Tool Use Evaluation Rubrics is an expert applied-AI skill for Tool Use. The focal concern is Evaluation Rubrics, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Tool Use Evaluation Rubrics affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Tool Use Evaluation Rubrics would look acceptable in a demo but fail under production ambiguity?
- Which part of Tool Use Evaluation Rubrics lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Tool Use Evaluation Rubrics fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Tool Use Evaluation Rubrics is getting better rather than merely changing?
- Where should humans intervene in Tool Use Evaluation Rubrics to add leverage instead of toil?
...
- A behavior contract for Tool Use Evaluation Rubrics.
...
- [ ] The behavior contract for Tool Use Evaluation Rubrics is explicit.
