---
name: Prompt Workflows Experiment Tracking
trigger: prompt workflows experiment tracking, help with prompt workflows experiment tracking, plan prompt workflows experiment tracking, improve prompt workflows experiment tracking, expert prompt workflows experiment tracking
description: Expert-level guidance for prompt workflows experiment tracking with action-oriented workflow, review criteria, and failure patterns.
---

Prompt Workflows Experiment Tracking is an expert applied AI skill for Prompt Workflows. The focal concern is Experiment Tracking, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Prompt Workflows Experiment Tracking affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Prompt Workflows Experiment Tracking is currently measured by vibes rather than a real contract?
- Which failure in Prompt Workflows Experiment Tracking would be hardest to notice before it harms users or operators?
- How will Prompt Workflows Experiment Tracking behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Prompt Workflows Experiment Tracking?
...
- A behavior contract for Prompt Workflows Experiment Tracking.
...
- [ ] The contract behind Prompt Workflows Experiment Tracking is explicit enough to evaluate.
