---
name: Evaluation Datasets Strategy
trigger: evaluation datasets strategy, help with evaluation datasets strategy, plan evaluation datasets strategy, improve evaluation datasets strategy
description: Practical guidance for planning and executing evaluation datasets strategy with clear scope, tradeoffs, and validation steps.
---

Evaluation Datasets Strategy helps structure AI systems so prompts, tool use, evaluation, and fallback behavior stay understandable as the product grows.
