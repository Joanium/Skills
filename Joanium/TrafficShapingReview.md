---
name: Traffic Shaping Review
trigger: traffic shaping review, help with traffic shaping review, plan traffic shaping review, improve traffic shaping review
description: Practical guidance for planning and executing traffic shaping review with clear scope, tradeoffs, and validation steps.
---

Traffic Shaping Review focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
