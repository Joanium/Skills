---
name: Component APIs Strategy
trigger: component apis strategy, help with component apis strategy, plan component apis strategy, improve component apis strategy
description: Practical guidance for planning and executing component apis strategy with clear scope, tradeoffs, and validation steps.
---

Component APIs Strategy improves frontend delivery by making behavior, accessibility, and handoff expectations concrete.
