---
name: Community Health Signals Review
trigger: community health signals review, help with community health signals review, plan community health signals review, improve community health signals review, expert community health signals review
description: Expert-level guidance for community health signals review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Community Health Signals Review is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when Community Health Signals Review affects acquisition, narrative clarity, or cross-channel execution.
...
- What claims about Community Health Signals Review are supported by evidence, and which are still assertions?
...
- A review summary for Community Health Signals Review with clear approval status.
