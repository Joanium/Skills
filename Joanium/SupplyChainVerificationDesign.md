---
name: Supply Chain Verification Design
trigger: supply chain verification design, help with supply chain verification design, plan supply chain verification design, improve supply chain verification design, expert supply chain verification design
description: Expert-level guidance for supply chain verification design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Supply Chain Verification Design is an expert-level security skill for reducing exploitable gaps while keeping controls practical for the team that must operate them. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Supply Chain Verification Design affects trust boundaries, privileged actions, or evidence needed after an incident.
...
- What are the core boundaries, contracts, and invariants in Supply Chain Verification Design?
...
- An architecture or boundary diagram for Supply Chain Verification Design.
