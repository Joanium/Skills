---
name: Crash Forensics Operations
trigger: crash forensics operations, help with crash forensics operations, plan crash forensics operations, improve crash forensics operations
description: Practical guidance for planning and executing crash forensics operations with clear scope, tradeoffs, and validation steps.
---

Crash Forensics Operations focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
