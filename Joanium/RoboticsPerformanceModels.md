---
name: Robotics Performance Models
trigger: robotics performance models, help with robotics performance models, plan robotics performance models, improve robotics performance models, expert robotics performance models
description: Expert-level guidance for robotics performance models with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Robotics Performance Models is an expert systems skill for Robotics. The focal concern is Performance Models, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Robotics Performance Models is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Robotics Performance Models would break first under scale, timing, or hardware stress?
- Which state or resource in Robotics Performance Models is hardest to observe when behavior goes wrong?
- How does Robotics Performance Models trade correctness, throughput, and recoverability today?
- What tooling gap makes Robotics Performance Models harder to reason about than it should be?
- Which optimization target inside Robotics Performance Models is attractive but strategically secondary?
...
- A system model for Robotics Performance Models that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Robotics Performance Models is explicit.
