---
name: Infrastructure Drift Prevention Governance
trigger: infrastructure drift prevention governance, help with infrastructure drift prevention governance, plan infrastructure drift prevention governance, improve infrastructure drift prevention governance, expert infrastructure drift prevention governance
description: Expert-level guidance for infrastructure drift prevention governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Infrastructure Drift Prevention Governance is an expert-level infrastructure skill for reducing operational risk while keeping rollout control, recovery, and ownership explicit. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Infrastructure Drift Prevention Governance changes service availability, deployment safety, or recovery behavior.
...
- Who sets the policy for Infrastructure Drift Prevention Governance, and who is allowed to grant exceptions?
...
- A policy document for Infrastructure Drift Prevention Governance with explicit scope.
