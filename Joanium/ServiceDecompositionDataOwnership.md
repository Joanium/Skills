---
name: Service Decomposition Data Ownership
trigger: service decomposition data ownership, help with service decomposition data ownership, plan service decomposition data ownership, improve service decomposition data ownership, expert service decomposition data ownership
description: Expert-level guidance for service decomposition data ownership with action-oriented workflow, review criteria, and failure patterns.
---

Service Decomposition Data Ownership is an expert architecture and systems skill for Service Decomposition. The focal concern is Data Ownership, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Service Decomposition Data Ownership needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Service Decomposition Data Ownership becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Service Decomposition Data Ownership is currently cheap only because the bill has not arrived yet?
- How would Service Decomposition Data Ownership be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Service Decomposition Data Ownership too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Service Decomposition Data Ownership.
...
- [ ] The key boundaries inside Service Decomposition Data Ownership are explicit and justified.
