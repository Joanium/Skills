---
name: Install Funnels Review
trigger: install funnels review, help with install funnels review, plan install funnels review, improve install funnels review
description: Practical guidance for planning and executing install funnels review with clear scope, tradeoffs, and validation steps.
---

Install Funnels Review focuses on shipping client applications that stay resilient across device constraints, stores, and unreliable networks.
