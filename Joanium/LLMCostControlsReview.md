---
name: LLM Cost Controls Review
trigger: llm cost controls review, help with llm cost controls review, plan llm cost controls review, improve llm cost controls review, expert llm cost controls review
description: Expert-level guidance for llm cost controls review, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

LLM Cost Controls Review is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is challenging assumptions, proving readiness, and deciding whether the work is actually safe to adopt.

## When To Use

- Use this when LLM Cost Controls Review influences user-visible output, automation, or safety-sensitive decisions.
...
- What claims about LLM Cost Controls Review are supported by evidence, and which are still assertions?
...
- A review summary for LLM Cost Controls Review with clear approval status.
