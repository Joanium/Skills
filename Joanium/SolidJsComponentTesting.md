---
name: SolidJS Component Testing
trigger: solidjs component testing, help with solidjs component testing, plan solidjs component testing, improve solidjs component testing, expert solidjs component testing
description: Expert-level guidance for solidjs component testing with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

SolidJS Component Testing is an expert frontend skill for SolidJS. The focal concern is Component Testing, but the real task is shaping user-perceived behavior under real browser and device constraints.

## When To Use

- Use this when SolidJS Component Testing affects a critical journey where users will notice latency, confusion, or inconsistency immediately.
...
- Where does SolidJS Component Testing make user state harder to reason about than it needs to be?
- Which interaction in SolidJS Component Testing degrades first under latency, stale data, or partial failure?
- What accessibility behavior in SolidJS Component Testing would break if the DOM or state changed unexpectedly?
- How does SolidJS Component Testing fail when routing, hydration, or rendering order becomes non-ideal?
- What part of SolidJS Component Testing looks correct in a mock but collapses under production behavior?
...
- A state transition map for SolidJS Component Testing.
...
- [ ] The state model for SolidJS Component Testing is clear enough to debug.
...
- [ ] Another engineer can extend SolidJS Component Testing without guessing hidden UI contracts.
