---
name: Repository Audit Automation Hooks
trigger: repository audit automation hooks, help with repository audit automation hooks, plan repository audit automation hooks, improve repository audit automation hooks, expert repository audit automation hooks
description: Expert-level guidance for repository audit automation hooks with action-oriented workflow, review criteria, and failure patterns.
---

Repository Audit Automation Hooks is an expert coding workflow skill for Repository Audit. The focal concern is Automation Hooks, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Repository Audit Automation Hooks is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Repository Audit Automation Hooks is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Repository Audit Automation Hooks would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Repository Audit Automation Hooks create a silent regression that tests may miss?
- How would the AI explain the safety of Repository Audit Automation Hooks to a skeptical reviewer?
...
- A concise evidence note for Repository Audit Automation Hooks.
...
- [ ] The evidence supporting Repository Audit Automation Hooks is stronger than the assumptions.
