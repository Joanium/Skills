---
name: Backup Verification Operations
trigger: backup verification operations, help with backup verification operations, plan backup verification operations, improve backup verification operations
description: Practical guidance for planning and executing backup verification operations with clear scope, tradeoffs, and validation steps.
---

Backup Verification Operations focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
