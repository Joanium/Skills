---
name: Pull Request Triage Evidence Packets
trigger: pull request triage evidence packets, help with pull request triage evidence packets, plan pull request triage evidence packets, improve pull request triage evidence packets, expert pull request triage evidence packets
description: Expert-level guidance for pull request triage evidence packets with action-oriented workflow, review criteria, and failure patterns.
---

Pull Request Triage Evidence Packets is an expert repository and delivery skill for Pull Request Triage. The focal concern is Evidence Packets, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Pull Request Triage Evidence Packets determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Pull Request Triage Evidence Packets riskier than the diff itself suggests?
- Which reviewer would challenge Pull Request Triage Evidence Packets first, and what evidence would they need?
- How could Pull Request Triage Evidence Packets fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Pull Request Triage Evidence Packets would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Pull Request Triage Evidence Packets concretely?
...
- A blast-radius note for Pull Request Triage Evidence Packets.
...
- [ ] The repository-level blast radius of Pull Request Triage Evidence Packets is explicit.
