---
name: Algorithms Architecture Patterns
trigger: algorithms architecture patterns, help with algorithms architecture patterns, plan algorithms architecture patterns, improve algorithms architecture patterns, expert algorithms architecture patterns
description: Expert-level guidance for algorithms architecture patterns with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Algorithms Architecture Patterns is an expert systems skill for Algorithms. The focal concern is Architecture Patterns, but the real bar is technical work that remains correct, observable, and optimizable in hard conditions.

## When To Use

- Use this when Algorithms Architecture Patterns is constrained by performance, correctness, or hardware realities that typical app-development patterns ignore.
...
- What hidden assumption inside Algorithms Architecture Patterns would break first under scale, timing, or hardware stress?
- Which state or resource in Algorithms Architecture Patterns is hardest to observe when behavior goes wrong?
- How does Algorithms Architecture Patterns trade correctness, throughput, and recoverability today?
- What tooling gap makes Algorithms Architecture Patterns harder to reason about than it should be?
- Which optimization target inside Algorithms Architecture Patterns is attractive but strategically secondary?
...
- A system model for Algorithms Architecture Patterns that names resources, state, and failure boundaries.
...
- [ ] The operating envelope for Algorithms Architecture Patterns is explicit.
