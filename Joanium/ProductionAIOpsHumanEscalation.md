---
name: Production AI Operations Human Escalation
trigger: production ai operations human escalation, help with production ai operations human escalation, plan production ai operations human escalation, improve production ai operations human escalation, expert production ai operations human escalation
description: Expert-level guidance for production ai operations human escalation with action-oriented workflow, review criteria, and failure patterns.
---

Production AI Operations Human Escalation is an expert applied AI skill for Production AI Operations. The focal concern is Human Escalation, but the real objective is helping an AI system behave usefully in production where cost, latency, ambiguity, and safety all matter at once.

## When To Use

- Use this when Production AI Operations Human Escalation affects how model-assisted behavior will actually work once users, tools, and ambiguity are involved.
...
- What part of Production AI Operations Human Escalation is currently measured by vibes rather than a real contract?
- Which failure in Production AI Operations Human Escalation would be hardest to notice before it harms users or operators?
- How will Production AI Operations Human Escalation behave if tools are slow, retrieval is weak, or prompts drift over time?
- What should escalate to humans because the AI is structurally weak there, not just temporarily uncertain?
- How will the next model or prompt change be attributed cleanly inside Production AI Operations Human Escalation?
...
- A behavior contract for Production AI Operations Human Escalation.
...
- [ ] The contract behind Production AI Operations Human Escalation is explicit enough to evaluate.
