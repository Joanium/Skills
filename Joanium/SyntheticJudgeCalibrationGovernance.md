---
name: Synthetic Judge Calibration Governance
trigger: synthetic judge calibration governance, help with synthetic judge calibration governance, plan synthetic judge calibration governance, improve synthetic judge calibration governance, expert synthetic judge calibration governance
description: Expert-level guidance for synthetic judge calibration governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Synthetic Judge Calibration Governance is an expert-level AI systems skill for making model-assisted behavior reliable, auditable, and economically sane in production. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Synthetic Judge Calibration Governance influences user-visible output, automation, or safety-sensitive decisions.
...
- Who sets the policy for Synthetic Judge Calibration Governance, and who is allowed to grant exceptions?
...
- A policy document for Synthetic Judge Calibration Governance with explicit scope.
