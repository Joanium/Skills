---
name: Cluster Tenancy Review
trigger: cluster tenancy review, help with cluster tenancy review, plan cluster tenancy review, improve cluster tenancy review
description: Practical guidance for planning and executing cluster tenancy review with clear scope, tradeoffs, and validation steps.
---

Cluster Tenancy Review focuses on infrastructure decisions that reduce rollout risk while keeping ownership, recovery, and change control explicit.
