---
name: Auth Recovery Analysis
trigger: auth recovery analysis, help with auth recovery analysis, plan auth recovery analysis, improve auth recovery analysis
description: Practical guidance for planning and executing auth recovery analysis with clear scope, tradeoffs, and validation steps.
---

Auth Recovery Analysis is about reducing exploitable gaps by pairing preventive controls with review, evidence, and response readiness.
