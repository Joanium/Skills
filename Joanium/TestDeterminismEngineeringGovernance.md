---
name: Test Determinism Engineering Governance
trigger: test determinism engineering governance, help with test determinism engineering governance, plan test determinism engineering governance, improve test determinism engineering governance, expert test determinism engineering governance
description: Expert-level guidance for test determinism engineering governance, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Test Determinism Engineering Governance is an expert-level engineering systems skill for making architecture, standards, and change management explicit enough to scale beyond individual memory. The emphasis here is on ownership, policy, exception handling, and auditability so the domain does not decay into ad hoc decisions.

## When To Use

- Use this when Test Determinism Engineering Governance affects codebase shape, team interfaces, or long-term delivery speed.
...
- Who sets the policy for Test Determinism Engineering Governance, and who is allowed to grant exceptions?
...
- A policy document for Test Determinism Engineering Governance with explicit scope.
