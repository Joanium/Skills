---
name: Agents Tool Reliability
trigger: agents tool reliability, help with agents tool reliability, plan agents tool reliability, improve agents tool reliability, expert agents tool reliability
description: Expert-level guidance for agents tool reliability with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Agents Tool Reliability is an expert applied-AI skill for Agents. The focal concern is Tool Reliability, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Agents Tool Reliability affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Agents Tool Reliability would look acceptable in a demo but fail under production ambiguity?
- Which part of Agents Tool Reliability lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Agents Tool Reliability fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Agents Tool Reliability is getting better rather than merely changing?
- Where should humans intervene in Agents Tool Reliability to add leverage instead of toil?
...
- A behavior contract for Agents Tool Reliability.
...
- [ ] The behavior contract for Agents Tool Reliability is explicit.
