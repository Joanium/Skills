---
name: Patch Backporting Regression Forecasting
trigger: patch backporting regression forecasting, help with patch backporting regression forecasting, plan patch backporting regression forecasting, improve patch backporting regression forecasting, expert patch backporting regression forecasting
description: Expert-level guidance for patch backporting regression forecasting with action-oriented workflow, review criteria, and failure patterns.
---

Patch Backporting Regression Forecasting is an expert repository and delivery skill for Patch Backporting. The focal concern is Regression Forecasting, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Patch Backporting Regression Forecasting determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Patch Backporting Regression Forecasting riskier than the diff itself suggests?
- Which reviewer would challenge Patch Backporting Regression Forecasting first, and what evidence would they need?
- How could Patch Backporting Regression Forecasting fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Patch Backporting Regression Forecasting would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Patch Backporting Regression Forecasting concretely?
...
- A blast-radius note for Patch Backporting Regression Forecasting.
...
- [ ] The repository-level blast radius of Patch Backporting Regression Forecasting is explicit.
