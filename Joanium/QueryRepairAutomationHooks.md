---
name: Query Repair Automation Hooks
trigger: query repair automation hooks, help with query repair automation hooks, plan query repair automation hooks, improve query repair automation hooks, expert query repair automation hooks
description: Expert-level guidance for query repair automation hooks with action-oriented workflow, review criteria, and failure patterns.
---

Query Repair Automation Hooks is an expert coding workflow skill for Query Repair. The focal concern is Automation Hooks, but the real objective is helping an AI move from messy code context to a safe, reviewable, high-leverage change.

## When To Use

- Use this when Query Repair Automation Hooks is the difference between a plausible code edit and a change that can survive review, testing, and rollback.
...
- What part of Query Repair Automation Hooks is known from evidence versus inferred from incomplete context?
- Which file, boundary, or runtime path inside Query Repair Automation Hooks would hurt most if misunderstood?
- What is the smallest proof that the chosen change direction is correct?
- Where could Query Repair Automation Hooks create a silent regression that tests may miss?
- How would the AI explain the safety of Query Repair Automation Hooks to a skeptical reviewer?
...
- A concise evidence note for Query Repair Automation Hooks.
...
- [ ] The evidence supporting Query Repair Automation Hooks is stronger than the assumptions.
