---
name: Prompting Data Contracts
trigger: prompting data contracts, help with prompting data contracts, plan prompting data contracts, improve prompting data contracts, expert prompting data contracts
description: Expert-level guidance for prompting data contracts with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Prompting Data Contracts is an expert applied-AI skill for Prompting. The focal concern is Data Contracts, but the real bar is production behavior that is measurable, reviewable, and worth its cost.

## When To Use

- Use this when Prompting Data Contracts affects model-assisted output that users, reviewers, or downstream systems will trust.
...
- What behavior in Prompting Data Contracts would look acceptable in a demo but fail under production ambiguity?
- Which part of Prompting Data Contracts lacks a measurable contract: inputs, outputs, tools, or review criteria?
- How will Prompting Data Contracts fail when latency, cost, retrieval quality, or tool behavior shifts?
- What evidence will prove that Prompting Data Contracts is getting better rather than merely changing?
- Where should humans intervene in Prompting Data Contracts to add leverage instead of toil?
...
- A behavior contract for Prompting Data Contracts.
...
- [ ] The behavior contract for Prompting Data Contracts is explicit.
