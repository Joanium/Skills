---
name: Monolith Decomposition Strategy
trigger: monolith decomposition strategy, help with monolith decomposition strategy, plan monolith decomposition strategy, improve monolith decomposition strategy
description: Practical guidance for planning and executing monolith decomposition strategy with clear scope, tradeoffs, and validation steps.
---

Monolith Decomposition Strategy improves engineering execution by making standards, migration steps, and review boundaries easier to apply consistently.
