---
name: Narrative Testing Systems Design
trigger: narrative testing systems design, help with narrative testing systems design, plan narrative testing systems design, improve narrative testing systems design, expert narrative testing systems design
description: Expert-level guidance for narrative testing systems design, including decision criteria, workflow, tradeoffs, signals, review checkpoints, and failure modes.
---

Narrative Testing Systems Design is an expert-level go-to-market skill for aligning audience, message, distribution, and measurement into a system instead of isolated campaigns. The emphasis here is on interfaces, invariants, failure handling, and why one structure is safer than its alternatives.

## When To Use

- Use this when Narrative Testing Systems Design affects acquisition, narrative clarity, or cross-channel execution.
...
- What are the core boundaries, contracts, and invariants in Narrative Testing Systems Design?
...
- An architecture or boundary diagram for Narrative Testing Systems Design.
