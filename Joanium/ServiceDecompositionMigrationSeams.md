---
name: Service Decomposition Migration Seams
trigger: service decomposition migration seams, help with service decomposition migration seams, plan service decomposition migration seams, improve service decomposition migration seams, expert service decomposition migration seams
description: Expert-level guidance for service decomposition migration seams with action-oriented workflow, review criteria, and failure patterns.
---

Service Decomposition Migration Seams is an expert architecture and systems skill for Service Decomposition. The focal concern is Migration Seams, but the real objective is helping an AI reason about boundaries, failure paths, and evolution before the system gets too expensive to change.

## When To Use

- Use this when Service Decomposition Migration Seams needs stronger reasoning about boundaries, contracts, and failure before implementation momentum hides the real tradeoffs.
...
- What part of Service Decomposition Migration Seams becomes ambiguous when the system is stressed, scaled, or reorganized?
- Which dependency in Service Decomposition Migration Seams is currently cheap only because the bill has not arrived yet?
- How would Service Decomposition Migration Seams be migrated if the current assumption proved wrong in six months?
- Where is ownership inside Service Decomposition Migration Seams too fuzzy for operators or adjacent teams?
...
- A boundary and ownership diagram for Service Decomposition Migration Seams.
...
- [ ] The key boundaries inside Service Decomposition Migration Seams are explicit and justified.
