---
name: Go Refactor Mechanics
trigger: go refactor mechanics, help with go refactor mechanics, plan go refactor mechanics, improve go refactor mechanics, expert go refactor mechanics
description: Expert-level guidance for go refactor mechanics with domain-specific heuristics, workflow, review criteria, and failure patterns.
---

Go Refactor Mechanics is an expert programming-language skill for Go. The focal concern is Refactor Mechanics, but the real bar is production code that survives refactors, scale, and peer review.

## When To Use

- Use this when Go Refactor Mechanics affects correctness, readability, and long-term maintainability in the same code path.
...
- What language feature is carrying the real complexity inside Go Refactor Mechanics?
- Which abstraction in Go Refactor Mechanics becomes harder to debug as the codebase grows?
- What runtime failure would reveal a weak design choice in Go Refactor Mechanics first?
- How will Go Refactor Mechanics behave when multiple contributors evolve it independently?
- Which part of Go Refactor Mechanics is optimized for elegance instead of team comprehension?
...
- A minimal before-and-after code sample for Go Refactor Mechanics.
- A failure-mode note that explains the sharp edges inside Go Refactor Mechanics.
...
- [ ] The main language-level risk in Go Refactor Mechanics is named explicitly.
...
- [ ] Future contributors can extend Go Refactor Mechanics without reverse-engineering hidden contracts.
