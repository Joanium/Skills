---
name: Merge Conflict Resolution Evidence Packets
trigger: merge conflict resolution evidence packets, help with merge conflict resolution evidence packets, plan merge conflict resolution evidence packets, improve merge conflict resolution evidence packets, expert merge conflict resolution evidence packets
description: Expert-level guidance for merge conflict resolution evidence packets with action-oriented workflow, review criteria, and failure patterns.
---

Merge Conflict Resolution Evidence Packets is an expert repository and delivery skill for Merge Conflict Resolution. The focal concern is Evidence Packets, but the real objective is helping an AI navigate large code changes without losing causal clarity, reviewer trust, or rollback safety.

## When To Use

- Use this when Merge Conflict Resolution Evidence Packets determines whether a large or risky code change can be reasoned about cleanly before it lands.
...
- What repository-level dependency makes Merge Conflict Resolution Evidence Packets riskier than the diff itself suggests?
- Which reviewer would challenge Merge Conflict Resolution Evidence Packets first, and what evidence would they need?
- How could Merge Conflict Resolution Evidence Packets fail after rebasing, backporting, or partial cherry-picking?
- What hidden coupling in Merge Conflict Resolution Evidence Packets would only become obvious during staging or release?
- How will the AI explain the intended blast radius of Merge Conflict Resolution Evidence Packets concretely?
...
- A blast-radius note for Merge Conflict Resolution Evidence Packets.
...
- [ ] The repository-level blast radius of Merge Conflict Resolution Evidence Packets is explicit.
